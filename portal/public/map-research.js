...
export function mountMapResearch(container, data, options = {}) {
  ...
  function update(graph, nextFilters, years){
    ...
    recordButton.textContent = `List the records (${graph.edges.length.toLocaleString('en-AU')})`;
    renderRows();
  }
  function apply(){
