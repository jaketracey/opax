...
export function mountMapResearch(container, data, options = {}) {
  ...
  const click=async e=>{
    ...
    if(b.hasAttribute('data-copy')){try{await navigator.clipboard.writeText(location.href);feedback.textContent='Map link copied.'}catch{feedback.textContent='Copy the map URL from your address bar.'}}
