...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function vp(i,t,e){let n=new Float32Array(ui),s=new N(0,1,0);return new Ye({name:"SphericalGaussianBlur",defines:{n:ui,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Oo(),fragmentShader:`
...
`)}var Yc=new Gt;function vm(i){Jt._getMatrix(Yc,Jt.workingColorSpace,i);let t=`mat3( ${Yc.elements.map(e=>e.toFixed(4))} )`;switch(Jt.getTransfer(i)){case cs:return[t,"LinearTransferOETF"];case ne:return[t,"sRGBTransferOETF"];default:return Bt("WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function $c(i,t,e){let n=i.getShaderParameter(t,i.COMPILE_STATUS),r=(i.getShaderInfoLog(t)||"").trim();if(n&&r==="")return"";let o=/ERROR: 0:(\d+)/.exec(r);if(o){let a=parseInt(o[1]);return e.toUpperCase()+`
...
`)}var bm={[Ia]:"Linear",[Pa]:"Reinhard",[La]:"Cineon",[Da]:"ACESFilmic",[Ua]:"AgX",[Fa]:"Neutral",[Na]:"Custom"};function Mm(i,t){let e=bm[t];return e===void 0?(Bt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var Do=new N;function Sm(){Jt.getLuminanceCoefficients(Do);let i=Do.x.toFixed(4),t=Do.y.toFixed(4),e=Do.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}var Lm={[Ts]:"SHADOWMAP_TYPE_PCF",[Yi]:"SHADOWMAP_TYPE_VSM"};function Dm(i){return Lm[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var Nm={[Yn]:"ENVMAP_TYPE_CUBE",[ci]:"ENVMAP_TYPE_CUBE",[As]:"ENVMAP_TYPE_CUBE_UV"};function Um(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Nm[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var Fm={[ci]:"ENVMAP_MODE_REFRACTION"};function Om(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Fm[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var Bm={[Ra]:"ENVMAP_BLENDING_MULTIPLY",[xc]:"ENVMAP_BLENDING_MIX",[_c]:"ENVMAP_BLENDING_ADD"};function zm(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Bm[i.combine]||"ENVMAP_BLENDING_NONE"}function km(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Vm(i,t,e,n){let s=i.getContext(),r=e.defines,o=e.vertexShader,a=e.fragmentShader,l=Dm(e),c=Um(e),h=Om(e),d=zm(e),u=km(e),f=Em(e),g=wm(r),v=s.createProgram(),m,p,E=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);let C=E+m+o,S=E+p+a,y=qc(s,s.VERTEX_SHADER,C),M=qc(s,s.FRAGMENT_SHADER,S);s.attachShader(v,y),s.attachShader(v,M),e.index0AttributeName!==void 0?s.bindAttribLocation(v,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function T(I){if(i.debug.checkShaderErrors){let L=s.getProgramInfoLog(v)||"",X=s.getShaderInfoLog(y)||"",W=s.getShaderInfoLog(M)||"",P=L.trim(),k=X.trim(),z=W.trim(),$=!0,tt=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,y,M);else{let it=$c(s,y,"vertex"),rt=$c(s,M,"fragment");Vt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
}`,ng=[new N(1,0,0),new N(-1,0,0),new N(0,1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1)],ig=[new N(0,-1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1),new N(0,-1,0),new N(0,-1,0)],nh=new fe,Fs=new N,il=new N;function sg(i,t,e){let n=new ki,s=new Yt,r=new Yt,o=new pe,a=new Rr,l=new Ir,c={},h=e.maxTextureSize,d={[An]:Te,[Te]:An,[Oe]:Oe},u=new Ye({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Yt},radius:{value:4}},vertexShader:tg,fragmentShader:eg}),f=u.clone();f.defines.HORIZONTAL_PASS=1;let g=new qe;g.setAttribute("position",new We(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let v=new he(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ts;let p=this.type;this.render=function(M,T,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||M.length===0)return;this.type===jl&&(Bt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Ts);let w=i.getRenderTarget(),R=i.getActiveCubeFace(),I=i.getActiveMipmapLevel(),L=i.state;L.setBlending(gn),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);let X=p!==this.type;X&&T.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(P=>P.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,P=M.length;W<P;W++){let k=M[W],z=k.shadow;if(z===void 0){Bt("WebGLShadowMap:",k,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;s.copy(z.mapSize);let $=z.getFrameExtents();s.multiply($),r.copy(z.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/$.x),s.x=r.x*$.x,z.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/$.y),s.y=r.y*$.y,z.mapSize.y=r.y));let tt=i.state.buffers.depth.getReversed();if(z.camera._reversedDepth=tt,z.map===null||X===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Yi){if(k.isPointLight){Bt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Xe(s.x,s.y,{format:Jn,type:xn,minFilter:we,magFilter:we,generateMipmaps:!1}),z.map.texture.name=k.name+".shadowMap",z.map.depthTexture=new Rn(s.x,s.y,an),z.map.depthTexture.name=k.name+".shadowMapDepth",z.map.depthTexture.format=pn,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Ee,z.map.depthTexture.magFilter=Ee}else k.isPointLight?(z.map=new Uo(s.x),z.map.depthTexture=new Ar(s.x,on)):(z.map=new Xe(s.x,s.y),z.map.depthTexture=new Rn(s.x,s.y,on)),z.map.depthTexture.name=k.name+".shadowMap",z.map.depthTexture.format=pn,this.type===Ts?(z.map.depthTexture.compareFunction=tt?Po:Io,z.map.depthTexture.minFilter=we,z.map.depthTexture.magFilter=we):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Ee,z.map.depthTexture.magFilter=Ee);z.camera.updateProjectionMatrix()}let it=z.map.isWebGLCubeRenderTarget?6:1;for(let rt=0;rt<it;rt++){if(z.map.isWebGLCubeRenderTarget)i.setRenderTarget(z.map,rt),i.clear();else{rt===0&&(i.setRenderTarget(z.map),i.clear());let _t=z.getViewport(rt);o.set(r.x*_t.x,r.y*_t.y,r.x*_t.z,r.y*_t.w),L.viewport(o)}if(k.isPointLight){let _t=z.camera,jt=z.matrix,ue=k.distance||_t.far;ue!==_t.far&&(_t.far=ue,_t.updateProjectionMatrix()),Fs.setFromMatrixPosition(k.matrixWorld),_t.position.copy(Fs),il.copy(_t.position),il.add(ng[rt]),_t.up.copy(ig[rt]),_t.lookAt(il),_t.updateMatrixWorld(),jt.makeTranslation(-Fs.x,-Fs.y,-Fs.z),nh.multiplyMatrices(_t.projectionMatrix,_t.matrixWorldInverse),z._frustum.setFromProjectionMatrix(nh,_t.coordinateSystem,_t.reversedDepth)}else z.updateMatrices(k);n=z.getFrustum(),S(T,x,z.camera,k,this.type)}z.isPointLightShadow!==!0&&this.type===Yi&&E(z,x),z.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(w,R,I)};function E(M,T){let x=t.update(v);u.defines.VSM_SAMPLES!==M.blurSamples&&(u.defines.VSM_SAMPLES=M.blurSamples,f.defines.VSM_SAMPLES=M.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),M.mapPass===null&&(M.mapPass=new Xe(s.x,s.y,{format:Jn,type:xn})),u.uniforms.shadow_pass.value=M.map.depthTexture,u.uniforms.resolution.value=M.mapSize,u.uniforms.radius.value=M.radius,i.setRenderTarget(M.mapPass),i.clear(),i.renderBufferDirect(T,null,x,u,v,null),f.uniforms.shadow_pass.value=M.mapPass.texture,f.uniforms.resolution.value=M.mapSize,f.uniforms.radius.value=M.radius,i.setRenderTarget(M.map),i.clear(),i.renderBufferDirect(T,null,x,f,v,null)}function C(M,T,x,w){let R=null,I=x.isPointLight===!0?M.customDistanceMaterial:M.customDepthMaterial;if(I!==void 0)R=I;else if(R=x.isPointLight===!0?l:a,i.localClippingEnabled&&T.clipShadows===!0&&Array.isArray(T.clippingPlanes)&&T.clippingPlanes.length!==0||T.displacementMap&&T.displacementScale!==0||T.alphaMap&&T.alphaTest>0||T.map&&T.alphaTest>0||T.alphaToCoverage===!0){let L=R.uuid,X=T.uuid,W=c[L];W===void 0&&(W={},c[L]=W);let P=W[X];P===void 0&&(P=R.clone(),W[X]=P,T.addEventListener("dispose",y)),R=P}if(R.visible=T.visible,R.wireframe=T.wireframe,w===Yi?R.side=T.shadowSide!==null?T.shadowSide:T.side:R.side=T.shadowSide!==null?T.shadowSide:d[T.side],R.alphaMap=T.alphaMap,R.alphaTest=T.alphaToCoverage===!0?.5:T.alphaTest,R.map=T.map,R.clipShadows=T.clipShadows,R.clippingPlanes=T.clippingPlanes,R.clipIntersection=T.clipIntersection,R.displacementMap=T.displacementMap,R.displacementScale=T.displacementScale,R.displacementBias=T.displacementBias,R.wireframeLinewidth=T.wireframeLinewidth,R.linewidth=T.linewidth,x.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let L=i.properties.get(R);L.light=x}return R}function S(M,T,x,w,R){if(M.visible===!1)return;if(M.layers.test(T.layers)&&(M.isMesh||M.isLine||M.isPoints)&&(M.castShadow||M.receiveShadow&&R===Yi)&&(!M.frustumCulled||n.intersectsObject(M))){M.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,M.matrixWorld);let X=t.update(M),W=M.material;if(Array.isArray(W)){let P=X.groups;for(let k=0,z=P.length;k<z;k++){let $=P[k],tt=W[$.materialIndex];if(tt&&tt.visible){let it=C(M,tt,w,R);M.onBeforeShadow(i,M,T,x,X,it,$),i.renderBufferDirect(x,null,X,it,M,$),M.onAfterShadow(i,M,T,x,X,it,$)}}}else if(W.visible){let P=C(M,W,w,R);M.onBeforeShadow(i,M,T,x,X,P,null),i.renderBufferDirect(x,null,X,P,M,null),M.onAfterShadow(i,M,T,x,X,P,null)}}let L=M.children;for(let X=0,W=L.length;X<W;X++)S(L[X],T,x,w,R)}function y(M){M.target.removeEventListener("dispose",y);for(let x in c){let w=c[x],R=M.target.uuid;R in w&&(w[R].dispose(),delete w[R])}}}function rg(i,t){function e(){let U=!1,ct=new pe,K=null,ft=new pe(0,0,0,0);return{setMask:function(vt){K!==vt&&!U&&(i.colorMask(vt,vt,vt,vt),K=vt)},setLocked:function(vt){U=vt},setClear:function(vt,et,Tt,St,me){me===!0&&(vt*=St,et*=St,Tt*=St),ct.set(vt,et,Tt,St),ft.equals(ct)===!1&&(i.clearColor(vt,et,Tt,St),ft.copy(ct))},reset:function(){U=!1,K=null,ft.set(-1,0,0,0)}}}function n(){let U=!1,ct=!1,K=null,ft=null,vt=null;return{setReversed:function(et){if(ct!==et){let Tt=t.get("EXT_clip_control");et?Tt.clipControlEXT(Tt.LOWER_LEFT_EXT,Tt.ZERO_TO_ONE_EXT):Tt.clipControlEXT(Tt.LOWER_LEFT_EXT,Tt.NEGATIVE_ONE_TO_ONE_EXT),ct=et;let St=vt;vt=null,this.setClear(St)}},getReversed:function(){return ct},setTest:function(et){et?nt(i.DEPTH_TEST):Ot(i.DEPTH_TEST)},setMask:function(et){K!==et&&!U&&(i.depthMask(et),K=et)},setFunc:function(et){if(ct&&(et=Pc[et]),ft!==et){switch(et){case fr:i.depthFunc(i.NEVER);break;case pr:i.depthFunc(i.ALWAYS);break;case mr:i.depthFunc(i.LESS);break;case ai:i.depthFunc(i.LEQUAL);break;case gr:i.depthFunc(i.EQUAL);break;case xr:i.depthFunc(i.GEQUAL);break;case _r:i.depthFunc(i.GREATER);break;case vr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ft=et}},setLocked:function(et){U=et},setClear:function(et){vt!==et&&(vt=et,ct&&(et=1-et),i.clearDepth(et))},reset:function(){U=!1,K=null,ft=null,vt=null,ct=!1}}}function s(){let U=!1,ct=null,K=null,ft=null,vt=null,et=null,Tt=null,St=null,me=null;return{setTest:function(ae){U||(ae?nt(i.STENCIL_TEST):Ot(i.STENCIL_TEST))},setMask:function(ae){ct!==ae&&!U&&(i.stencilMask(ae),ct=ae)},setFunc:function(ae,cn,hn){(K!==ae||ft!==cn||vt!==hn)&&(i.stencilFunc(ae,cn,hn),K=ae,ft=cn,vt=hn)},setOp:function(ae,cn,hn){(et!==ae||Tt!==cn||St!==hn)&&(i.stencilOp(ae,cn,hn),et=ae,Tt=cn,St=hn)},setLocked:function(ae){U=ae},setClear:function(ae){me!==ae&&(i.clearStencil(ae),me=ae)},reset:function(){U=!1,ct=null,K=null,ft=null,vt=null,et=null,Tt=null,St=null,me=null}}}let r=new e,o=new n,a=new s,l=new WeakMap,c=new WeakMap,h={},d={},u={},f=new WeakMap,g=[],v=null,m=!1,p=null,E=null,C=null,S=null,y=null,M=null,T=null,x=new Wt(0,0,0),w=0,R=!1,I=null,L=null,X=null,W=null,P=null,k=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),z=!1,$=0,tt=i.getParameter(i.VERSION);tt.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(tt)[1]),z=$>=1):tt.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(tt)[1]),z=$>=2);let it=null,rt={},_t=i.getParameter(i.SCISSOR_BOX),jt=i.getParameter(i.VIEWPORT),ue=new pe().fromArray(_t),Qt=new pe().fromArray(jt);function j(U,ct,K,ft){let vt=new Uint8Array(4),et=i.createTexture();i.bindTexture(U,et),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Tt=0;Tt<K;Tt++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(ct,0,i.RGBA,1,1,ft,0,i.RGBA,i.UNSIGNED_BYTE,vt):i.texImage2D(ct+Tt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,vt);return et}let at={};at[i.TEXTURE_2D]=j(i.TEXTURE_2D,i.TEXTURE_2D,1),at[i.TEXTURE_CUBE_MAP]=j(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),at[i.TEXTURE_2D_ARRAY]=j(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),at[i.TEXTURE_3D]=j(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),nt(i.DEPTH_TEST),o.setFunc(ai),Et(!1),Mt(wa),nt(i.CULL_FACE),ot(gn);function nt(U){h[U]!==!0&&(i.enable(U),h[U]=!0)}function Ot(U){h[U]!==!1&&(i.disable(U),h[U]=!1)}function Lt(U,ct){return u[U]!==ct?(i.bindFramebuffer(U,ct),u[U]=ct,U===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=ct),U===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=ct),!0):!1}function At(U,ct){let K=g,ft=!1;if(U){K=f.get(ct),K===void 0&&(K=[],f.set(ct,K));let vt=U.textures;if(K.length!==vt.length||K[0]!==i.COLOR_ATTACHMENT0){for(let et=0,Tt=vt.length;et<Tt;et++)K[et]=i.COLOR_ATTACHMENT0+et;K.length=vt.length,ft=!0}}else K[0]!==i.BACK&&(K[0]=i.BACK,ft=!0);ft&&i.drawBuffers(K)}function de(U){return v!==U?(i.useProgram(U),v=U,!0):!1}let F={[Vn]:i.FUNC_ADD,[tc]:i.FUNC_SUBTRACT,[ec]:i.FUNC_REVERSE_SUBTRACT};F[nc]=i.MIN,F[ic]=i.MAX;let J={[sc]:i.ZERO,[rc]:i.ONE,[oc]:i.SRC_COLOR,[ur]:i.SRC_ALPHA,[dc]:i.SRC_ALPHA_SATURATE,[hc]:i.DST_COLOR,[lc]:i.DST_ALPHA,[ac]:i.ONE_MINUS_SRC_COLOR,[dr]:i.ONE_MINUS_SRC_ALPHA,[uc]:i.ONE_MINUS_DST_COLOR,[cc]:i.ONE_MINUS_DST_ALPHA,[fc]:i.CONSTANT_COLOR,[pc]:i.ONE_MINUS_CONSTANT_COLOR,[mc]:i.CONSTANT_ALPHA,[gc]:i.ONE_MINUS_CONSTANT_ALPHA};function ot(U,ct,K,ft,vt,et,Tt,St,me,ae){if(U===gn){m===!0&&(Ot(i.BLEND),m=!1);return}if(m===!1&&(nt(i.BLEND),m=!0),U!==Ql){if(U!==p||ae!==R){if((E!==Vn||y!==Vn)&&(i.blendEquation(i.FUNC_ADD),E=Vn,y=Vn),ae)switch(U){case oi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ta:i.blendFunc(i.ONE,i.ONE);break;case Aa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ca:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Vt("WebGLState: Invalid blending: ",U);break}else switch(U){case oi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ta:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Aa:Vt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Ca:Vt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Vt("WebGLState: Invalid blending: ",U);break}C=null,S=null,M=null,T=null,x.set(0,0,0),w=0,p=U,R=ae}return}vt=vt||ct,et=et||K,Tt=Tt||ft,(ct!==E||vt!==y)&&(i.blendEquationSeparate(F[ct],F[vt]),E=ct,y=vt),(K!==C||ft!==S||et!==M||Tt!==T)&&(i.blendFuncSeparate(J[K],J[ft],J[et],J[Tt]),C=K,S=ft,M=et,T=Tt),(St.equals(x)===!1||me!==w)&&(i.blendColor(St.r,St.g,St.b,me),x.copy(St),w=me),p=U,R=!1}function lt(U,ct){U.side===Oe?Ot(i.CULL_FACE):nt(i.CULL_FACE);let K=U.side===Te;ct&&(K=!K),Et(K),U.blending===oi&&U.transparent===!1?ot(gn):ot(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),r.setMask(U.colorWrite);let ft=U.stencilWrite;a.setTest(ft),ft&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Ct(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?nt(i.SAMPLE_ALPHA_TO_COVERAGE):Ot(i.SAMPLE_ALPHA_TO_COVERAGE)}function Et(U){I!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),I=U)}function Mt(U){U!==Jl?(nt(i.CULL_FACE),U!==L&&(U===wa?i.cullFace(i.BACK):U===Kl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Ot(i.CULL_FACE),L=U}function Dt(U){U!==X&&(z&&i.lineWidth(U),X=U)}function Ct(U,ct,K){U?(nt(i.POLYGON_OFFSET_FILL),(W!==ct||P!==K)&&(W=ct,P=K,o.getReversed()&&(ct=-ct),i.polygonOffset(ct,K))):Ot(i.POLYGON_OFFSET_FILL)}function zt(U){U?nt(i.SCISSOR_TEST):Ot(i.SCISSOR_TEST)}function Nt(U){U===void 0&&(U=i.TEXTURE0+k-1),it!==U&&(i.activeTexture(U),it=U)}function D(U,ct,K){K===void 0&&(it===null?K=i.TEXTURE0+k-1:K=it);let ft=rt[K];ft===void 0&&(ft={type:void 0,texture:void 0},rt[K]=ft),(ft.type!==U||ft.texture!==ct)&&(it!==K&&(i.activeTexture(K),it=K),i.bindTexture(U,ct||at[U]),ft.type=U,ft.texture=ct)}function ee(){let U=rt[it];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function Ht(){try{i.compressedTexImage2D(...arguments)}catch(U){Vt("WebGLState:",U)}}function A(){try{i.compressedTexImage3D(...arguments)}catch(U){Vt("WebGLState:",U)}}function _(){try{i.texSubImage2D(...arguments)}catch(U){Vt("WebGLState:",U)}}function B(){try{i.texSubImage3D(...arguments)}catch(U){Vt("WebGLState:",U)}}function V(){try{i.compressedTexSubImage2D(...arguments)}catch(U){Vt("WebGLState:",U)}}function Y(){try{i.compressedTexSubImage3D(...arguments)}catch(U){Vt("WebGLState:",U)}}function st(){try{i.texStorage2D(...arguments)}catch(U){Vt("WebGLState:",U)}}function ht(){try{i.texStorage3D(...arguments)}catch(U){Vt("WebGLState:",U)}}function Z(){try{i.texImage2D(...arguments)}catch(U){Vt("WebGLState:",U)}}function Q(){try{i.texImage3D(...arguments)}catch(U){Vt("WebGLState:",U)}}function ut(U){return d[U]!==void 0?d[U]:i.getParameter(U)}function Rt(U,ct){d[U]!==ct&&(i.pixelStorei(U,ct),d[U]=ct)}function pt(U){ue.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),ue.copy(U))}function dt(U){Qt.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),Qt.copy(U))}function Ut(U,ct){let K=c.get(ct);K===void 0&&(K=new WeakMap,c.set(ct,K));let ft=K.get(U);ft===void 0&&(ft=i.getUniformBlockIndex(ct,U.name),K.set(U,ft))}function kt(U,ct){let ft=c.get(ct).get(U);l.get(ct)!==ft&&(i.uniformBlockBinding(ct,ft,U.__bindingPointIndex),l.set(ct,ft))}function Xt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},d={},it=null,rt={},u={},f=new WeakMap,g=[],v=null,m=!1,p=null,E=null,C=null,S=null,y=null,M=null,T=null,x=new Wt(0,0,0),w=0,R=!1,I=null,L=null,X=null,W=null,P=null,ue.set(0,0,i.canvas.width,i.canvas.height),Qt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:nt,disable:Ot,bindFramebuffer:Lt,drawBuffers:At,useProgram:de,setBlending:ot,setMaterial:lt,setFlipSided:Et,setCullFace:Mt,setLineWidth:Dt,setPolygonOffset:Ct,setScissorTest:zt,activeTexture:Nt,bindTexture:D,unbindTexture:ee,compressedTexImage2D:Ht,compressedTexImage3D:A,texImage2D:Z,texImage3D:Q,pixelStorei:Rt,getParameter:ut,updateUBOMapping:Ut,uniformBlockBinding:kt,texStorage2D:st,texStorage3D:ht,texSubImage2D:_,texSubImage3D:B,compressedTexSubImage2D:V,compressedTexSubImage3D:Y,scissor:pt,viewport:dt,reset:Xt}}function og(i,t,e,n,s,r,o){let a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Yt,h=new WeakMap,d=new Set,u,f=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(A,_){return g?new OffscreenCanvas(A,_):hs("canvas")}function m(A,_,B){let V=1,Y=Ht(A);if((Y.width>B||Y.height>B)&&(V=B/Math.max(Y.width,Y.height)),V<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){let st=Math.floor(V*Y.width),ht=Math.floor(V*Y.height);u===void 0&&(u=v(st,ht));let Z=_?v(st,ht):u;return Z.width=st,Z.height=ht,Z.getContext("2d").drawImage(A,0,0,st,ht),Bt("WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+st+"x"+ht+")."),Z}else return"data"in A&&Bt("WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),A;return A}function p(A){return A.generateMipmaps}function E(A){i.generateMipmap(A)}function C(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function S(A,_,B,V,Y,st=!1){if(A!==null){if(i[A]!==void 0)return i[A];Bt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let ht;V&&(ht=t.get("EXT_texture_norm16"),ht||Bt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Z=_;if(_===i.RED&&(B===i.FLOAT&&(Z=i.R32F),B===i.HALF_FLOAT&&(Z=i.R16F),B===i.UNSIGNED_BYTE&&(Z=i.R8),B===i.UNSIGNED_SHORT&&ht&&(Z=ht.R16_EXT),B===i.SHORT&&ht&&(Z=ht.R16_SNORM_EXT)),_===i.RED_INTEGER&&(B===i.UNSIGNED_BYTE&&(Z=i.R8UI),B===i.UNSIGNED_SHORT&&(Z=i.R16UI),B===i.UNSIGNED_INT&&(Z=i.R32UI),B===i.BYTE&&(Z=i.R8I),B===i.SHORT&&(Z=i.R16I),B===i.INT&&(Z=i.R32I)),_===i.RG&&(B===i.FLOAT&&(Z=i.RG32F),B===i.HALF_FLOAT&&(Z=i.RG16F),B===i.UNSIGNED_BYTE&&(Z=i.RG8),B===i.UNSIGNED_SHORT&&ht&&(Z=ht.RG16_EXT),B===i.SHORT&&ht&&(Z=ht.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(B===i.UNSIGNED_BYTE&&(Z=i.RG8UI),B===i.UNSIGNED_SHORT&&(Z=i.RG16UI),B===i.UNSIGNED_INT&&(Z=i.RG32UI),B===i.BYTE&&(Z=i.RG8I),B===i.SHORT&&(Z=i.RG16I),B===i.INT&&(Z=i.RG32I)),_===i.RGB_INTEGER&&(B===i.UNSIGNED_BYTE&&(Z=i.RGB8UI),B===i.UNSIGNED_SHORT&&(Z=i.RGB16UI),B===i.UNSIGNED_INT&&(Z=i.RGB32UI),B===i.BYTE&&(Z=i.RGB8I),B===i.SHORT&&(Z=i.RGB16I),B===i.INT&&(Z=i.RGB32I)),_===i.RGBA_INTEGER&&(B===i.UNSIGNED_BYTE&&(Z=i.RGBA8UI),B===i.UNSIGNED_SHORT&&(Z=i.RGBA16UI),B===i.UNSIGNED_INT&&(Z=i.RGBA32UI),B===i.BYTE&&(Z=i.RGBA8I),B===i.SHORT&&(Z=i.RGBA16I),B===i.INT&&(Z=i.RGBA32I)),_===i.RGB&&(B===i.UNSIGNED_SHORT&&ht&&(Z=ht.RGB16_EXT),B===i.SHORT&&ht&&(Z=ht.RGB16_SNORM_EXT),B===i.UNSIGNED_INT_5_9_9_9_REV&&(Z=i.RGB9_E5),B===i.UNSIGNED_INT_10F_11F_11F_REV&&(Z=i.R11F_G11F_B10F)),_===i.RGBA){let Q=st?cs:Jt.getTransfer(Y);B===i.FLOAT&&(Z=i.RGBA32F),B===i.HALF_FLOAT&&(Z=i.RGBA16F),B===i.UNSIGNED_BYTE&&(Z=Q===ne?i.SRGB8_ALPHA8:i.RGBA8),B===i.UNSIGNED_SHORT&&ht&&(Z=ht.RGBA16_EXT),B===i.SHORT&&ht&&(Z=ht.RGBA16_SNORM_EXT),B===i.UNSIGNED_SHORT_4_4_4_4&&(Z=i.RGBA4),B===i.UNSIGNED_SHORT_5_5_5_1&&(Z=i.RGB5_A1)}return(Z===i.R16F||Z===i.R32F||Z===i.RG16F||Z===i.RG32F||Z===i.RGBA16F||Z===i.RGBA32F)&&t.get("EXT_color_buffer_float"),Z}function y(A,_){let B;return A?_===null||_===on||_===Zi?B=i.DEPTH24_STENCIL8:_===an?B=i.DEPTH32F_STENCIL8:_===$i&&(B=i.DEPTH24_STENCIL8,Bt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===on||_===Zi?B=i.DEPTH_COMPONENT24:_===an?B=i.DEPTH_COMPONENT32F:_===$i&&(B=i.DEPTH_COMPONENT16),B}function M(A,_){return p(A)===!0||A.isFramebufferTexture&&A.minFilter!==Ee&&A.minFilter!==we?Math.log2(Math.max(_.width,_.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?_.mipmaps.length:1}function T(A){let _=A.target;_.removeEventListener("dispose",T),w(_),_.isVideoTexture&&h.delete(_),_.isHTMLTexture&&d.delete(_)}function x(A){let _=A.target;_.removeEventListener("dispose",x),I(_)}function w(A){let _=n.get(A);if(_.__webglInit===void 0)return;let B=A.source,V=f.get(B);if(V){let Y=V[_.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&R(A),Object.keys(V).length===0&&f.delete(B)}n.remove(A)}function R(A){let _=n.get(A);i.deleteTexture(_.__webglTexture);let B=A.source,V=f.get(B);delete V[_.__cacheKey],o.memory.textures--}function I(A){let _=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let V=0;V<6;V++){if(Array.isArray(_.__webglFramebuffer[V]))for(let Y=0;Y<_.__webglFramebuffer[V].length;Y++)i.deleteFramebuffer(_.__webglFramebuffer[V][Y]);else i.deleteFramebuffer(_.__webglFramebuffer[V]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[V])}else{if(Array.isArray(_.__webglFramebuffer))for(let V=0;V<_.__webglFramebuffer.length;V++)i.deleteFramebuffer(_.__webglFramebuffer[V]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let V=0;V<_.__webglColorRenderbuffer.length;V++)_.__webglColorRenderbuffer[V]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[V]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let B=A.textures;for(let V=0,Y=B.length;V<Y;V++){let st=n.get(B[V]);st.__webglTexture&&(i.deleteTexture(st.__webglTexture),o.memory.textures--),n.remove(B[V])}n.remove(A)}let L=0;function X(){L=0}function W(){return L}function P(A){L=A}function k(){let A=L;return A>=s.maxTextures&&Bt("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),L+=1,A}function z(A){let _=[];return _.push(A.wrapS),_.push(A.wrapT),_.push(A.wrapR||0),_.push(A.magFilter),_.push(A.minFilter),_.push(A.anisotropy),_.push(A.internalFormat),_.push(A.format),_.push(A.type),_.push(A.generateMipmaps),_.push(A.premultiplyAlpha),_.push(A.flipY),_.push(A.unpackAlignment),_.push(A.colorSpace),_.join()}function $(A,_){let B=n.get(A);if(A.isVideoTexture&&D(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&B.__version!==A.version){let V=A.image;if(V===null)Bt("WebGLRenderer: Texture marked for update but no image data found.");else if(V.complete===!1)Bt("WebGLRenderer: Texture marked for update but image is incomplete");else{Ot(B,A,_);return}}else A.isExternalTexture&&(B.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,B.__webglTexture,i.TEXTURE0+_)}function tt(A,_){let B=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&B.__version!==A.version){Ot(B,A,_);return}else A.isExternalTexture&&(B.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,B.__webglTexture,i.TEXTURE0+_)}function it(A,_){let B=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&B.__version!==A.version){Ot(B,A,_);return}e.bindTexture(i.TEXTURE_3D,B.__webglTexture,i.TEXTURE0+_)}function rt(A,_){let B=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&B.__version!==A.version){Lt(B,A,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,B.__webglTexture,i.TEXTURE0+_)}let _t={[yr]:i.REPEAT,[fn]:i.CLAMP_TO_EDGE,[br]:i.MIRRORED_REPEAT},jt={[Ee]:i.NEAREST,[vc]:i.NEAREST_MIPMAP_NEAREST,[Cs]:i.NEAREST_MIPMAP_LINEAR,[we]:i.LINEAR,[Xr]:i.LINEAR_MIPMAP_NEAREST,[$n]:i.LINEAR_MIPMAP_LINEAR},ue={[Mc]:i.NEVER,[Ac]:i.ALWAYS,[Sc]:i.LESS,[Io]:i.LEQUAL,[Ec]:i.EQUAL,[Po]:i.GEQUAL,[wc]:i.GREATER,[Tc]:i.NOTEQUAL};function Qt(A,_){if(_.type===an&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===we||_.magFilter===Xr||_.magFilter===Cs||_.magFilter===$n||_.minFilter===we||_.minFilter===Xr||_.minFilter===Cs||_.minFilter===$n)&&Bt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,_t[_.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,_t[_.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,_t[_.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,jt[_.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,jt[_.minFilter]),_.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,ue[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ee||_.minFilter!==Cs&&_.minFilter!==$n||_.type===an&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){let B=t.get("EXT_texture_filter_anisotropic");i.texParameterf(A,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function j(A,_){let B=!1;A.__webglInit===void 0&&(A.__webglInit=!0,_.addEventListener("dispose",T));let V=_.source,Y=f.get(V);Y===void 0&&(Y={},f.set(V,Y));let st=z(_);if(st!==A.__cacheKey){Y[st]===void 0&&(Y[st]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,B=!0),Y[st].usedTimes++;let ht=Y[A.__cacheKey];ht!==void 0&&(Y[A.__cacheKey].usedTimes--,ht.usedTimes===0&&R(_)),A.__cacheKey=st,A.__webglTexture=Y[st].texture}return B}function at(A,_,B){return Math.floor(Math.floor(A/B)/_)}function nt(A,_,B,V){let st=A.updateRanges;if(st.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,B,V,_.data);else{st.sort((Rt,pt)=>Rt.start-pt.start);let ht=0;for(let Rt=1;Rt<st.length;Rt++){let pt=st[ht],dt=st[Rt],Ut=pt.start+pt.count,kt=at(dt.start,_.width,4),Xt=at(pt.start,_.width,4);dt.start<=Ut+1&&kt===Xt&&at(dt.start+dt.count-1,_.width,4)===kt?pt.count=Math.max(pt.count,dt.start+dt.count-pt.start):(++ht,st[ht]=dt)}st.length=ht+1;let Z=e.getParameter(i.UNPACK_ROW_LENGTH),Q=e.getParameter(i.UNPACK_SKIP_PIXELS),ut=e.getParameter(i.UNPACK_SKIP_ROWS);e.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let Rt=0,pt=st.length;Rt<pt;Rt++){let dt=st[Rt],Ut=Math.floor(dt.start/4),kt=Math.ceil(dt.count/4),Xt=Ut%_.width,U=Math.floor(Ut/_.width),ct=kt,K=1;e.pixelStorei(i.UNPACK_SKIP_PIXELS,Xt),e.pixelStorei(i.UNPACK_SKIP_ROWS,U),e.texSubImage2D(i.TEXTURE_2D,0,Xt,U,ct,K,B,V,_.data)}A.clearUpdateRanges(),e.pixelStorei(i.UNPACK_ROW_LENGTH,Z),e.pixelStorei(i.UNPACK_SKIP_PIXELS,Q),e.pixelStorei(i.UNPACK_SKIP_ROWS,ut)}}function Ot(A,_,B){let V=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(V=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(V=i.TEXTURE_3D);let Y=j(A,_),st=_.source;e.bindTexture(V,A.__webglTexture,i.TEXTURE0+B);let ht=n.get(st);if(st.version!==ht.__version||Y===!0){if(e.activeTexture(i.TEXTURE0+B),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){let K=Jt.getPrimaries(Jt.workingColorSpace),ft=_.colorSpace===In?null:Jt.getPrimaries(_.colorSpace),vt=_.colorSpace===In||K===ft?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,vt)}e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let Q=m(_.image,!1,s.maxTextureSize);Q=ee(_,Q);let ut=r.convert(_.format,_.colorSpace),Rt=r.convert(_.type),pt=S(_.internalFormat,ut,Rt,_.normalized,_.colorSpace,_.isVideoTexture);Qt(V,_);let dt,Ut=_.mipmaps,kt=_.isVideoTexture!==!0,Xt=ht.__version===void 0||Y===!0,U=st.dataReady,ct=M(_,Q);if(_.isDepthTexture)pt=y(_.format===Zn,_.type),Xt&&(kt?e.texStorage2D(i.TEXTURE_2D,1,pt,Q.width,Q.height):e.texImage2D(i.TEXTURE_2D,0,pt,Q.width,Q.height,0,ut,Rt,null));else if(_.isDataTexture)if(Ut.length>0){kt&&Xt&&e.texStorage2D(i.TEXTURE_2D,ct,pt,Ut[0].width,Ut[0].height);for(let K=0,ft=Ut.length;K<ft;K++)dt=Ut[K],kt?U&&e.texSubImage2D(i.TEXTURE_2D,K,0,0,dt.width,dt.height,ut,Rt,dt.data):e.texImage2D(i.TEXTURE_2D,K,pt,dt.width,dt.height,0,ut,Rt,dt.data);_.generateMipmaps=!1}else kt?(Xt&&e.texStorage2D(i.TEXTURE_2D,ct,pt,Q.width,Q.height),U&&nt(_,Q,ut,Rt)):e.texImage2D(i.TEXTURE_2D,0,pt,Q.width,Q.height,0,ut,Rt,Q.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){kt&&Xt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ct,pt,Ut[0].width,Ut[0].height,Q.depth);for(let K=0,ft=Ut.length;K<ft;K++)if(dt=Ut[K],_.format!==Qe)if(ut!==null)if(kt){if(U)if(_.layerUpdates.size>0){let vt=Ka(dt.width,dt.height,_.format,_.type);for(let et of _.layerUpdates){let Tt=dt.data.subarray(et*vt/dt.data.BYTES_PER_ELEMENT,(et+1)*vt/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,K,0,0,et,dt.width,dt.height,1,ut,Tt)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,K,0,0,0,dt.width,dt.height,Q.depth,ut,dt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,K,pt,dt.width,dt.height,Q.depth,0,dt.data,0,0);else Bt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else kt?U&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,K,0,0,0,dt.width,dt.height,Q.depth,ut,Rt,dt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,K,pt,dt.width,dt.height,Q.depth,0,ut,Rt,dt.data)}else{kt&&Xt&&e.texStorage2D(i.TEXTURE_2D,ct,pt,Ut[0].width,Ut[0].height);for(let K=0,ft=Ut.length;K<ft;K++)dt=Ut[K],_.format!==Qe?ut!==null?kt?U&&e.compressedTexSubImage2D(i.TEXTURE_2D,K,0,0,dt.width,dt.height,ut,dt.data):e.compressedTexImage2D(i.TEXTURE_2D,K,pt,dt.width,dt.height,0,dt.data):Bt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):kt?U&&e.texSubImage2D(i.TEXTURE_2D,K,0,0,dt.width,dt.height,ut,Rt,dt.data):e.texImage2D(i.TEXTURE_2D,K,pt,dt.width,dt.height,0,ut,Rt,dt.data)}else if(_.isDataArrayTexture)if(kt){if(Xt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ct,pt,Q.width,Q.height,Q.depth),U)if(_.layerUpdates.size>0){let K=Ka(Q.width,Q.height,_.format,_.type);for(let ft of _.layerUpdates){let vt=Q.data.subarray(ft*K/Q.data.BYTES_PER_ELEMENT,(ft+1)*K/Q.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ft,Q.width,Q.height,1,ut,Rt,vt)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ut,Rt,Q.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,pt,Q.width,Q.height,Q.depth,0,ut,Rt,Q.data);else if(_.isData3DTexture)kt?(Xt&&e.texStorage3D(i.TEXTURE_3D,ct,pt,Q.width,Q.height,Q.depth),U&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ut,Rt,Q.data)):e.texImage3D(i.TEXTURE_3D,0,pt,Q.width,Q.height,Q.depth,0,ut,Rt,Q.data);else if(_.isFramebufferTexture){if(Xt)if(kt)e.texStorage2D(i.TEXTURE_2D,ct,pt,Q.width,Q.height);else{let K=Q.width,ft=Q.height;for(let vt=0;vt<ct;vt++)e.texImage2D(i.TEXTURE_2D,vt,pt,K,ft,0,ut,Rt,null),K>>=1,ft>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){let K=i.canvas;if(K.hasAttribute("layoutsubtree")||K.setAttribute("layoutsubtree","true"),Q.parentNode!==K){K.appendChild(Q),d.add(_),K.onpaint=ft=>{let vt=ft.changedElements;for(let et of d)vt.includes(et.image)&&(et.needsUpdate=!0)},K.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,Q);else{let vt=i.RGBA,et=i.RGBA,Tt=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,vt,et,Tt,Q)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ut.length>0){if(kt&&Xt){let K=Ht(Ut[0]);e.texStorage2D(i.TEXTURE_2D,ct,pt,K.width,K.height)}for(let K=0,ft=Ut.length;K<ft;K++)dt=Ut[K],kt?U&&e.texSubImage2D(i.TEXTURE_2D,K,0,0,ut,Rt,dt):e.texImage2D(i.TEXTURE_2D,K,pt,ut,Rt,dt);_.generateMipmaps=!1}else if(kt){if(Xt){let K=Ht(Q);e.texStorage2D(i.TEXTURE_2D,ct,pt,K.width,K.height)}U&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,ut,Rt,Q)}else e.texImage2D(i.TEXTURE_2D,0,pt,ut,Rt,Q);p(_)&&E(V),ht.__version=st.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function Lt(A,_,B){if(_.image.length!==6)return;let V=j(A,_),Y=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+B);let st=n.get(Y);if(Y.version!==st.__version||V===!0){e.activeTexture(i.TEXTURE0+B);let ht=Jt.getPrimaries(Jt.workingColorSpace),Z=_.colorSpace===In?null:Jt.getPrimaries(_.colorSpace),Q=_.colorSpace===In||ht===Z?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);let ut=_.isCompressedTexture||_.image[0].isCompressedTexture,Rt=_.image[0]&&_.image[0].isDataTexture,pt=[];for(let et=0;et<6;et++)!ut&&!Rt?pt[et]=m(_.image[et],!0,s.maxCubemapSize):pt[et]=Rt?_.image[et].image:_.image[et],pt[et]=ee(_,pt[et]);let dt=pt[0],Ut=r.convert(_.format,_.colorSpace),kt=r.convert(_.type),Xt=S(_.internalFormat,Ut,kt,_.normalized,_.colorSpace),U=_.isVideoTexture!==!0,ct=st.__version===void 0||V===!0,K=Y.dataReady,ft=M(_,dt);Qt(i.TEXTURE_CUBE_MAP,_);let vt;if(ut){U&&ct&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ft,Xt,dt.width,dt.height);for(let et=0;et<6;et++){vt=pt[et].mipmaps;for(let Tt=0;Tt<vt.length;Tt++){let St=vt[Tt];_.format!==Qe?Ut!==null?U?K&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt,0,0,St.width,St.height,Ut,St.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt,Xt,St.width,St.height,0,St.data):Bt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt,0,0,St.width,St.height,Ut,kt,St.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt,Xt,St.width,St.height,0,Ut,kt,St.data)}}}else{if(vt=_.mipmaps,U&&ct){vt.length>0&&ft++;let et=Ht(pt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ft,Xt,et.width,et.height)}for(let et=0;et<6;et++)if(Rt){U?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,pt[et].width,pt[et].height,Ut,kt,pt[et].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Xt,pt[et].width,pt[et].height,0,Ut,kt,pt[et].data);for(let Tt=0;Tt<vt.length;Tt++){let me=vt[Tt].image[et].image;U?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt+1,0,0,me.width,me.height,Ut,kt,me.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt+1,Xt,me.width,me.height,0,Ut,kt,me.data)}}else{U?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,Ut,kt,pt[et]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Xt,Ut,kt,pt[et]);for(let Tt=0;Tt<vt.length;Tt++){let St=vt[Tt];U?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt+1,0,0,Ut,kt,St.image[et]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt+1,Xt,Ut,kt,St.image[et])}}}p(_)&&E(i.TEXTURE_CUBE_MAP),st.__version=Y.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function At(A,_,B,V,Y,st){let ht=r.convert(B.format,B.colorSpace),Z=r.convert(B.type),Q=S(B.internalFormat,ht,Z,B.normalized,B.colorSpace),ut=n.get(_),Rt=n.get(B);if(Rt.__renderTarget=_,!ut.__hasExternalTextures){let pt=Math.max(1,_.width>>st),dt=Math.max(1,_.height>>st);Y===i.TEXTURE_3D||Y===i.TEXTURE_2D_ARRAY?e.texImage3D(Y,st,Q,pt,dt,_.depth,0,ht,Z,null):e.texImage2D(Y,st,Q,pt,dt,0,ht,Z,null)}e.bindFramebuffer(i.FRAMEBUFFER,A),Nt(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,V,Y,Rt.__webglTexture,0,zt(_)):(Y===i.TEXTURE_2D||Y>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,V,Y,Rt.__webglTexture,st),e.bindFramebuffer(i.FRAMEBUFFER,null)}function de(A,_,B){if(i.bindRenderbuffer(i.RENDERBUFFER,A),_.depthBuffer){let V=_.depthTexture,Y=V&&V.isDepthTexture?V.type:null,st=y(_.stencilBuffer,Y),ht=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Nt(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,zt(_),st,_.width,_.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,zt(_),st,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,st,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ht,i.RENDERBUFFER,A)}else{let V=_.textures;for(let Y=0;Y<V.length;Y++){let st=V[Y],ht=r.convert(st.format,st.colorSpace),Z=r.convert(st.type),Q=S(st.internalFormat,ht,Z,st.normalized,st.colorSpace);Nt(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,zt(_),Q,_.width,_.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,zt(_),Q,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Q,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function F(A,_,B){let V=_.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,A),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let Y=n.get(_.depthTexture);if(Y.__renderTarget=_,(!Y.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),V){if(Y.__webglInit===void 0&&(Y.__webglInit=!0,_.depthTexture.addEventListener("dispose",T)),Y.__webglTexture===void 0){Y.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Qt(i.TEXTURE_CUBE_MAP,_.depthTexture);let ut=r.convert(_.depthTexture.format),Rt=r.convert(_.depthTexture.type),pt;_.depthTexture.format===pn?pt=i.DEPTH_COMPONENT24:_.depthTexture.format===Zn&&(pt=i.DEPTH24_STENCIL8);for(let dt=0;dt<6;dt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0,pt,_.width,_.height,0,ut,Rt,null)}}else $(_.depthTexture,0);let st=Y.__webglTexture,ht=zt(_),Z=V?i.TEXTURE_CUBE_MAP_POSITIVE_X+B:i.TEXTURE_2D,Q=_.depthTexture.format===Zn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===pn)Nt(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,Z,st,0,ht):i.framebufferTexture2D(i.FRAMEBUFFER,Q,Z,st,0);else if(_.depthTexture.format===Zn)Nt(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,Z,st,0,ht):i.framebufferTexture2D(i.FRAMEBUFFER,Q,Z,st,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function J(A){let _=n.get(A),B=A.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==A.depthTexture){let V=A.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),V){let Y=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,V.removeEventListener("dispose",Y)};V.addEventListener("dispose",Y),_.__depthDisposeCallback=Y}_.__boundDepthTexture=V}if(A.depthTexture&&!_.__autoAllocateDepthBuffer)if(B)for(let V=0;V<6;V++)F(_.__webglFramebuffer[V],A,V);else{let V=A.texture.mipmaps;V&&V.length>0?F(_.__webglFramebuffer[0],A,0):F(_.__webglFramebuffer,A,0)}else if(B){_.__webglDepthbuffer=[];for(let V=0;V<6;V++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[V]),_.__webglDepthbuffer[V]===void 0)_.__webglDepthbuffer[V]=i.createRenderbuffer(),de(_.__webglDepthbuffer[V],A,!1);else{let Y=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,st=_.__webglDepthbuffer[V];i.bindRenderbuffer(i.RENDERBUFFER,st),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,st)}}else{let V=A.texture.mipmaps;if(V&&V.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),de(_.__webglDepthbuffer,A,!1);else{let Y=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,st=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,st),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,st)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function ot(A,_,B){let V=n.get(A);_!==void 0&&At(V.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),B!==void 0&&J(A)}function lt(A){let _=A.texture,B=n.get(A),V=n.get(_);A.addEventListener("dispose",x);let Y=A.textures,st=A.isWebGLCubeRenderTarget===!0,ht=Y.length>1;if(ht||(V.__webglTexture===void 0&&(V.__webglTexture=i.createTexture()),V.__version=_.version,o.memory.textures++),st){B.__webglFramebuffer=[];for(let Z=0;Z<6;Z++)if(_.mipmaps&&_.mipmaps.length>0){B.__webglFramebuffer[Z]=[];for(let Q=0;Q<_.mipmaps.length;Q++)B.__webglFramebuffer[Z][Q]=i.createFramebuffer()}else B.__webglFramebuffer[Z]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){B.__webglFramebuffer=[];for(let Z=0;Z<_.mipmaps.length;Z++)B.__webglFramebuffer[Z]=i.createFramebuffer()}else B.__webglFramebuffer=i.createFramebuffer();if(ht)for(let Z=0,Q=Y.length;Z<Q;Z++){let ut=n.get(Y[Z]);ut.__webglTexture===void 0&&(ut.__webglTexture=i.createTexture(),o.memory.textures++)}if(A.samples>0&&Nt(A)===!1){B.__webglMultisampledFramebuffer=i.createFramebuffer(),B.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let Z=0;Z<Y.length;Z++){let Q=Y[Z];B.__webglColorRenderbuffer[Z]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,B.__webglColorRenderbuffer[Z]);let ut=r.convert(Q.format,Q.colorSpace),Rt=r.convert(Q.type),pt=S(Q.internalFormat,ut,Rt,Q.normalized,Q.colorSpace,A.isXRRenderTarget===!0),dt=zt(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,dt,pt,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Z,i.RENDERBUFFER,B.__webglColorRenderbuffer[Z])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(B.__webglDepthRenderbuffer=i.createRenderbuffer(),de(B.__webglDepthRenderbuffer,A,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(st){e.bindTexture(i.TEXTURE_CUBE_MAP,V.__webglTexture),Qt(i.TEXTURE_CUBE_MAP,_);for(let Z=0;Z<6;Z++)if(_.mipmaps&&_.mipmaps.length>0)for(let Q=0;Q<_.mipmaps.length;Q++)At(B.__webglFramebuffer[Z][Q],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Q);else At(B.__webglFramebuffer[Z],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0);p(_)&&E(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ht){for(let Z=0,Q=Y.length;Z<Q;Z++){let ut=Y[Z],Rt=n.get(ut),pt=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(pt=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(pt,Rt.__webglTexture),Qt(pt,ut),At(B.__webglFramebuffer,A,ut,i.COLOR_ATTACHMENT0+Z,pt,0),p(ut)&&E(pt)}e.unbindTexture()}else{let Z=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(Z=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(Z,V.__webglTexture),Qt(Z,_),_.mipmaps&&_.mipmaps.length>0)for(let Q=0;Q<_.mipmaps.length;Q++)At(B.__webglFramebuffer[Q],A,_,i.COLOR_ATTACHMENT0,Z,Q);else At(B.__webglFramebuffer,A,_,i.COLOR_ATTACHMENT0,Z,0);p(_)&&E(Z),e.unbindTexture()}A.depthBuffer&&J(A)}function Et(A){let _=A.textures;for(let B=0,V=_.length;B<V;B++){let Y=_[B];if(p(Y)){let st=C(A),ht=n.get(Y).__webglTexture;e.bindTexture(st,ht),E(st),e.unbindTexture()}}}let Mt=[],Dt=[];function Ct(A){if(A.samples>0){if(Nt(A)===!1){let _=A.textures,B=A.width,V=A.height,Y=i.COLOR_BUFFER_BIT,st=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ht=n.get(A),Z=_.length>1;if(Z)for(let ut=0;ut<_.length;ut++)e.bindFramebuffer(i.FRAMEBUFFER,ht.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,ht.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,ht.__webglMultisampledFramebuffer);let Q=A.texture.mipmaps;Q&&Q.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ht.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ht.__webglFramebuffer);for(let ut=0;ut<_.length;ut++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(Y|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(Y|=i.STENCIL_BUFFER_BIT)),Z){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ht.__webglColorRenderbuffer[ut]);let Rt=n.get(_[ut]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Rt,0)}i.blitFramebuffer(0,0,B,V,0,0,B,V,Y,i.NEAREST),l===!0&&(Mt.length=0,Dt.length=0,Mt.push(i.COLOR_ATTACHMENT0+ut),A.depthBuffer&&A.resolveDepthBuffer===!1&&(Mt.push(st),Dt.push(st),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Dt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Mt))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Z)for(let ut=0;ut<_.length;ut++){e.bindFramebuffer(i.FRAMEBUFFER,ht.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.RENDERBUFFER,ht.__webglColorRenderbuffer[ut]);let Rt=n.get(_[ut]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,ht.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.TEXTURE_2D,Rt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ht.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){let _=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function zt(A){return Math.min(s.maxSamples,A.samples)}function Nt(A){let _=n.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function D(A){let _=o.render.frame;h.get(A)!==_&&(h.set(A,_),A.update())}function ee(A,_){let B=A.colorSpace,V=A.format,Y=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||B!==ls&&B!==In&&(Jt.getTransfer(B)===ne?(V!==Qe||Y!==Be)&&Bt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Vt("WebGLTextures: Unsupported texture color space:",B)),_}function Ht(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=k,this.resetTextureUnits=X,this.getTextureUnits=W,this.setTextureUnits=P,this.setTexture2D=$,this.setTexture2DArray=tt,this.setTexture3D=it,this.setTextureCube=rt,this.rebindTextures=ot,this.setupRenderTarget=lt,this.updateRenderTargetMipmap=Et,this.updateMultisampleRenderTarget=Ct,this.setupDepthRenderbuffer=J,this.setupFrameBufferTexture=At,this.useMultisampledRTT=Nt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function ag(i,t){function e(n,s=In){let r,o=Jt.getTransfer(s);if(n===Be)return i.UNSIGNED_BYTE;if(n===Yr)return i.UNSIGNED_SHORT_4_4_4_4;if(n===$r)return i.UNSIGNED_SHORT_5_5_5_1;if(n===ka)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Va)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Ba)return i.BYTE;if(n===za)return i.SHORT;if(n===$i)return i.UNSIGNED_SHORT;if(n===qr)return i.INT;if(n===on)return i.UNSIGNED_INT;if(n===an)return i.FLOAT;if(n===xn)return i.HALF_FLOAT;if(n===Ha)return i.ALPHA;if(n===Ga)return i.RGB;if(n===Qe)return i.RGBA;if(n===pn)return i.DEPTH_COMPONENT;if(n===Zn)return i.DEPTH_STENCIL;if(n===Wa)return i.RED;if(n===Zr)return i.RED_INTEGER;if(n===Jn)return i.RG;if(n===Jr)return i.RG_INTEGER;if(n===Kr)return i.RGBA_INTEGER;if(n===Rs||n===Is||n===Ps||n===Ls)if(o===ne)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Rs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Is)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ps)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ls)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Rs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Is)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ps)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ls)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===jr||n===Qr||n===to||n===eo)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===jr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Qr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===to)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===eo)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===no||n===io||n===so||n===ro||n===oo||n===Ds||n===ao)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===no||n===io)return o===ne?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===so)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===ro)return r.COMPRESSED_R11_EAC;if(n===oo)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Ds)return r.COMPRESSED_RG11_EAC;if(n===ao)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===lo||n===co||n===ho||n===uo||n===fo||n===po||n===mo||n===go||n===xo||n===_o||n===vo||n===yo||n===bo||n===Mo)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===lo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===co)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ho)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===uo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===fo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===po)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===mo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===go)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===xo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===_o)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===vo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===yo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===bo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Mo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===So||n===Eo||n===wo)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===So)return o===ne?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Eo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===wo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===To||n===Ao||n===Ns||n===Co)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===To)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ao)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ns)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Co)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Zi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}var lg=`
void main() {
...
`;function Xg(){if(document.getElementById(bh))return;let i=document.createElement("style");i.id=bh,i.textContent=Wg,document.head.appendChild(i)}function se(i,t,e){let n=document.createElement(i);return t&&(n.className=t),e.appendChild(n),n}function Mh(i){Xg();let{engine:t,raw:e,routeBase:n}=i,s=new Map(e.nodes.map(y=>[y.id,y])),r=!1,o=null,a=null,l=null,c=null,h=y=>`${n}#/subject/topic/${y}`,d=(y,M)=>{let T=new URLSearchParams;return T.set("q",Vo(y)),T.set("topic",y),M&&T.set("party",M),`${n}#/search?${T.toString()}`},u=y=>s.get(`party:${y}`)?.colour??"#79706E",f=y=>{let M=new Map;for(let w of e.nodes){if(w.kind!=="donor"||w.group!==y)continue;let R=zs[w.industry];R&&M.set(R,(M.get(R)??0)+w.total)}let T=null,x=-1;for(let[w,R]of M)R>x&&(x=R,T=w);return T},g=()=>{let y=a??(o?.kind==="donor"?o:null);return y?zs[y.industry]??null:l?f(l):null},v=()=>{let y=r&&c?g():null;if(!y||!c){t.setWordsOverlay(null);return}let M=vh(c,y).rows.filter(R=>s.has(`party:${R.party}`)),T=M[0]?.share??0,x=new Map;for(let R of M)T>0&&x.set(`party:${R.party}`,R.share/T);let w=new Map;for(let R of e.edges){let I=s.get(R.source);if(!I||zs[I.industry]!==y)continue;let L=x.get(R.target);L&&w.set(`${R.source}|${R.target}`,L)}t.setWordsOverlay({rings:x,edgeTint:w})},m=y=>{if(c){y(c);return}Hg().then(M=>{M&&(c=M,y(M))})};if(i.legend){let y=se("button","mm-chip mm-words-toggle",i.legend);y.type="button",y.setAttribute("aria-pressed","false"),y.title="Ring each party in bronze by its share of the selected industry's debate",se("span","mm-words-glyph",y).setAttribute("aria-hidden","true");let M=se("span","",y);M.textContent="words halo",y.addEventListener("click",()=>{r=!r,y.setAttribute("aria-pressed",String(r)),r?m(v):v()})}let p=(y,M,T,x)=>{let w=se("li","",y),R=se("a","mm-words-row mm-words-row-party",w);R.href=d(x,M.party),R.title=`${M.party}: ${M.count.toLocaleString("en-AU")} labelled ${Vo(x)} speeches so far. Opens the filtered search.`;let I=se("span","mm-dot",R);I.style.background=u(M.party);let L=se("span","mm-words-name",R);L.textContent=M.party;let X=se("span","mm-words-track",R);X.setAttribute("aria-hidden","true");let W=se("i","",X),P=T>0?M.share/T:0;W.style.width=`${Math.max(P*100,1.5)}%`,W.style.opacity=String(.35+.65*P);let k=se("span","mm-words-pct",R);k.textContent=yh(M.share)},E=(y,M,T)=>{let x=zs[M.industry];if(!x)return;let{total:w,rows:R}=vh(T,x);if(w<=0||R.length===0)return;let I=se("div","mm-legend-title",y);I.textContent="In parliament";let L=se("p","mm-words-lead",y),X=se("a","",L);X.href=h(x),X.textContent=xl[x]??x,L.append(": ");let W=se("b","",L);if(W.textContent=w.toLocaleString("en-AU"),L.append(" labelled speeches so far"),w<zg){let tt=se("span","mm-words-few",L);tt.textContent=" \xB7 few labels yet, shares will move"}let P=se("ul","mm-words-rows",y),k=R[0]?.share??0;for(let tt of R)p(P,tt,k,x);let z=se("p","mm-words-fine",y);z.append("Each party's share of the speeches labelled with this topic. ");let $=se("a","",z);$.href=h(x),$.textContent=`All ${Vo(x)} speeches`},C=(y,M,T)=>{let x=M.label;if(!T.parties.includes(x))return;let w=new Map;for(let P of e.edges){if(P.target!==M.id)continue;let k=s.get(P.source),z=k?zs[k.industry]:void 0;z&&w.set(z,(w.get(z)??0)+P.total)}let R=[...w.entries()].map(([P,k])=>{let z=T.totals[P]??0,$=T.cells[P]?.[x]??0;return{slug:P,dollars:k,count:$,share:z>0?$/z:0}}).filter(P=>P.count>0).sort((P,k)=>k.share-P.share||k.dollars-P.dollars).slice(0,5);if(R.length===0)return;let I=se("div","mm-legend-title",y);I.textContent="What they talk about";let L=se("ul","mm-words-rows",y),X=R[0]?.share??0;for(let P of R){let k=se("li","",L),z=se("a","mm-words-row mm-words-row-topic",k);z.href=h(P.slug),z.title=`${x}: ${P.count.toLocaleString("en-AU")} of ${(T.totals[P.slug]??0).toLocaleString("en-AU")} labelled ${Vo(P.slug)} speeches so far; ${Ue(P.dollars)} disclosed from the matching donors. Opens the topic page.`;let $=se("span","mm-words-name",z);$.textContent=xl[P.slug]??P.slug;let tt=se("span","mm-words-track",z);tt.setAttribute("aria-hidden","true");let it=se("i","",tt),rt=X>0?P.share/X:0;it.style.width=`${Math.max(rt*100,1.5)}%`,it.style.opacity=String(.35+.65*rt);let _t=se("span","mm-words-pct",z);_t.textContent=yh(P.share);let jt=se("span","mm-words-money",z);jt.textContent=Ue(P.dollars)}let W=se("p","mm-words-fine",y);W.textContent=`${x}'s share of each debate's labelled speeches so far, beside what it received from donors in the matching industry. Shown together for comparison, not as cause.`},S=(y,M)=>{let T=document.createElement("div");T.className="mm-words",T.hidden=!0;let x=y.querySelector(".mm-ask");x?y.insertBefore(T,x):y.appendChild(T),m(w=>{T.isConnected&&(M.kind==="donor"?E(T,M,w):C(T,M,w),T.hidden=T.childElementCount===0)})};return{select(y,M){o=y,a=null,y&&S(M,y),r&&m(v)},selectEdge(y){o=null,a=y?s.get(y.source)??null:null,r&&m(v)},isolate(y){l=y,r&&m(v)}}}var Sh=1e4;function ts(i,t){return i?i===t?`${i}`:`${i}\u2013${t}`:""}function qg(i){let t=new Map,e=0;for(let a of mi.keys())t.set(a,e++);let n=new Map;for(let a of i.nodes)n.set(a.group,(n.get(a.group)??0)+1);let s=new Map;for(let[a,l]of n){let c=yn(a);s.set(a,{slot:t.get(a)??t.get("other")??0,colour:c.colour,ink:c.ink,hollow:!1,count:l})}let r=i.nodes.map(a=>({id:a.id,label:a.label,group:a.group,weight:a.total/Sh,kind:a.kind,industry:a.industry,total:a.total,count:a.count,firstYear:a.firstYear,lastYear:a.lastYear,...a.colour?{colour:a.colour}:{}})),o=i.edges.map(a=>({source:a.source,target:a.target,label:Ue(a.total),weight:a.total/Sh,total:a.total,count:a.count,firstYear:a.firstYear,lastYear:a.lastYear}));return{nodes:r,edges:o,groupStyles:s,degrees:Gs(o)}}var Eh="money-map-styles",Yg=`
...
.mm-root { position: relative; overflow: hidden; background: ${fi};
...
.mm-canvas:focus-visible { outline: 2px solid ${pi}; }
...
.rp-map3d-label { position: absolute; top: 0; left: 0; white-space: nowrap;
  ...
  text-shadow: 0 0 4px ${fi}, 0 0 8px ${fi}; }
...
.rp-map3d-territory { position: absolute; top: 0; left: 0; white-space: nowrap;
  ...
  text-shadow: 0 0 4px ${fi}; transition: opacity 160ms; }
...
.mm-card { position: absolute; top: 12px; right: 12px; width: 330px;
  ...
  outline: none; }
.mm-card:focus-visible { outline: 2px solid ${pi}; }
...
.mm-find input:focus-visible { outline: 2px solid ${pi}; }
...
.mm-scrub input[type='range'] { width: 100%; margin: 2px 0; accent-color: ${pi}; }
...
`;function $g(){if(document.getElementById(Eh))return;let i=document.createElement("style");i.id=Eh,i.textContent=Yg,document.head.appendChild(i)}function Ft(i,t,e){let n=document.createElement(i);return t&&(n.className=t),e.appendChild(n),n}async function zv(i,t,e={}){$g(),i.classList.add("mm-root");let n=await fetch(t);if(!n.ok)throw new Error(`money map data: HTTP ${n.status} for ${t}`);let s=await n.json();if(!xh()){let F=Ft("div","mm-fallback",i);F.textContent="The 3D money map needs WebGL, which this browser does not offer. The underlying data is available as JSON at "+t;let J=()=>{};return{select:J,isolate:J,fit:J,setPaused:J,destroy:()=>F.remove()}}let r=qg(s),o=new Map(s.nodes.map(F=>[F.id,F])),a=e.chrome??"full";i.dataset.mmChrome=a;let l=location.pathname==="/"?"":"/",c=e.askUrl??(F=>`${l}#/ask?q=${encodeURIComponent(`What has parliament said about ${F}?`)}`),h=2026,d=1998;for(let F of s.edges)F.firstYear&&(h=Math.min(h,F.firstYear)),F.lastYear&&(d=Math.max(d,F.lastYear));let u=h,f=d,g=Ft("canvas","mm-canvas",i);g.tabIndex=0,g.setAttribute("role","application"),g.setAttribute("aria-label","Money map - drag to orbit, pinch or scroll to zoom, click a node for details. With the keyboard: arrows orbit, plus and minus zoom, Enter selects the node nearest the middle, Escape clears the selection.");let v=Ft("div","mm-labels",i);v.setAttribute("aria-hidden","true");let m=a==="full",p=m?Ft("div","mm-legend",i):null;if(p){let F=Ft("div","mm-legend-title",p);F.textContent="Industries \xB7 click to isolate"}let E=Ft("div","mm-card",i);E.tabIndex=-1,E.setAttribute("role","region"),E.setAttribute("aria-label","Details for the selected node"),E.hidden=!0;let C=m?Ft("div","mm-zoom",i):null;if(C){let F=(J,ot,lt)=>{let Et=Ft("button","",C);Et.type="button",Et.textContent=J,Et.setAttribute("aria-label",ot),Et.title=ot,Et.addEventListener("click",lt)};F("+","Zoom in",()=>x.zoomBy(1.3)),F("\u2212","Zoom out",()=>x.zoomBy(1/1.3)),F("\u2922","Fit the whole map to view",()=>x.fit(!0))}let S=m?Ft("p","mm-hint",i):null;if(S){let F=typeof s.meta?.sourceShort=="string"?s.meta.sourceShort:"AEC returns";S.textContent=`Drag to orbit \xB7 scroll to zoom \xB7 click a cluster to open it \xB7 click a node or a flow \xB7 ${F} ${s.meta?.coverage??"1998\u20132026"}`}let y=null,M=null,T=null,x=new ko(g,v,F=>Lt(F,{user:!0}),()=>{g.replaceWith(Object.assign(document.createElement("div"),{className:"mm-fallback",textContent:"The 3D view lost its graphics context. Reload the page to restart it."}))});x.onEdgePick=F=>At(F);let w=Mh({engine:x,raw:s,legend:p,routeBase:l}),R=()=>{let F=i.getBoundingClientRect();if(F.width<1||F.height<1)return 1.5;let J=F.width/F.height;return J<1?.8:J<1.45?1.2:1.9},I="",L=()=>{let F=u>h||f<d,J=Nt=>!F||(Nt.firstYear??h)<=f&&(Nt.lastYear??d)>=u,ot=r.edges.filter(J),lt=new Set(ot.map(Nt=>Nt.source)),Et=r.nodes.filter(Nt=>Nt.group==="parties"?!0:T!==null&&Nt.group!==T?!1:!F||lt.has(Nt.id)),Mt=new Set(Et.map(Nt=>Nt.id)),Dt=ot.filter(Nt=>Mt.has(Nt.source)&&Mt.has(Nt.target)),Ct={nodes:Et,edges:Dt,groupStyles:r.groupStyles,degrees:Gs(Dt),measure:"resources",layout:"grouped",aspect:R(),centralGroup:"parties"};x.setData(Ct);let zt=`${Ct.aspect}|${T??"*"}`;if(zt!==I){let Nt=I==="";I=zt,x.setInsets(Ot()),x.fit(!Nt)}y&&!Mt.has(y)&&Lt(null),M&&!Dt.includes(M)&&At(null)},X=R(),W=new ResizeObserver(()=>{let F=i.getBoundingClientRect();if(F.width<1||F.height<1)return;x.setInsets(Ot());let J=R();J!==X?(X=J,L()):x.viewOwned||x.fit(!1)});W.observe(i);let P=new Map,k=F=>{T=F!==null&&F!=="parties"&&r.groupStyles.has(F)?F:null;for(let[J,ot]of P)ot.setAttribute("aria-pressed",String(J===T)),T!==null&&J!==T?ot.setAttribute("data-dimmed",""):ot.removeAttribute("data-dimmed");L(),w.isolate(T)};if(p){let F=[...mi.keys()].filter(J=>J!=="parties"&&r.groupStyles.has(J));for(let J of F){let ot=Ft("button","mm-chip",p);ot.type="button",ot.setAttribute("aria-pressed","false");let lt=Ft("span","mm-dot",ot);lt.style.background=yn(J).colour;let Et=Ft("span","",ot);Et.textContent=`${J} \xB7 ${r.groupStyles.get(J)?.count??0}`,ot.addEventListener("click",()=>k(T===J?null:J)),P.set(J,ot)}}let z=m?Ft("div","mm-find",i):null;if(z){let F=Ft("input","",z);F.type="search",F.placeholder="Find a donor or party\u2026",F.setAttribute("aria-label","Find a donor or party by name");let J=Ft("ul","mm-find-list",z),ot=()=>{let lt=F.value.trim().toLowerCase();if(J.replaceChildren(),lt.length<2)return;let Et=r.nodes.map(Mt=>{let Dt=Mt.label.toLowerCase(),Ct=Dt.indexOf(lt),zt=Ct===0?0:Dt.includes(` ${lt}`)?1:Ct>0?2:-1;return{n:Mt,score:zt,at:Ct}}).filter(Mt=>Mt.score>=0).sort((Mt,Dt)=>Mt.score-Dt.score||Mt.n.label.length-Dt.n.label.length).slice(0,8);for(let{n:Mt}of Et){let Dt=Ft("li","",J),Ct=Ft("button","",Dt);Ct.type="button";let zt=Ft("span","mm-dot",Ct);zt.style.background=Mt.colour??yn(Mt.group).colour;let Nt=Ft("span","mm-row-name",Ct);Nt.textContent=Mt.label,Ct.addEventListener("click",()=>{F.value="",J.replaceChildren(),Lt(Mt.id,{user:!0})})}};F.addEventListener("input",ot),F.addEventListener("keydown",lt=>{lt.key==="Enter"&&J.querySelector("button")?.click(),lt.key==="Escape"&&(F.value="",J.replaceChildren(),lt.stopPropagation())})}let $=m&&d>h?Ft("div","mm-scrub",i):null;if($){let F=Ft("div","mm-scrub-label",$),J=Ft("span","",F);J.textContent="YEARS";let ot=Ft("span","mm-scrub-years",F),lt=Ft("input","",$),Et=Ft("input","",$);for(let[zt,Nt]of[[lt,"from"],[Et,"to"]])zt.type="range",zt.min=String(h),zt.max=String(d),zt.setAttribute("aria-label",`Show flows ${Nt} year`);lt.value=String(h),Et.value=String(d);let Mt=()=>{ot.textContent=u===f?`${u}`:`${u} \u2013 ${f}`};Mt();let Dt=0,Ct=()=>{let zt=Number(lt.value),Nt=Number(Et.value);u=Math.min(zt,Nt),f=Math.max(zt,Nt),Mt(),!Dt&&(Dt=requestAnimationFrame(()=>{Dt=0,L()}))};lt.addEventListener("input",Ct),Et.addEventListener("input",Ct)}let tt=(F,J,ot,lt,Et,Mt)=>{let Dt=Ft("li","",F),Ct=Ft("button","mm-row",Dt);if(Ct.type="button",Mt?Ct.addEventListener("click",Mt):Ct.disabled=!0,J){let D=Ft("span","mm-dot",Ct);D.style.background=J}let zt=Ft("span","mm-row-name",Ct);zt.textContent=ot;let Nt=Ft("span","mm-row-amt",Ct);if(Nt.textContent=Ue(lt),Et){let D=Ft("span","mm-row-years",Ct);D.textContent=Et}},it=(F,J,ot,lt=!1,Et=!1)=>{let Mt=Ft("a",lt?"mm-ask mm-ask-quiet":"mm-ask",F);Mt.href=J,Mt.textContent=ot,Et&&(Mt.target="_blank",Mt.rel="noopener")},rt=F=>`https://www.google.com/search?q=${encodeURIComponent(`${F} Australia`)}`,_t=(F,J)=>`${l}#/subject/${F}/${encodeURIComponent(J)}`,jt=F=>{let J=new Map;for(let Et of s.edges){if(Et.target!==F)continue;let Mt=o.get(Et.source);if(!Mt||Mt.industry==="other")continue;let Dt=Mt.industry.replace(/_/g," ");J.set(Dt,(J.get(Dt)??0)+Et.total)}let ot=null,lt=0;for(let[Et,Mt]of J)Mt>lt&&(lt=Mt,ot=Et);return ot},ue=F=>{E.innerHTML="";let J=Ft("button","mm-card-close",E);J.type="button",J.textContent="\u2715",J.setAttribute("aria-label","Close details"),J.addEventListener("click",()=>Lt(null,{user:!0}));let ot=Ft("h2","",E);ot.textContent=F.label;let lt=Ft("span","mm-card-tag",E),Et=yn(F.group);lt.style.color=F.kind==="party"?F.colour??Et.ink:Et.ink,lt.textContent=F.kind==="party"?"political party":F.industry.replace(/_/g," ");let Mt=Ft("div","mm-card-total",E);Mt.textContent=Ue(F.total);let Dt=Ft("div","mm-card-sub",E),Ct=ts(F.firstYear,F.lastYear);Dt.textContent=F.kind==="party"?`received across ${F.count.toLocaleString()} receipts \xB7 ${Ct}`:`given across ${F.count.toLocaleString()} donations \xB7 ${Ct}`;let zt=Ft("div","mm-legend-title",E),Nt=Ft("ul","mm-rows",E);if(F.kind==="donor"){zt.textContent="Where it went";let D=s.edges.filter(ee=>ee.source===F.id).sort((ee,Ht)=>Ht.total-ee.total);for(let ee of D){let Ht=o.get(ee.target);Ht&&tt(Nt,Ht.colour??"#9AA0A8",Ht.label,ee.total,ts(ee.firstYear,ee.lastYear),()=>Lt(Ht.id,{user:!0}))}["individual","other",""].includes(F.industry.toLowerCase())||it(E,c(F.industry.replace(/_/g," ")),"What did parliament say about this industry?"),it(E,`${l}#/search?q=${encodeURIComponent(`"${Qt(F.label)}"`)}`,`What was said about ${Qt(F.label)}?`,!0),it(E,_t("donor",F.label),"Full profile",!0),it(E,rt(F.label),"Search the web \u2197",!0,!0)}else{zt.textContent="Top donors shown on the map";let D=s.edges.filter(Ht=>Ht.target===F.id).sort((Ht,A)=>A.total-Ht.total).slice(0,15);for(let Ht of D){let A=o.get(Ht.source);A&&tt(Nt,yn(A.group).colour,A.label,Ht.total,ts(Ht.firstYear,Ht.lastYear),()=>Lt(A.id,{user:!0}))}let ee=jt(F.id);ee&&it(E,`${l}#/ask?q=${encodeURIComponent(`What has ${F.label} said about ${ee}?`)}`,`Ask what ${F.label} said about ${ee}`),it(E,_t("party",F.label),"Full profile",!0),it(E,rt(F.label),"Search the web \u2197",!0,!0)}},Qt=F=>F.replace(/\s+(Pty\.?\s*)?(Ltd|Limited|Incorporated|Inc)\.?$/i,""),j=(F,J)=>{let ot=o.get(F.target);if(!ot)return;E.innerHTML="";let lt=Ft("button","mm-card-close",E);lt.type="button",lt.textContent="\u2715",lt.setAttribute("aria-label","Close details"),lt.addEventListener("click",()=>At(null));let Et=yn(J),Mt=J.charAt(0).toUpperCase()+J.slice(1),Dt=Ft("h2","",E);Dt.textContent=`${Mt} \u2192 ${ot.label}`;let Ct=Ft("span","mm-card-tag",E);Ct.style.color=Et.ink,Ct.textContent="industry flow";let zt=Ft("div","mm-card-total",E);zt.textContent=Ue(F.total??0);let Nt=Ft("div","mm-card-sub",E),D=ts(F.firstYear??null,F.lastYear??null),ee=F.count??0;Nt.textContent=`from ${ee===1?"1 donor":`${ee.toLocaleString()} donors`} shown${D?` \xB7 ${D}`:""}`;let Ht=Ft("div","mm-legend-title",E);Ht.textContent="Largest donors in this flow";let A=Ft("ul","mm-rows",E),_=s.edges.filter(V=>V.target===ot.id&&o.get(V.source)?.group===J).sort((V,Y)=>Y.total-V.total).slice(0,12);for(let V of _){let Y=o.get(V.source);Y&&tt(A,Et.colour,Y.label,V.total,ts(V.firstYear,V.lastYear),()=>Lt(Y.id,{user:!0}))}["individuals","other"].includes(J)||it(E,c(J),`What has parliament said about ${J}?`);let B=Ft("button","mm-ask mm-ask-quiet",E);B.type="button",B.textContent=`Show only ${J} on the map`,B.addEventListener("click",()=>{At(null),k(J)})},at=F=>{if(F.hub){j(F,F.hub);return}let J=o.get(F.source),ot=o.get(F.target);if(!J||!ot)return;E.innerHTML="";let lt=Ft("button","mm-card-close",E);lt.type="button",lt.textContent="\u2715",lt.setAttribute("aria-label","Close details"),lt.addEventListener("click",()=>At(null));let Et=Ft("h2","",E);Et.textContent=`${J.label} \u2192 ${ot.label}`;let Mt=Ft("span","mm-card-tag",E);Mt.style.color=yn(J.group).ink,Mt.textContent=`${J.industry.replace(/_/g," ")} money`;let Dt=Ft("div","mm-card-total",E);Dt.textContent=Ue(F.total??0);let Ct=Ft("div","mm-card-sub",E),zt=ts(F.firstYear??null,F.lastYear??null);Ct.textContent=`across ${(F.count??0).toLocaleString()} donations${zt?` \xB7 ${zt}`:""}`;let Nt=Ft("ul","mm-rows",E);if(tt(Nt,J.colour??yn(J.group).colour,J.label,J.total,"",()=>Lt(J.id,{user:!0})),tt(Nt,ot.colour??"#9AA0A8",ot.label,ot.total,"",()=>Lt(ot.id,{user:!0})),F.firstYear&&F.lastYear){let D=J.industry.replace(/_/g," ");it(E,`${l}#/search?q=${encodeURIComponent(D)}&from=${F.firstYear}&to=${F.lastYear}`,`What was said about ${D} in ${zt}?`)}},nt=()=>{let F={left:0,right:0,top:0,bottom:0},J=i.getBoundingClientRect();if(J.width<1||J.height<1)return F;let ot=10,lt=(Mt,Dt)=>{if(!Mt)return;let Ct=Mt.getBoundingClientRect();if(Ct.width<1||Ct.height<1)return;if(Dt==="top"||Dt==="bottom"){let D=Ct.right-J.left-F.left,ee=J.right-Ct.left-F.right;if(D<=24||ee<=24)return}let zt=Dt==="left"?Ct.right-J.left:Dt==="right"?J.right-Ct.left:Dt==="top"?Ct.bottom-J.top:J.bottom-Ct.top,Nt=Dt==="left"||Dt==="right"?J.width*.4:J.height*.4;F[Dt]=Math.max(F[Dt],Math.min(zt+ot,Nt))},Et=p!==null&&p.getBoundingClientRect().width>J.width*.5;return p&&!Et&&lt(p,"left"),lt(C,"right"),p&&Et&&lt(p,"top"),lt(z,"top"),lt($,"bottom"),lt(S,"bottom"),F},Ot=()=>{let F=nt();if(E.hidden)return F;let J=E.getBoundingClientRect(),ot=i.getBoundingClientRect();return J.width>=ot.width-40?F.bottom=Math.max(F.bottom,J.height+16):F.right=Math.max(F.right,J.width+24),F};function Lt(F,{user:J=!1}={}){y=F,M=null;let ot=F?o.get(F)??null:null;x.setEmphasis({selectedId:F,pathEdges:null,pathFrom:null}),ot?(ue(ot),E.hidden=!1,requestAnimationFrame(()=>{E.hidden||(x.setInsets(Ot()),y&&x.focusOn(y,null))}),E.focus({preventScroll:!0})):(E.hidden=!0,E.innerHTML="",x.setInsets(nt())),w.select(ot,E),J&&e.onSelect?.(ot)}function At(F){M=F,y=null,x.setEmphasis({selectedId:null,pathEdges:F?[F]:null,pathFrom:null}),F?(at(F),E.hidden=!1,requestAnimationFrame(()=>{E.hidden||x.setInsets(Ot())}),E.focus({preventScroll:!0})):(E.hidden=!0,E.innerHTML="",x.setInsets(nt())),w.selectEdge(F)}let de=F=>{F.key==="Escape"&&(y||M)&&(M?At(null):Lt(null,{user:!0}),g.focus({preventScroll:!0}),F.stopPropagation())};return i.addEventListener("keydown",de),L(),e.focus&&o.has(e.focus)&&Lt(e.focus),{select:F=>Lt(F),isolate:F=>k(F),fit:(F=!0)=>x.fit(F),setPaused:F=>x.setPaused(F),destroy:()=>{i.removeEventListener("keydown",de),W.disconnect(),x.dispose();for(let F of[g,v,p,E,C,S,z,$])F?.remove();i.classList.remove("mm-root"),delete i.dataset.mmChrome}}}export{mi as CLUSTER_COLOURS,Bs as ForceSim3D,Gs as buildDegrees,qg as buildGraph,ml as clusterCentres3D,yn as clusterColour,Ue as formatMoney,zv as mountMoneyMap,Xo as radiusFor,Wo as shortLabel,xh as webglAvailable};
