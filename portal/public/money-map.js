...
`)}var Sm={[Ca]:"Linear",[Ra]:"Reinhard",[Ia]:"Cineon",[Pa]:"ACESFilmic",[Da]:"AgX",[Na]:"Neutral",[La]:"Custom"};function Em(i,t){let e=Sm[t];return e===void 0?(Ut("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var Po=new D;function wm(){Qt.getLuminanceCoefficients(Po);let i=Po.x.toFixed(4),t=Po.y.toFixed(4),e=Po.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}var Nm={[Es]:"SHADOWMAP_TYPE_PCF",[qi]:"SHADOWMAP_TYPE_VSM"};function Um(i){return Nm[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var Fm={[Zn]:"ENVMAP_TYPE_CUBE",[ui]:"ENVMAP_TYPE_CUBE",[ws]:"ENVMAP_TYPE_CUBE_UV"};function Om(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Fm[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var Bm={[ui]:"ENVMAP_MODE_REFRACTION"};function zm(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Bm[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var km={[Aa]:"ENVMAP_BLENDING_MULTIPLY",[gc]:"ENVMAP_BLENDING_MIX",[xc]:"ENVMAP_BLENDING_ADD"};function Vm(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":km[i.combine]||"ENVMAP_BLENDING_NONE"}function Hm(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Gm(i,t,e,n){let s=i.getContext(),r=e.defines,o=e.vertexShader,a=e.fragmentShader,l=Um(e),c=Om(e),h=zm(e),d=Vm(e),u=Hm(e),f=Tm(e),m=Am(r),v=s.createProgram(),g,p,C=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);let w=C+g+o,S=C+p+a,y=Xc(s,s.VERTEX_SHADER,w),M=Xc(s,s.FRAGMENT_SHADER,S);s.attachShader(v,y),s.attachShader(v,M),e.index0AttributeName!==void 0?s.bindAttribLocation(v,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function A(I){if(i.debug.checkShaderErrors){let N=s.getProgramInfoLog(v)||"",X=s.getShaderInfoLog(y)||"",Y=s.getShaderInfoLog(M)||"",F=N.trim(),B=X.trim(),V=Y.trim(),$=!0,tt=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,y,M);else{let it=qc(s,y,"vertex"),at=qc(s,M,"fragment");Ot("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
Program Info Log: `+F+`
`+it+`
`+at)}else F!==""?Ut("WebGLProgram: Program Info Log:",F):(B===""||V==="")&&(tt=!1);tt&&(I.diagnostics={runnable:$,programLog:F,vertexShader:{log:B,prefix:g},fragmentShader:{log:V,prefix:p}})}s.deleteShader(y),s.deleteShader(M),x=new ji(s,v),E=Cm(s,v)}let x;this.getUniforms=function(){return x===void 0&&A(this),x};let E;this.getAttributes=function(){return E===void 0&&A(this),E};let R=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return R===!1&&(R=s.getProgramParameter(v,_m)),R},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(v),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=vm++,this.cacheKey=t,this.usedTimes=1,this.program=v,this.vertexShader=y,this.fragmentShader=M,this}var Wm=0,ll=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t,e,n){let s=this._getShaderCacheForMaterial(t);return s.has(e)===!1&&(s.add(e),e.usedTimes++),s.has(n)===!1&&(s.add(n),n.usedTimes++),this}remove(t){let e=this.materialCache.get(t);for(let n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderStage(t){return this._getShaderStage(t.vertexShader)}getFragmentShaderStage(t){return this._getShaderStage(t.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){let e=this.materialCache,n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){let e=this.shaderCache,n=e.get(t);return n===void 0&&(n=new cl(t),e.set(t,n)),n}},cl=class{constructor(t){this.id=Wm++,this.code=t,this.usedTimes=0}};function Xm(i){return i===jn||i===Ps||i===Ls}function Ym(i,t,e,n,s,r){let o=new Bi,a=new ll,l=new Set,c=[],h=new Map,d=n.logarithmicDepthBuffer,u=n.precision,f={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function m(x){return l.add(x),x===0?"uv":`uv${x}`}function v(x,E,R,I,N,X){let Y=I.fog,F=N.geometry,B=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?I.environment:null,V=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,$=t.get(x.envMap||B,V),tt=$&&$.mapping===ws?$.image.height:null,it=f[x.type];x.precision!==null&&(u=n.getMaxPrecision(x.precision),u!==x.precision&&Ut("WebGLProgram.getParameters:",x.precision,"not supported, using",u,"instead."));let at=F.morphAttributes.position||F.morphAttributes.normal||F.morphAttributes.color,mt=at!==void 0?at.length:0,Jt=0;F.morphAttributes.position!==void 0&&(Jt=1),F.morphAttributes.normal!==void 0&&(Jt=2),F.morphAttributes.color!==void 0&&(Jt=3);let le,Kt,Q,ot;if(it){let Et=vn[it];le=Et.vertexShader,Kt=Et.fragmentShader}else{le=x.vertexShader,Kt=x.fragmentShader;let Et=a.getVertexShaderStage(x),pe=a.getFragmentShaderStage(x);a.update(x,Et,pe),Q=Et.id,ot=pe.id}let nt=i.getRenderTarget(),Bt=i.state.buffers.depth.getReversed(),zt=N.isInstancedMesh===!0,Lt=N.isBatchedMesh===!0,re=!!x.map,Yt=!!x.matcap,Wt=!!$,Zt=!!x.aoMap,jt=!!x.lightMap,z=!!x.bumpMap&&x.wireframe===!1,J=!!x.normalMap,dt=!!x.displacementMap,Mt=!!x.emissiveMap,St=!!x.metalnessMap,vt=!!x.roughnessMap,P=x.anisotropy>0,At=x.clearcoat>0,Nt=x.dispersion>0,T=x.iridescence>0,_=x.sheen>0,L=x.transmission>0,k=P&&!!x.anisotropyMap,q=At&&!!x.clearcoatMap,st=At&&!!x.clearcoatNormalMap,rt=At&&!!x.clearcoatRoughnessMap,Z=T&&!!x.iridescenceMap,K=T&&!!x.iridescenceThicknessMap,ct=_&&!!x.sheenColorMap,Ct=_&&!!x.sheenRoughnessMap,ft=!!x.specularMap,ht=!!x.specularColorMap,Dt=!!x.specularIntensityMap,Ft=L&&!!x.transmissionMap,Ht=L&&!!x.thicknessMap,U=!!x.gradientMap,lt=!!x.alphaMap,j=x.alphaTest>0,ut=!!x.alphaHash,_t=!!x.extensions,et=sn;x.toneMapped&&(nt===null||nt.isXRRenderTarget===!0)&&(et=i.toneMapping);let Tt={shaderID:it,shaderType:x.type,shaderName:x.name,vertexShader:le,fragmentShader:Kt,defines:x.defines,customVertexShaderID:Q,customFragmentShaderID:ot,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:u,batching:Lt,batchingColor:Lt&&N._colorsTexture!==null,instancing:zt,instancingColor:zt&&N.instanceColor!==null,instancingMorph:zt&&N.morphTexture!==null,outputColorSpace:nt===null?i.outputColorSpace:nt.isXRRenderTarget===!0?nt.texture.colorSpace:Qt.workingColorSpace,alphaToCoverage:!!x.alphaToCoverage,map:re,matcap:Yt,envMap:Wt,envMapMode:Wt&&$.mapping,envMapCubeUVHeight:tt,aoMap:Zt,lightMap:jt,bumpMap:z,normalMap:J,displacementMap:dt,emissiveMap:Mt,normalMapObjectSpace:J&&x.normalMapType===yc,normalMapTangentSpace:J&&x.normalMapType===Ao,packedNormalMap:J&&x.normalMapType===Ao&&Xm(x.normalMap.format),metalnessMap:St,roughnessMap:vt,anisotropy:P,anisotropyMap:k,clearcoat:At,clearcoatMap:q,clearcoatNormalMap:st,clearcoatRoughnessMap:rt,dispersion:Nt,iridescence:T,iridescenceMap:Z,iridescenceThicknessMap:K,sheen:_,sheenColorMap:ct,sheenRoughnessMap:Ct,specularMap:ft,specularColorMap:ht,specularIntensityMap:Dt,transmission:L,transmissionMap:Ft,thicknessMap:Ht,gradientMap:U,opaque:x.transparent===!1&&x.blending===li&&x.alphaToCoverage===!1,alphaMap:lt,alphaTest:j,alphaHash:ut,combine:x.combine,mapUv:re&&m(x.map.channel),aoMapUv:Zt&&m(x.aoMap.channel),lightMapUv:jt&&m(x.lightMap.channel),bumpMapUv:z&&m(x.bumpMap.channel),normalMapUv:J&&m(x.normalMap.channel),displacementMapUv:dt&&m(x.displacementMap.channel),emissiveMapUv:Mt&&m(x.emissiveMap.channel),metalnessMapUv:St&&m(x.metalnessMap.channel),roughnessMapUv:vt&&m(x.roughnessMap.channel),anisotropyMapUv:k&&m(x.anisotropyMap.channel),clearcoatMapUv:q&&m(x.clearcoatMap.channel),clearcoatNormalMapUv:st&&m(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:rt&&m(x.clearcoatRoughnessMap.channel),iridescenceMapUv:Z&&m(x.iridescenceMap.channel),iridescenceThicknessMapUv:K&&m(x.iridescenceThicknessMap.channel),sheenColorMapUv:ct&&m(x.sheenColorMap.channel),sheenRoughnessMapUv:Ct&&m(x.sheenRoughnessMap.channel),specularMapUv:ft&&m(x.specularMap.channel),specularColorMapUv:ht&&m(x.specularColorMap.channel),specularIntensityMapUv:Dt&&m(x.specularIntensityMap.channel),transmissionMapUv:Ft&&m(x.transmissionMap.channel),thicknessMapUv:Ht&&m(x.thicknessMap.channel),alphaMapUv:lt&&m(x.alphaMap.channel),vertexTangents:!!F.attributes.tangent&&(J||P),vertexNormals:!!F.attributes.normal,vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!F.attributes.color&&F.attributes.color.itemSize===4,pointsUvs:N.isPoints===!0&&!!F.attributes.uv&&(re||lt),fog:!!Y,useFog:x.fog===!0,fogExp2:!!Y&&Y.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||F.attributes.normal===void 0&&J===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:Bt,skinning:N.isSkinnedMesh===!0,hasPositionAttribute:F.attributes.position!==void 0,morphTargets:F.morphAttributes.position!==void 0,morphNormals:F.morphAttributes.normal!==void 0,morphColors:F.morphAttributes.color!==void 0,morphTargetsCount:mt,morphTextureStride:Jt,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numLightProbes:E.numLightProbes,numLightProbeGrids:X.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:x.dithering,shadowMapEnabled:i.shadowMap.enabled&&R.length>0,shadowMapType:i.shadowMap.type,toneMapping:et,decodeVideoTexture:re&&x.map.isVideoTexture===!0&&Qt.getTransfer(x.map.colorSpace)===ne,decodeVideoTextureEmissive:Mt&&x.emissiveMap.isVideoTexture===!0&&Qt.getTransfer(x.emissiveMap.colorSpace)===ne,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===Fe,flipSided:x.side===Ae,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:_t&&x.extensions.clipCullDistance===!0&&e.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(_t&&x.extensions.multiDraw===!0||Lt)&&e.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:e.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return Tt.vertexUv1s=l.has(1),Tt.vertexUv2s=l.has(2),Tt.vertexUv3s=l.has(3),l.clear(),Tt}function g(x){let E=[];if(x.shaderID?E.push(x.shaderID):(E.push(x.customVertexShaderID),E.push(x.customFragmentShaderID)),x.defines!==void 0)for(let R in x.defines)E.push(R),E.push(x.defines[R]);return x.isRawShaderMaterial===!1&&(p(E,x),C(E,x),E.push(i.outputColorSpace)),E.push(x.customProgramCacheKey),E.join()}function p(x,E){x.push(E.precision),x.push(E.outputColorSpace),x.push(E.envMapMode),x.push(E.envMapCubeUVHeight),x.push(E.mapUv),x.push(E.alphaMapUv),x.push(E.lightMapUv),x.push(E.aoMapUv),x.push(E.bumpMapUv),x.push(E.normalMapUv),x.push(E.displacementMapUv),x.push(E.emissiveMapUv),x.push(E.metalnessMapUv),x.push(E.roughnessMapUv),x.push(E.anisotropyMapUv),x.push(E.clearcoatMapUv),x.push(E.clearcoatNormalMapUv),x.push(E.clearcoatRoughnessMapUv),x.push(E.iridescenceMapUv),x.push(E.iridescenceThicknessMapUv),x.push(E.sheenColorMapUv),x.push(E.sheenRoughnessMapUv),x.push(E.specularMapUv),x.push(E.specularColorMapUv),x.push(E.specularIntensityMapUv),x.push(E.transmissionMapUv),x.push(E.thicknessMapUv),x.push(E.combine),x.push(E.fogExp2),x.push(E.sizeAttenuation),x.push(E.morphTargetsCount),x.push(E.morphAttributeCount),x.push(E.numDirLights),x.push(E.numPointLights),x.push(E.numSpotLights),x.push(E.numSpotLightMaps),x.push(E.numHemiLights),x.push(E.numRectAreaLights),x.push(E.numDirLightShadows),x.push(E.numPointLightShadows),x.push(E.numSpotLightShadows),x.push(E.numSpotLightShadowsWithMaps),x.push(E.numLightProbes),x.push(E.shadowMapType),x.push(E.toneMapping),x.push(E.numClippingPlanes),x.push(E.numClipIntersection),x.push(E.depthPacking)}function C(x,E){o.disableAll(),E.instancing&&o.enable(0),E.instancingColor&&o.enable(1),E.instancingMorph&&o.enable(2),E.matcap&&o.enable(3),E.envMap&&o.enable(4),E.normalMapObjectSpace&&o.enable(5),E.normalMapTangentSpace&&o.enable(6),E.clearcoat&&o.enable(7),E.iridescence&&o.enable(8),E.alphaTest&&o.enable(9),E.vertexColors&&o.enable(10),E.vertexAlphas&&o.enable(11),E.vertexUv1s&&o.enable(12),E.vertexUv2s&&o.enable(13),E.vertexUv3s&&o.enable(14),E.vertexTangents&&o.enable(15),E.anisotropy&&o.enable(16),E.alphaHash&&o.enable(17),E.batching&&o.enable(18),E.dispersion&&o.enable(19),E.batchingColor&&o.enable(20),E.gradientMap&&o.enable(21),E.packedNormalMap&&o.enable(22),E.vertexNormals&&o.enable(23),x.push(o.mask),o.disableAll(),E.fog&&o.enable(0),E.useFog&&o.enable(1),E.flatShading&&o.enable(2),E.logarithmicDepthBuffer&&o.enable(3),E.reversedDepthBuffer&&o.enable(4),E.skinning&&o.enable(5),E.morphTargets&&o.enable(6),E.morphNormals&&o.enable(7),E.morphColors&&o.enable(8),E.premultipliedAlpha&&o.enable(9),E.shadowMapEnabled&&o.enable(10),E.doubleSided&&o.enable(11),E.flipSided&&o.enable(12),E.useDepthPacking&&o.enable(13),E.dithering&&o.enable(14),E.transmission&&o.enable(15),E.sheen&&o.enable(16),E.opaque&&o.enable(17),E.pointsUvs&&o.enable(18),E.decodeVideoTexture&&o.enable(19),E.decodeVideoTextureEmissive&&o.enable(20),E.alphaToCoverage&&o.enable(21),E.numLightProbeGrids>0&&o.enable(22),E.hasPositionAttribute&&o.enable(23),x.push(o.mask)}function w(x){let E=f[x.type],R;if(E){let I=vn[E];R=Lc.clone(I.uniforms)}else R=x.uniforms;return R}function S(x,E){let R=h.get(E);return R!==void 0?++R.usedTimes:(R=new Gm(i,E,x,s),c.push(R),h.set(E,R)),R}function y(x){if(--x.usedTimes===0){let E=c.indexOf(x);c[E]=c[c.length-1],c.pop(),h.delete(x.cacheKey),x.destroy()}}function M(x){a.remove(x)}function A(){a.dispose()}return{getParameters:v,getProgramCacheKey:g,getUniforms:w,acquireProgram:S,releaseProgram:y,releaseShaderCache:M,programs:c,dispose:A}}function qm(){let i=new WeakMap;function t(o){return i.has(o)}function e(o){let a=i.get(o);return a===void 0&&(a={},i.set(o,a)),a}function n(o){i.delete(o)}function s(o,a,l){i.get(o)[a]=l}function r(){i=new WeakMap}return{has:t,get:e,remove:n,update:s,dispose:r}}function $m(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.material.id!==t.material.id?i.material.id-t.material.id:i.materialVariant!==t.materialVariant?i.materialVariant-t.materialVariant:i.z!==t.z?i.z-t.z:i.id-t.id}function jc(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.z!==t.z?t.z-i.z:i.id-t.id}function Qc(){let i=[],t=0,e=[],n=[],s=[];function r(){t=0,e.length=0,n.length=0,s.length=0}function o(u){let f=0;return u.isInstancedMesh&&(f+=2),u.isSkinnedMesh&&(f+=1),f}function a(u,f,m,v,g,p){let C=i[t];return C===void 0?(C={id:u.id,object:u,geometry:f,material:m,materialVariant:o(u),groupOrder:v,renderOrder:u.renderOrder,z:g,group:p},i[t]=C):(C.id=u.id,C.object=u,C.geometry=f,C.material=m,C.materialVariant=o(u),C.groupOrder=v,C.renderOrder=u.renderOrder,C.z=g,C.group=p),t++,C}function l(u,f,m,v,g,p){let C=a(u,f,m,v,g,p);m.transmission>0?n.push(C):m.transparent===!0?s.push(C):e.push(C)}function c(u,f,m,v,g,p){let C=a(u,f,m,v,g,p);m.transmission>0?n.unshift(C):m.transparent===!0?s.unshift(C):e.unshift(C)}function h(u,f,m){e.length>1&&e.sort(u||$m),n.length>1&&n.sort(f||jc),s.length>1&&s.sort(f||jc),m&&(e.reverse(),n.reverse(),s.reverse())}function d(){for(let u=t,f=i.length;u<f;u++){let m=i[u];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:e,transmissive:n,transparent:s,init:r,push:l,unshift:c,finish:d,sort:h}}function Zm(){let i=new WeakMap;function t(n,s){let r=i.get(n),o;return r===void 0?(o=new Qc,i.set(n,[o])):s>=r.length?(o=new Qc,r.push(o)):o=r[s],o}function e(){i=new WeakMap}return{get:t,dispose:e}}function Jm(){let i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new D,color:new Vt};break;case"SpotLight":e={position:new D,direction:new D,color:new Vt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new D,color:new Vt,distance:0,decay:0};break;case"HemisphereLight":e={direction:new D,skyColor:new Vt,groundColor:new Vt};break;case"RectAreaLight":e={color:new Vt,position:new D,halfWidth:new D,halfHeight:new D};break}return i[t.id]=e,e}}}function Km(){let i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new $t};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new $t};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new $t,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[t.id]=e,e}}}var jm=0;function Qm(i,t){return(t.castShadow?2:0)-(i.castShadow?2:0)+(t.map?1:0)-(i.map?1:0)}function tg(i){let t=new Jm,e=Km(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new D);let s=new D,r=new de,o=new de;function a(c){let h=0,d=0,u=0;for(let E=0;E<9;E++)n.probe[E].set(0,0,0);let f=0,m=0,v=0,g=0,p=0,C=0,w=0,S=0,y=0,M=0,A=0;c.sort(Qm);for(let E=0,R=c.length;E<R;E++){let I=c[E],N=I.color,X=I.intensity,Y=I.distance,F=null;if(I.shadow&&I.shadow.map&&(I.shadow.map.texture.format===jn?F=I.shadow.map.texture:F=I.shadow.map.depthTexture||I.shadow.map.texture),I.isAmbientLight)h+=N.r*X,d+=N.g*X,u+=N.b*X;else if(I.isLightProbe){for(let B=0;B<9;B++)n.probe[B].addScaledVector(I.sh.coefficients[B],X);A++}else if(I.isDirectionalLight){let B=t.get(I);if(B.color.copy(I.color).multiplyScalar(I.intensity),I.castShadow){let V=I.shadow,$=e.get(I);$.shadowIntensity=V.intensity,$.shadowBias=V.bias,$.shadowNormalBias=V.normalBias,$.shadowRadius=V.radius,$.shadowMapSize=V.mapSize,n.directionalShadow[f]=$,n.directionalShadowMap[f]=F,n.directionalShadowMatrix[f]=I.shadow.matrix,C++}n.directional[f]=B,f++}else if(I.isSpotLight){let B=t.get(I);B.position.setFromMatrixPosition(I.matrixWorld),B.color.copy(N).multiplyScalar(X),B.distance=Y,B.coneCos=Math.cos(I.angle),B.penumbraCos=Math.cos(I.angle*(1-I.penumbra)),B.decay=I.decay,n.spot[v]=B;let V=I.shadow;if(I.map&&(n.spotLightMap[y]=I.map,y++,V.updateMatrices(I),I.castShadow&&M++),n.spotLightMatrix[v]=V.matrix,I.castShadow){let $=e.get(I);$.shadowIntensity=V.intensity,$.shadowBias=V.bias,$.shadowNormalBias=V.normalBias,$.shadowRadius=V.radius,$.shadowMapSize=V.mapSize,n.spotShadow[v]=$,n.spotShadowMap[v]=F,S++}v++}else if(I.isRectAreaLight){let B=t.get(I);B.color.copy(N).multiplyScalar(X),B.halfWidth.set(I.width*.5,0,0),B.halfHeight.set(0,I.height*.5,0),n.rectArea[g]=B,g++}else if(I.isPointLight){let B=t.get(I);if(B.color.copy(I.color).multiplyScalar(I.intensity),B.distance=I.distance,B.decay=I.decay,I.castShadow){let V=I.shadow,$=e.get(I);$.shadowIntensity=V.intensity,$.shadowBias=V.bias,$.shadowNormalBias=V.normalBias,$.shadowRadius=V.radius,$.shadowMapSize=V.mapSize,$.shadowCameraNear=V.camera.near,$.shadowCameraFar=V.camera.far,n.pointShadow[m]=$,n.pointShadowMap[m]=F,n.pointShadowMatrix[m]=I.shadow.matrix,w++}n.point[m]=B,m++}else if(I.isHemisphereLight){let B=t.get(I);B.skyColor.copy(I.color).multiplyScalar(X),B.groundColor.copy(I.groundColor).multiplyScalar(X),n.hemi[p]=B,p++}}g>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=pt.LTC_FLOAT_1,n.rectAreaLTC2=pt.LTC_FLOAT_2):(n.rectAreaLTC1=pt.LTC_HALF_1,n.rectAreaLTC2=pt.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=d,n.ambient[2]=u;let x=n.hash;(x.directionalLength!==f||x.pointLength!==m||x.spotLength!==v||x.rectAreaLength!==g||x.hemiLength!==p||x.numDirectionalShadows!==C||x.numPointShadows!==w||x.numSpotShadows!==S||x.numSpotMaps!==y||x.numLightProbes!==A)&&(n.directional.length=f,n.spot.length=v,n.rectArea.length=g,n.point.length=m,n.hemi.length=p,n.directionalShadow.length=C,n.directionalShadowMap.length=C,n.pointShadow.length=w,n.pointShadowMap.length=w,n.spotShadow.length=S,n.spotShadowMap.length=S,n.directionalShadowMatrix.length=C,n.pointShadowMatrix.length=w,n.spotLightMatrix.length=S+y-M,n.spotLightMap.length=y,n.numSpotLightShadowsWithMaps=M,n.numLightProbes=A,x.directionalLength=f,x.pointLength=m,x.spotLength=v,x.rectAreaLength=g,x.hemiLength=p,x.numDirectionalShadows=C,x.numPointShadows=w,x.numSpotShadows=S,x.numSpotMaps=y,x.numLightProbes=A,n.version=jm++)}function l(c,h){let d=0,u=0,f=0,m=0,v=0,g=h.matrixWorldInverse;for(let p=0,C=c.length;p<C;p++){let w=c[p];if(w.isDirectionalLight){let S=n.directional[d];S.direction.setFromMatrixPosition(w.matrixWorld),s.setFromMatrixPosition(w.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(g),d++}else if(w.isSpotLight){let S=n.spot[f];S.position.setFromMatrixPosition(w.matrixWorld),S.position.applyMatrix4(g),S.direction.setFromMatrixPosition(w.matrixWorld),s.setFromMatrixPosition(w.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(g),f++}else if(w.isRectAreaLight){let S=n.rectArea[m];S.position.setFromMatrixPosition(w.matrixWorld),S.position.applyMatrix4(g),o.identity(),r.copy(w.matrixWorld),r.premultiply(g),o.extractRotation(r),S.halfWidth.set(w.width*.5,0,0),S.halfHeight.set(0,w.height*.5,0),S.halfWidth.applyMatrix4(o),S.halfHeight.applyMatrix4(o),m++}else if(w.isPointLight){let S=n.point[u];S.position.setFromMatrixPosition(w.matrixWorld),S.position.applyMatrix4(g),u++}else if(w.isHemisphereLight){let S=n.hemi[v];S.direction.setFromMatrixPosition(w.matrixWorld),S.direction.transformDirection(g),v++}}}return{setup:a,setupView:l,state:n}}function th(i){let t=new tg(i),e=[],n=[],s=[];function r(u){d.camera=u,e.length=0,n.length=0,s.length=0}function o(u){e.push(u)}function a(u){n.push(u)}function l(u){s.push(u)}function c(){t.setup(e)}function h(u){t.setupView(e,u)}let d={lightsArray:e,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:t,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:d,setupLights:c,setupLightsView:h,pushLight:o,pushShadow:a,pushLightProbeGrid:l}}function eg(i){let t=new WeakMap;function e(s,r=0){let o=t.get(s),a;return o===void 0?(a=new th(i),t.set(s,[a])):r>=o.length?(a=new th(i),o.push(a)):a=o[r],a}function n(){t=new WeakMap}return{get:e,dispose:n}}var ng=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,sg=[new D(1,0,0),new D(-1,0,0),new D(0,1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1)],rg=[new D(0,-1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1),new D(0,-1,0),new D(0,-1,0)],eh=new de,Ns=new D,nl=new D;function og(i,t,e){let n=new Vi,s=new $t,r=new $t,o=new fe,a=new Ar,l=new Cr,c={},h=e.maxTextureSize,d={[An]:Ae,[Ae]:An,[Fe]:Fe},u=new Ue({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $t},radius:{value:4}},vertexShader:ng,fragmentShader:ig}),f=u.clone();f.defines.HORIZONTAL_PASS=1;let m=new ze;m.setAttribute("position",new ye(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let v=new ge(m,u),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Es;let p=this.type;this.render=function(M,A,x){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||M.length===0)return;this.type===Kl&&(Ut("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Es);let E=i.getRenderTarget(),R=i.getActiveCubeFace(),I=i.getActiveMipmapLevel(),N=i.state;N.setBlending(gn),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);let X=p!==this.type;X&&A.traverse(function(Y){Y.material&&(Array.isArray(Y.material)?Y.material.forEach(F=>F.needsUpdate=!0):Y.material.needsUpdate=!0)});for(let Y=0,F=M.length;Y<F;Y++){let B=M[Y],V=B.shadow;if(V===void 0){Ut("WebGLShadowMap:",B,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);let $=V.getFrameExtents();s.multiply($),r.copy(V.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/$.x),s.x=r.x*$.x,V.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/$.y),s.y=r.y*$.y,V.mapSize.y=r.y));let tt=i.state.buffers.depth.getReversed();if(V.camera._reversedDepth=tt,V.map===null||X===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===qi){if(B.isPointLight){Ut("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new Xe(s.x,s.y,{format:jn,type:xn,minFilter:Te,magFilter:Te,generateMipmaps:!1}),V.map.texture.name=B.name+".shadowMap",V.map.depthTexture=new Rn(s.x,s.y,on),V.map.depthTexture.name=B.name+".shadowMapDepth",V.map.depthTexture.format=fn,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=we,V.map.depthTexture.magFilter=we}else B.isPointLight?(V.map=new Do(s.x),V.map.depthTexture=new wr(s.x,rn)):(V.map=new Xe(s.x,s.y),V.map.depthTexture=new Rn(s.x,s.y,rn)),V.map.depthTexture.name=B.name+".shadowMap",V.map.depthTexture.format=fn,this.type===Es?(V.map.depthTexture.compareFunction=tt?Ro:Co,V.map.depthTexture.minFilter=Te,V.map.depthTexture.magFilter=Te):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=we,V.map.depthTexture.magFilter=we);V.camera.updateProjectionMatrix()}let it=V.map.isWebGLCubeRenderTarget?6:1;for(let at=0;at<it;at++){if(V.map.isWebGLCubeRenderTarget)i.setRenderTarget(V.map,at),i.clear();else{at===0&&(i.setRenderTarget(V.map),i.clear());let mt=V.getViewport(at);o.set(r.x*mt.x,r.y*mt.y,r.x*mt.z,r.y*mt.w),N.viewport(o)}if(B.isPointLight){let mt=V.camera,Jt=V.matrix,le=B.distance||mt.far;le!==mt.far&&(mt.far=le,mt.updateProjectionMatrix()),Ns.setFromMatrixPosition(B.matrixWorld),mt.position.copy(Ns),nl.copy(mt.position),nl.add(sg[at]),mt.up.copy(rg[at]),mt.lookAt(nl),mt.updateMatrixWorld(),Jt.makeTranslation(-Ns.x,-Ns.y,-Ns.z),eh.multiplyMatrices(mt.projectionMatrix,mt.matrixWorldInverse),V._frustum.setFromProjectionMatrix(eh,mt.coordinateSystem,mt.reversedDepth)}else V.updateMatrices(B);n=V.getFrustum(),S(A,x,V.camera,B,this.type)}V.isPointLightShadow!==!0&&this.type===qi&&C(V,x),V.needsUpdate=!1}p=this.type,g.needsUpdate=!1,i.setRenderTarget(E,R,I)};function C(M,A){let x=t.update(v);u.defines.VSM_SAMPLES!==M.blurSamples&&(u.defines.VSM_SAMPLES=M.blurSamples,f.defines.VSM_SAMPLES=M.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),M.mapPass===null&&(M.mapPass=new Xe(s.x,s.y,{format:jn,type:xn})),u.uniforms.shadow_pass.value=M.map.depthTexture,u.uniforms.resolution.value=M.mapSize,u.uniforms.radius.value=M.radius,i.setRenderTarget(M.mapPass),i.clear(),i.renderBufferDirect(A,null,x,u,v,null),f.uniforms.shadow_pass.value=M.mapPass.texture,f.uniforms.resolution.value=M.mapSize,f.uniforms.radius.value=M.radius,i.setRenderTarget(M.map),i.clear(),i.renderBufferDirect(A,null,x,f,v,null)}function w(M,A,x,E){let R=null,I=x.isPointLight===!0?M.customDistanceMaterial:M.customDepthMaterial;if(I!==void 0)R=I;else if(R=x.isPointLight===!0?l:a,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){let N=R.uuid,X=A.uuid,Y=c[N];Y===void 0&&(Y={},c[N]=Y);let F=Y[X];F===void 0&&(F=R.clone(),Y[X]=F,A.addEventListener("dispose",y)),R=F}if(R.visible=A.visible,R.wireframe=A.wireframe,E===qi?R.side=A.shadowSide!==null?A.shadowSide:A.side:R.side=A.shadowSide!==null?A.shadowSide:d[A.side],R.alphaMap=A.alphaMap,R.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,R.map=A.map,R.clipShadows=A.clipShadows,R.clippingPlanes=A.clippingPlanes,R.clipIntersection=A.clipIntersection,R.displacementMap=A.displacementMap,R.displacementScale=A.displacementScale,R.displacementBias=A.displacementBias,R.wireframeLinewidth=A.wireframeLinewidth,R.linewidth=A.linewidth,x.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let N=i.properties.get(R);N.light=x}return R}function S(M,A,x,E,R){if(M.visible===!1)return;if(M.layers.test(A.layers)&&(M.isMesh||M.isLine||M.isPoints)&&(M.castShadow||M.receiveShadow&&R===qi)&&(!M.frustumCulled||n.intersectsObject(M))){M.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,M.matrixWorld);let X=t.update(M),Y=M.material;if(Array.isArray(Y)){let F=X.groups;for(let B=0,V=F.length;B<V;B++){let $=F[B],tt=Y[$.materialIndex];if(tt&&tt.visible){let it=w(M,tt,E,R);M.onBeforeShadow(i,M,A,x,X,it,$),i.renderBufferDirect(x,null,X,it,M,$),M.onAfterShadow(i,M,A,x,X,it,$)}}}else if(Y.visible){let F=w(M,Y,E,R);M.onBeforeShadow(i,M,A,x,X,F,null),i.renderBufferDirect(x,null,X,F,M,null),M.onAfterShadow(i,M,A,x,X,F,null)}}let N=M.children;for(let X=0,Y=N.length;X<Y;X++)S(N[X],A,x,E,R)}function y(M){M.target.removeEventListener("dispose",y);for(let x in c){let E=c[x],R=M.target.uuid;R in E&&(E[R].dispose(),delete E[R])}}}function ag(i,t){function e(){let U=!1,lt=new fe,j=null,ut=new fe(0,0,0,0);return{setMask:function(_t){j!==_t&&!U&&(i.colorMask(_t,_t,_t,_t),j=_t)},setLocked:function(_t){U=_t},setClear:function(_t,et,Tt,Et,pe){pe===!0&&(_t*=Et,et*=Et,Tt*=Et),lt.set(_t,et,Tt,Et),ut.equals(lt)===!1&&(i.clearColor(_t,et,Tt,Et),ut.copy(lt))},reset:function(){U=!1,j=null,ut.set(-1,0,0,0)}}}function n(){let U=!1,lt=!1,j=null,ut=null,_t=null;return{setReversed:function(et){if(lt!==et){let Tt=t.get("EXT_clip_control");et?Tt.clipControlEXT(Tt.LOWER_LEFT_EXT,Tt.ZERO_TO_ONE_EXT):Tt.clipControlEXT(Tt.LOWER_LEFT_EXT,Tt.NEGATIVE_ONE_TO_ONE_EXT),lt=et;let Et=_t;_t=null,this.setClear(Et)}},getReversed:function(){return lt},setTest:function(et){et?nt(i.DEPTH_TEST):Bt(i.DEPTH_TEST)},setMask:function(et){j!==et&&!U&&(i.depthMask(et),j=et)},setFunc:function(et){if(lt&&(et=Ic[et]),ut!==et){switch(et){case ur:i.depthFunc(i.NEVER);break;case dr:i.depthFunc(i.ALWAYS);break;case fr:i.depthFunc(i.LESS);break;case ci:i.depthFunc(i.LEQUAL);break;case pr:i.depthFunc(i.EQUAL);break;case mr:i.depthFunc(i.GEQUAL);break;case gr:i.depthFunc(i.GREATER);break;case xr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ut=et}},setLocked:function(et){U=et},setClear:function(et){_t!==et&&(_t=et,lt&&(et=1-et),i.clearDepth(et))},reset:function(){U=!1,j=null,ut=null,_t=null,lt=!1}}}function s(){let U=!1,lt=null,j=null,ut=null,_t=null,et=null,Tt=null,Et=null,pe=null;return{setTest:function(ce){U||(ce?nt(i.STENCIL_TEST):Bt(i.STENCIL_TEST))},setMask:function(ce){lt!==ce&&!U&&(i.stencilMask(ce),lt=ce)},setFunc:function(ce,ln,cn){(j!==ce||ut!==ln||_t!==cn)&&(i.stencilFunc(ce,ln,cn),j=ce,ut=ln,_t=cn)},setOp:function(ce,ln,cn){(et!==ce||Tt!==ln||Et!==cn)&&(i.stencilOp(ce,ln,cn),et=ce,Tt=ln,Et=cn)},setLocked:function(ce){U=ce},setClear:function(ce){pe!==ce&&(i.clearStencil(ce),pe=ce)},reset:function(){U=!1,lt=null,j=null,ut=null,_t=null,et=null,Tt=null,Et=null,pe=null}}}let r=new e,o=new n,a=new s,l=new WeakMap,c=new WeakMap,h={},d={},u={},f=new WeakMap,m=[],v=null,g=!1,p=null,C=null,w=null,S=null,y=null,M=null,A=null,x=new Vt(0,0,0),E=0,R=!1,I=null,N=null,X=null,Y=null,F=null,B=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),V=!1,$=0,tt=i.getParameter(i.VERSION);tt.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(tt)[1]),V=$>=1):tt.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(tt)[1]),V=$>=2);let it=null,at={},mt=i.getParameter(i.SCISSOR_BOX),Jt=i.getParameter(i.VIEWPORT),le=new fe().fromArray(mt),Kt=new fe().fromArray(Jt);function Q(U,lt,j,ut){let _t=new Uint8Array(4),et=i.createTexture();i.bindTexture(U,et),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Tt=0;Tt<j;Tt++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(lt,0,i.RGBA,1,1,ut,0,i.RGBA,i.UNSIGNED_BYTE,_t):i.texImage2D(lt+Tt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,_t);return et}let ot={};ot[i.TEXTURE_2D]=Q(i.TEXTURE_2D,i.TEXTURE_2D,1),ot[i.TEXTURE_CUBE_MAP]=Q(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ot[i.TEXTURE_2D_ARRAY]=Q(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ot[i.TEXTURE_3D]=Q(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),nt(i.DEPTH_TEST),o.setFunc(ci),z(!1),J(Sa),nt(i.CULL_FACE),Zt(gn);function nt(U){h[U]!==!0&&(i.enable(U),h[U]=!0)}function Bt(U){h[U]!==!1&&(i.disable(U),h[U]=!1)}function zt(U,lt){return u[U]!==lt?(i.bindFramebuffer(U,lt),u[U]=lt,U===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=lt),U===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=lt),!0):!1}function Lt(U,lt){let j=m,ut=!1;if(U){j=f.get(lt),j===void 0&&(j=[],f.set(lt,j));let _t=U.textures;if(j.length!==_t.length||j[0]!==i.COLOR_ATTACHMENT0){for(let et=0,Tt=_t.length;et<Tt;et++)j[et]=i.COLOR_ATTACHMENT0+et;j.length=_t.length,ut=!0}}else j[0]!==i.BACK&&(j[0]=i.BACK,ut=!0);ut&&i.drawBuffers(j)}function re(U){return v!==U?(i.useProgram(U),v=U,!0):!1}let Yt={[Gn]:i.FUNC_ADD,[Ql]:i.FUNC_SUBTRACT,[tc]:i.FUNC_REVERSE_SUBTRACT};Yt[ec]=i.MIN,Yt[nc]=i.MAX;let Wt={[ic]:i.ZERO,[sc]:i.ONE,[rc]:i.SRC_COLOR,[cr]:i.SRC_ALPHA,[uc]:i.SRC_ALPHA_SATURATE,[cc]:i.DST_COLOR,[ac]:i.DST_ALPHA,[oc]:i.ONE_MINUS_SRC_COLOR,[hr]:i.ONE_MINUS_SRC_ALPHA,[hc]:i.ONE_MINUS_DST_COLOR,[lc]:i.ONE_MINUS_DST_ALPHA,[dc]:i.CONSTANT_COLOR,[fc]:i.ONE_MINUS_CONSTANT_COLOR,[pc]:i.CONSTANT_ALPHA,[mc]:i.ONE_MINUS_CONSTANT_ALPHA};function Zt(U,lt,j,ut,_t,et,Tt,Et,pe,ce){if(U===gn){g===!0&&(Bt(i.BLEND),g=!1);return}if(g===!1&&(nt(i.BLEND),g=!0),U!==jl){if(U!==p||ce!==R){if((C!==Gn||y!==Gn)&&(i.blendEquation(i.FUNC_ADD),C=Gn,y=Gn),ce)switch(U){case li:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ea:i.blendFunc(i.ONE,i.ONE);break;case wa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ta:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ot("WebGLState: Invalid blending: ",U);break}else switch(U){case li:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ea:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case wa:Ot("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Ta:Ot("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ot("WebGLState: Invalid blending: ",U);break}w=null,S=null,M=null,A=null,x.set(0,0,0),E=0,p=U,R=ce}return}_t=_t||lt,et=et||j,Tt=Tt||ut,(lt!==C||_t!==y)&&(i.blendEquationSeparate(Yt[lt],Yt[_t]),C=lt,y=_t),(j!==w||ut!==S||et!==M||Tt!==A)&&(i.blendFuncSeparate(Wt[j],Wt[ut],Wt[et],Wt[Tt]),w=j,S=ut,M=et,A=Tt),(Et.equals(x)===!1||pe!==E)&&(i.blendColor(Et.r,Et.g,Et.b,pe),x.copy(Et),E=pe),p=U,R=!1}function jt(U,lt){U.side===Fe?Bt(i.CULL_FACE):nt(i.CULL_FACE);let j=U.side===Ae;lt&&(j=!j),z(j),U.blending===li&&U.transparent===!1?Zt(gn):Zt(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),r.setMask(U.colorWrite);let ut=U.stencilWrite;a.setTest(ut),ut&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Mt(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?nt(i.SAMPLE_ALPHA_TO_COVERAGE):Bt(i.SAMPLE_ALPHA_TO_COVERAGE)}function z(U){I!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),I=U)}function J(U){U!==Zl?(nt(i.CULL_FACE),U!==N&&(U===Sa?i.cullFace(i.BACK):U===Jl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Bt(i.CULL_FACE),N=U}function dt(U){U!==X&&(V&&i.lineWidth(U),X=U)}function Mt(U,lt,j){U?(nt(i.POLYGON_OFFSET_FILL),(Y!==lt||F!==j)&&(Y=lt,F=j,o.getReversed()&&(lt=-lt),i.polygonOffset(lt,j))):Bt(i.POLYGON_OFFSET_FILL)}function St(U){U?nt(i.SCISSOR_TEST):Bt(i.SCISSOR_TEST)}function vt(U){U===void 0&&(U=i.TEXTURE0+B-1),it!==U&&(i.activeTexture(U),it=U)}function P(U,lt,j){j===void 0&&(it===null?j=i.TEXTURE0+B-1:j=it);let ut=at[j];ut===void 0&&(ut={type:void 0,texture:void 0},at[j]=ut),(ut.type!==U||ut.texture!==lt)&&(it!==j&&(i.activeTexture(j),it=j),i.bindTexture(U,lt||ot[U]),ut.type=U,ut.texture=lt)}function At(){let U=at[it];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function Nt(){try{i.compressedTexImage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function T(){try{i.compressedTexImage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function _(){try{i.texSubImage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function L(){try{i.texSubImage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function k(){try{i.compressedTexSubImage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function q(){try{i.compressedTexSubImage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function st(){try{i.texStorage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function rt(){try{i.texStorage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function Z(){try{i.texImage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function K(){try{i.texImage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function ct(U){return d[U]!==void 0?d[U]:i.getParameter(U)}function Ct(U,lt){d[U]!==lt&&(i.pixelStorei(U,lt),d[U]=lt)}function ft(U){le.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),le.copy(U))}function ht(U){Kt.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),Kt.copy(U))}function Dt(U,lt){let j=c.get(lt);j===void 0&&(j=new WeakMap,c.set(lt,j));let ut=j.get(U);ut===void 0&&(ut=i.getUniformBlockIndex(lt,U.name),j.set(U,ut))}function Ft(U,lt){let ut=c.get(lt).get(U);l.get(lt)!==ut&&(i.uniformBlockBinding(lt,ut,U.__bindingPointIndex),l.set(lt,ut))}function Ht(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},d={},it=null,at={},u={},f=new WeakMap,m=[],v=null,g=!1,p=null,C=null,w=null,S=null,y=null,M=null,A=null,x=new Vt(0,0,0),E=0,R=!1,I=null,N=null,X=null,Y=null,F=null,le.set(0,0,i.canvas.width,i.canvas.height),Kt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:nt,disable:Bt,bindFramebuffer:zt,drawBuffers:Lt,useProgram:re,setBlending:Zt,setMaterial:jt,setFlipSided:z,setCullFace:J,setLineWidth:dt,setPolygonOffset:Mt,setScissorTest:St,activeTexture:vt,bindTexture:P,unbindTexture:At,compressedTexImage2D:Nt,compressedTexImage3D:T,texImage2D:Z,texImage3D:K,pixelStorei:Ct,getParameter:ct,updateUBOMapping:Dt,uniformBlockBinding:Ft,texStorage2D:st,texStorage3D:rt,texSubImage2D:_,texSubImage3D:L,compressedTexSubImage2D:k,compressedTexSubImage3D:q,scissor:ft,viewport:ht,reset:Ht}}function lg(i,t,e,n,s,r,o){let a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new $t,h=new WeakMap,d=new Set,u,f=new WeakMap,m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(T,_){return m?new OffscreenCanvas(T,_):cs("canvas")}function g(T,_,L){let k=1,q=Nt(T);if((q.width>L||q.height>L)&&(k=L/Math.max(q.width,q.height)),k<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){let st=Math.floor(k*q.width),rt=Math.floor(k*q.height);u===void 0&&(u=v(st,rt));let Z=_?v(st,rt):u;return Z.width=st,Z.height=rt,Z.getContext("2d").drawImage(T,0,0,st,rt),Ut("WebGLRenderer: Texture has been resized from ("+q.width+"x"+q.height+") to ("+st+"x"+rt+")."),Z}else return"data"in T&&Ut("WebGLRenderer: Image in DataTexture is too big ("+q.width+"x"+q.height+")."),T;return T}function p(T){return T.generateMipmaps}function C(T){i.generateMipmap(T)}function w(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function S(T,_,L,k,q,st=!1){if(T!==null){if(i[T]!==void 0)return i[T];Ut("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let rt;k&&(rt=t.get("EXT_texture_norm16"),rt||Ut("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Z=_;if(_===i.RED&&(L===i.FLOAT&&(Z=i.R32F),L===i.HALF_FLOAT&&(Z=i.R16F),L===i.UNSIGNED_BYTE&&(Z=i.R8),L===i.UNSIGNED_SHORT&&rt&&(Z=rt.R16_EXT),L===i.SHORT&&rt&&(Z=rt.R16_SNORM_EXT)),_===i.RED_INTEGER&&(L===i.UNSIGNED_BYTE&&(Z=i.R8UI),L===i.UNSIGNED_SHORT&&(Z=i.R16UI),L===i.UNSIGNED_INT&&(Z=i.R32UI),L===i.BYTE&&(Z=i.R8I),L===i.SHORT&&(Z=i.R16I),L===i.INT&&(Z=i.R32I)),_===i.RG&&(L===i.FLOAT&&(Z=i.RG32F),L===i.HALF_FLOAT&&(Z=i.RG16F),L===i.UNSIGNED_BYTE&&(Z=i.RG8),L===i.UNSIGNED_SHORT&&rt&&(Z=rt.RG16_EXT),L===i.SHORT&&rt&&(Z=rt.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(L===i.UNSIGNED_BYTE&&(Z=i.RG8UI),L===i.UNSIGNED_SHORT&&(Z=i.RG16UI),L===i.UNSIGNED_INT&&(Z=i.RG32UI),L===i.BYTE&&(Z=i.RG8I),L===i.SHORT&&(Z=i.RG16I),L===i.INT&&(Z=i.RG32I)),_===i.RGB_INTEGER&&(L===i.UNSIGNED_BYTE&&(Z=i.RGB8UI),L===i.UNSIGNED_SHORT&&(Z=i.RGB16UI),L===i.UNSIGNED_INT&&(Z=i.RGB32UI),L===i.BYTE&&(Z=i.RGB8I),L===i.SHORT&&(Z=i.RGB16I),L===i.INT&&(Z=i.RGB32I)),_===i.RGBA_INTEGER&&(L===i.UNSIGNED_BYTE&&(Z=i.RGBA8UI),L===i.UNSIGNED_SHORT&&(Z=i.RGBA16UI),L===i.UNSIGNED_INT&&(Z=i.RGBA32UI),L===i.BYTE&&(Z=i.RGBA8I),L===i.SHORT&&(Z=i.RGBA16I),L===i.INT&&(Z=i.RGBA32I)),_===i.RGB&&(L===i.UNSIGNED_SHORT&&rt&&(Z=rt.RGB16_EXT),L===i.SHORT&&rt&&(Z=rt.RGB16_SNORM_EXT),L===i.UNSIGNED_INT_5_9_9_9_REV&&(Z=i.RGB9_E5),L===i.UNSIGNED_INT_10F_11F_11F_REV&&(Z=i.R11F_G11F_B10F)),_===i.RGBA){let K=st?ls:Qt.getTransfer(q);L===i.FLOAT&&(Z=i.RGBA32F),L===i.HALF_FLOAT&&(Z=i.RGBA16F),L===i.UNSIGNED_BYTE&&(Z=K===ne?i.SRGB8_ALPHA8:i.RGBA8),L===i.UNSIGNED_SHORT&&rt&&(Z=rt.RGBA16_EXT),L===i.SHORT&&rt&&(Z=rt.RGBA16_SNORM_EXT),L===i.UNSIGNED_SHORT_4_4_4_4&&(Z=i.RGBA4),L===i.UNSIGNED_SHORT_5_5_5_1&&(Z=i.RGB5_A1)}return(Z===i.R16F||Z===i.R32F||Z===i.RG16F||Z===i.RG32F||Z===i.RGBA16F||Z===i.RGBA32F)&&t.get("EXT_color_buffer_float"),Z}function y(T,_){let L;return T?_===null||_===rn||_===Zi?L=i.DEPTH24_STENCIL8:_===on?L=i.DEPTH32F_STENCIL8:_===$i&&(L=i.DEPTH24_STENCIL8,Ut("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===rn||_===Zi?L=i.DEPTH_COMPONENT24:_===on?L=i.DEPTH_COMPONENT32F:_===$i&&(L=i.DEPTH_COMPONENT16),L}function M(T,_){return p(T)===!0||T.isFramebufferTexture&&T.minFilter!==we&&T.minFilter!==Te?Math.log2(Math.max(_.width,_.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?_.mipmaps.length:1}function A(T){let _=T.target;_.removeEventListener("dispose",A),E(_),_.isVideoTexture&&h.delete(_),_.isHTMLTexture&&d.delete(_)}function x(T){let _=T.target;_.removeEventListener("dispose",x),I(_)}function E(T){let _=n.get(T);if(_.__webglInit===void 0)return;let L=T.source,k=f.get(L);if(k){let q=k[_.__cacheKey];q.usedTimes--,q.usedTimes===0&&R(T),Object.keys(k).length===0&&f.delete(L)}n.remove(T)}function R(T){let _=n.get(T);i.deleteTexture(_.__webglTexture);let L=T.source,k=f.get(L);delete k[_.__cacheKey],o.memory.textures--}function I(T){let _=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(_.__webglFramebuffer[k]))for(let q=0;q<_.__webglFramebuffer[k].length;q++)i.deleteFramebuffer(_.__webglFramebuffer[k][q]);else i.deleteFramebuffer(_.__webglFramebuffer[k]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[k])}else{if(Array.isArray(_.__webglFramebuffer))for(let k=0;k<_.__webglFramebuffer.length;k++)i.deleteFramebuffer(_.__webglFramebuffer[k]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let k=0;k<_.__webglColorRenderbuffer.length;k++)_.__webglColorRenderbuffer[k]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[k]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let L=T.textures;for(let k=0,q=L.length;k<q;k++){let st=n.get(L[k]);st.__webglTexture&&(i.deleteTexture(st.__webglTexture),o.memory.textures--),n.remove(L[k])}n.remove(T)}let N=0;function X(){N=0}function Y(){return N}function F(T){N=T}function B(){let T=N;return T>=s.maxTextures&&Ut("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),N+=1,T}function V(T){let _=[];return _.push(T.wrapS),_.push(T.wrapT),_.push(T.wrapR||0),_.push(T.magFilter),_.push(T.minFilter),_.push(T.anisotropy),_.push(T.internalFormat),_.push(T.format),_.push(T.type),_.push(T.generateMipmaps),_.push(T.premultiplyAlpha),_.push(T.flipY),_.push(T.unpackAlignment),_.push(T.colorSpace),_.join()}function $(T,_){let L=n.get(T);if(T.isVideoTexture&&P(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&L.__version!==T.version){let k=T.image;if(k===null)Ut("WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)Ut("WebGLRenderer: Texture marked for update but image is incomplete");else{Bt(L,T,_);return}}else T.isExternalTexture&&(L.__webglTexture=T.sourceTexture?T.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,L.__webglTexture,i.TEXTURE0+_)}function tt(T,_){let L=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&L.__version!==T.version){Bt(L,T,_);return}else T.isExternalTexture&&(L.__webglTexture=T.sourceTexture?T.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,L.__webglTexture,i.TEXTURE0+_)}function it(T,_){let L=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&L.__version!==T.version){Bt(L,T,_);return}e.bindTexture(i.TEXTURE_3D,L.__webglTexture,i.TEXTURE0+_)}function at(T,_){let L=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&L.__version!==T.version){zt(L,T,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,L.__webglTexture,i.TEXTURE0+_)}let mt={[_r]:i.REPEAT,[dn]:i.CLAMP_TO_EDGE,[vr]:i.MIRRORED_REPEAT},Jt={[we]:i.NEAREST,[_c]:i.NEAREST_MIPMAP_NEAREST,[Ts]:i.NEAREST_MIPMAP_LINEAR,[Te]:i.LINEAR,[Gr]:i.LINEAR_MIPMAP_NEAREST,[Jn]:i.LINEAR_MIPMAP_LINEAR},le={[bc]:i.NEVER,[Tc]:i.ALWAYS,[Mc]:i.LESS,[Co]:i.LEQUAL,[Sc]:i.EQUAL,[Ro]:i.GEQUAL,[Ec]:i.GREATER,[wc]:i.NOTEQUAL};function Kt(T,_){if(_.type===on&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===Te||_.magFilter===Gr||_.magFilter===Ts||_.magFilter===Jn||_.minFilter===Te||_.minFilter===Gr||_.minFilter===Ts||_.minFilter===Jn)&&Ut("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,mt[_.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,mt[_.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,mt[_.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,Jt[_.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,Jt[_.minFilter]),_.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,le[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===we||_.minFilter!==Ts&&_.minFilter!==Jn||_.type===on&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){let L=t.get("EXT_texture_filter_anisotropic");i.texParameterf(T,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Q(T,_){let L=!1;T.__webglInit===void 0&&(T.__webglInit=!0,_.addEventListener("dispose",A));let k=_.source,q=f.get(k);q===void 0&&(q={},f.set(k,q));let st=V(_);if(st!==T.__cacheKey){q[st]===void 0&&(q[st]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,L=!0),q[st].usedTimes++;let rt=q[T.__cacheKey];rt!==void 0&&(q[T.__cacheKey].usedTimes--,rt.usedTimes===0&&R(_)),T.__cacheKey=st,T.__webglTexture=q[st].texture}return L}function ot(T,_,L){return Math.floor(Math.floor(T/L)/_)}function nt(T,_,L,k){let st=T.updateRanges;if(st.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,L,k,_.data);else{st.sort((Ct,ft)=>Ct.start-ft.start);let rt=0;for(let Ct=1;Ct<st.length;Ct++){let ft=st[rt],ht=st[Ct],Dt=ft.start+ft.count,Ft=ot(ht.start,_.width,4),Ht=ot(ft.start,_.width,4);ht.start<=Dt+1&&Ft===Ht&&ot(ht.start+ht.count-1,_.width,4)===Ft?ft.count=Math.max(ft.count,ht.start+ht.count-ft.start):(++rt,st[rt]=ht)}st.length=rt+1;let Z=e.getParameter(i.UNPACK_ROW_LENGTH),K=e.getParameter(i.UNPACK_SKIP_PIXELS),ct=e.getParameter(i.UNPACK_SKIP_ROWS);e.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let Ct=0,ft=st.length;Ct<ft;Ct++){let ht=st[Ct],Dt=Math.floor(ht.start/4),Ft=Math.ceil(ht.count/4),Ht=Dt%_.width,U=Math.floor(Dt/_.width),lt=Ft,j=1;e.pixelStorei(i.UNPACK_SKIP_PIXELS,Ht),e.pixelStorei(i.UNPACK_SKIP_ROWS,U),e.texSubImage2D(i.TEXTURE_2D,0,Ht,U,lt,j,L,k,_.data)}T.clearUpdateRanges(),e.pixelStorei(i.UNPACK_ROW_LENGTH,Z),e.pixelStorei(i.UNPACK_SKIP_PIXELS,K),e.pixelStorei(i.UNPACK_SKIP_ROWS,ct)}}function Bt(T,_,L){let k=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(k=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(k=i.TEXTURE_3D);let q=Q(T,_),st=_.source;e.bindTexture(k,T.__webglTexture,i.TEXTURE0+L);let rt=n.get(st);if(st.version!==rt.__version||q===!0){if(e.activeTexture(i.TEXTURE0+L),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){let j=Qt.getPrimaries(Qt.workingColorSpace),ut=_.colorSpace===In?null:Qt.getPrimaries(_.colorSpace),_t=_.colorSpace===In||j===ut?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,_t)}e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let K=g(_.image,!1,s.maxTextureSize);K=At(_,K);let ct=r.convert(_.format,_.colorSpace),Ct=r.convert(_.type),ft=S(_.internalFormat,ct,Ct,_.normalized,_.colorSpace,_.isVideoTexture);Kt(k,_);let ht,Dt=_.mipmaps,Ft=_.isVideoTexture!==!0,Ht=rt.__version===void 0||q===!0,U=st.dataReady,lt=M(_,K);if(_.isDepthTexture)ft=y(_.format===Kn,_.type),Ht&&(Ft?e.texStorage2D(i.TEXTURE_2D,1,ft,K.width,K.height):e.texImage2D(i.TEXTURE_2D,0,ft,K.width,K.height,0,ct,Ct,null));else if(_.isDataTexture)if(Dt.length>0){Ft&&Ht&&e.texStorage2D(i.TEXTURE_2D,lt,ft,Dt[0].width,Dt[0].height);for(let j=0,ut=Dt.length;j<ut;j++)ht=Dt[j],Ft?U&&e.texSubImage2D(i.TEXTURE_2D,j,0,0,ht.width,ht.height,ct,Ct,ht.data):e.texImage2D(i.TEXTURE_2D,j,ft,ht.width,ht.height,0,ct,Ct,ht.data);_.generateMipmaps=!1}else Ft?(Ht&&e.texStorage2D(i.TEXTURE_2D,lt,ft,K.width,K.height),U&&nt(_,K,ct,Ct)):e.texImage2D(i.TEXTURE_2D,0,ft,K.width,K.height,0,ct,Ct,K.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Ft&&Ht&&e.texStorage3D(i.TEXTURE_2D_ARRAY,lt,ft,Dt[0].width,Dt[0].height,K.depth);for(let j=0,ut=Dt.length;j<ut;j++)if(ht=Dt[j],_.format!==Ke)if(ct!==null)if(Ft){if(U)if(_.layerUpdates.size>0){let _t=Ja(ht.width,ht.height,_.format,_.type);for(let et of _.layerUpdates){let Tt=ht.data.subarray(et*_t/ht.data.BYTES_PER_ELEMENT,(et+1)*_t/ht.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,et,ht.width,ht.height,1,ct,Tt)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,ht.width,ht.height,K.depth,ct,ht.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,j,ft,ht.width,ht.height,K.depth,0,ht.data,0,0);else Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ft?U&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,ht.width,ht.height,K.depth,ct,Ct,ht.data):e.texImage3D(i.TEXTURE_2D_ARRAY,j,ft,ht.width,ht.height,K.depth,0,ct,Ct,ht.data)}else{Ft&&Ht&&e.texStorage2D(i.TEXTURE_2D,lt,ft,Dt[0].width,Dt[0].height);for(let j=0,ut=Dt.length;j<ut;j++)ht=Dt[j],_.format!==Ke?ct!==null?Ft?U&&e.compressedTexSubImage2D(i.TEXTURE_2D,j,0,0,ht.width,ht.height,ct,ht.data):e.compressedTexImage2D(i.TEXTURE_2D,j,ft,ht.width,ht.height,0,ht.data):Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ft?U&&e.texSubImage2D(i.TEXTURE_2D,j,0,0,ht.width,ht.height,ct,Ct,ht.data):e.texImage2D(i.TEXTURE_2D,j,ft,ht.width,ht.height,0,ct,Ct,ht.data)}else if(_.isDataArrayTexture)if(Ft){if(Ht&&e.texStorage3D(i.TEXTURE_2D_ARRAY,lt,ft,K.width,K.height,K.depth),U)if(_.layerUpdates.size>0){let j=Ja(K.width,K.height,_.format,_.type);for(let ut of _.layerUpdates){let _t=K.data.subarray(ut*j/K.data.BYTES_PER_ELEMENT,(ut+1)*j/K.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ut,K.width,K.height,1,ct,Ct,_t)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,ct,Ct,K.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,ft,K.width,K.height,K.depth,0,ct,Ct,K.data);else if(_.isData3DTexture)Ft?(Ht&&e.texStorage3D(i.TEXTURE_3D,lt,ft,K.width,K.height,K.depth),U&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,ct,Ct,K.data)):e.texImage3D(i.TEXTURE_3D,0,ft,K.width,K.height,K.depth,0,ct,Ct,K.data);else if(_.isFramebufferTexture){if(Ht)if(Ft)e.texStorage2D(i.TEXTURE_2D,lt,ft,K.width,K.height);else{let j=K.width,ut=K.height;for(let _t=0;_t<lt;_t++)e.texImage2D(i.TEXTURE_2D,_t,ft,j,ut,0,ct,Ct,null),j>>=1,ut>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){let j=i.canvas;if(j.hasAttribute("layoutsubtree")||j.setAttribute("layoutsubtree","true"),K.parentNode!==j){j.appendChild(K),d.add(_),j.onpaint=ut=>{let _t=ut.changedElements;for(let et of d)_t.includes(et.image)&&(et.needsUpdate=!0)},j.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,K);else{let _t=i.RGBA,et=i.RGBA,Tt=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,_t,et,Tt,K)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Dt.length>0){if(Ft&&Ht){let j=Nt(Dt[0]);e.texStorage2D(i.TEXTURE_2D,lt,ft,j.width,j.height)}for(let j=0,ut=Dt.length;j<ut;j++)ht=Dt[j],Ft?U&&e.texSubImage2D(i.TEXTURE_2D,j,0,0,ct,Ct,ht):e.texImage2D(i.TEXTURE_2D,j,ft,ct,Ct,ht);_.generateMipmaps=!1}else if(Ft){if(Ht){let j=Nt(K);e.texStorage2D(i.TEXTURE_2D,lt,ft,j.width,j.height)}U&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,ct,Ct,K)}else e.texImage2D(i.TEXTURE_2D,0,ft,ct,Ct,K);p(_)&&C(k),rt.__version=st.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function zt(T,_,L){if(_.image.length!==6)return;let k=Q(T,_),q=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+L);let st=n.get(q);if(q.version!==st.__version||k===!0){e.activeTexture(i.TEXTURE0+L);let rt=Qt.getPrimaries(Qt.workingColorSpace),Z=_.colorSpace===In?null:Qt.getPrimaries(_.colorSpace),K=_.colorSpace===In||rt===Z?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,K);let ct=_.isCompressedTexture||_.image[0].isCompressedTexture,Ct=_.image[0]&&_.image[0].isDataTexture,ft=[];for(let et=0;et<6;et++)!ct&&!Ct?ft[et]=g(_.image[et],!0,s.maxCubemapSize):ft[et]=Ct?_.image[et].image:_.image[et],ft[et]=At(_,ft[et]);let ht=ft[0],Dt=r.convert(_.format,_.colorSpace),Ft=r.convert(_.type),Ht=S(_.internalFormat,Dt,Ft,_.normalized,_.colorSpace),U=_.isVideoTexture!==!0,lt=st.__version===void 0||k===!0,j=q.dataReady,ut=M(_,ht);Kt(i.TEXTURE_CUBE_MAP,_);let _t;if(ct){U&&lt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ut,Ht,ht.width,ht.height);for(let et=0;et<6;et++){_t=ft[et].mipmaps;for(let Tt=0;Tt<_t.length;Tt++){let Et=_t[Tt];_.format!==Ke?Dt!==null?U?j&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt,0,0,Et.width,Et.height,Dt,Et.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt,Ht,Et.width,Et.height,0,Et.data):Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?j&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt,0,0,Et.width,Et.height,Dt,Ft,Et.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt,Ht,Et.width,Et.height,0,Dt,Ft,Et.data)}}}else{if(_t=_.mipmaps,U&&lt){_t.length>0&&ut++;let et=Nt(ft[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ut,Ht,et.width,et.height)}for(let et=0;et<6;et++)if(Ct){U?j&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,ft[et].width,ft[et].height,Dt,Ft,ft[et].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Ht,ft[et].width,ft[et].height,0,Dt,Ft,ft[et].data);for(let Tt=0;Tt<_t.length;Tt++){let pe=_t[Tt].image[et].image;U?j&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt+1,0,0,pe.width,pe.height,Dt,Ft,pe.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt+1,Ht,pe.width,pe.height,0,Dt,Ft,pe.data)}}else{U?j&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,Dt,Ft,ft[et]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Ht,Dt,Ft,ft[et]);for(let Tt=0;Tt<_t.length;Tt++){let Et=_t[Tt];U?j&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt+1,0,0,Dt,Ft,Et.image[et]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt+1,Ht,Dt,Ft,Et.image[et])}}}p(_)&&C(i.TEXTURE_CUBE_MAP),st.__version=q.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function Lt(T,_,L,k,q,st){let rt=r.convert(L.format,L.colorSpace),Z=r.convert(L.type),K=S(L.internalFormat,rt,Z,L.normalized,L.colorSpace),ct=n.get(_),Ct=n.get(L);if(Ct.__renderTarget=_,!ct.__hasExternalTextures){let ft=Math.max(1,_.width>>st),ht=Math.max(1,_.height>>st);q===i.TEXTURE_3D||q===i.TEXTURE_2D_ARRAY?e.texImage3D(q,st,K,ft,ht,_.depth,0,rt,Z,null):e.texImage2D(q,st,K,ft,ht,0,rt,Z,null)}e.bindFramebuffer(i.FRAMEBUFFER,T),vt(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,k,q,Ct.__webglTexture,0,St(_)):(q===i.TEXTURE_2D||q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,k,q,Ct.__webglTexture,st),e.bindFramebuffer(i.FRAMEBUFFER,null)}function re(T,_,L){if(i.bindRenderbuffer(i.RENDERBUFFER,T),_.depthBuffer){let k=_.depthTexture,q=k&&k.isDepthTexture?k.type:null,st=y(_.stencilBuffer,q),rt=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;vt(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,St(_),st,_.width,_.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,St(_),st,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,st,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,rt,i.RENDERBUFFER,T)}else{let k=_.textures;for(let q=0;q<k.length;q++){let st=k[q],rt=r.convert(st.format,st.colorSpace),Z=r.convert(st.type),K=S(st.internalFormat,rt,Z,st.normalized,st.colorSpace);vt(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,St(_),K,_.width,_.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,St(_),K,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,K,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Yt(T,_,L){let k=_.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,T),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let q=n.get(_.depthTexture);if(q.__renderTarget=_,(!q.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),k){if(q.__webglInit===void 0&&(q.__webglInit=!0,_.depthTexture.addEventListener("dispose",A)),q.__webglTexture===void 0){q.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),Kt(i.TEXTURE_CUBE_MAP,_.depthTexture);let ct=r.convert(_.depthTexture.format),Ct=r.convert(_.depthTexture.type),ft;_.depthTexture.format===fn?ft=i.DEPTH_COMPONENT24:_.depthTexture.format===Kn&&(ft=i.DEPTH24_STENCIL8);for(let ht=0;ht<6;ht++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,0,ft,_.width,_.height,0,ct,Ct,null)}}else $(_.depthTexture,0);let st=q.__webglTexture,rt=St(_),Z=k?i.TEXTURE_CUBE_MAP_POSITIVE_X+L:i.TEXTURE_2D,K=_.depthTexture.format===Kn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===fn)vt(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,Z,st,0,rt):i.framebufferTexture2D(i.FRAMEBUFFER,K,Z,st,0);else if(_.depthTexture.format===Kn)vt(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,Z,st,0,rt):i.framebufferTexture2D(i.FRAMEBUFFER,K,Z,st,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Wt(T){let _=n.get(T),L=T.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==T.depthTexture){let k=T.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),k){let q=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,k.removeEventListener("dispose",q)};k.addEventListener("dispose",q),_.__depthDisposeCallback=q}_.__boundDepthTexture=k}if(T.depthTexture&&!_.__autoAllocateDepthBuffer)if(L)for(let k=0;k<6;k++)Yt(_.__webglFramebuffer[k],T,k);else{let k=T.texture.mipmaps;k&&k.length>0?Yt(_.__webglFramebuffer[0],T,0):Yt(_.__webglFramebuffer,T,0)}else if(L){_.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[k]),_.__webglDepthbuffer[k]===void 0)_.__webglDepthbuffer[k]=i.createRenderbuffer(),re(_.__webglDepthbuffer[k],T,!1);else{let q=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,st=_.__webglDepthbuffer[k];i.bindRenderbuffer(i.RENDERBUFFER,st),i.framebufferRenderbuffer(i.FRAMEBUFFER,q,i.RENDERBUFFER,st)}}else{let k=T.texture.mipmaps;if(k&&k.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),re(_.__webglDepthbuffer,T,!1);else{let q=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,st=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,st),i.framebufferRenderbuffer(i.FRAMEBUFFER,q,i.RENDERBUFFER,st)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Zt(T,_,L){let k=n.get(T);_!==void 0&&Lt(k.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),L!==void 0&&Wt(T)}function jt(T){let _=T.texture,L=n.get(T),k=n.get(_);T.addEventListener("dispose",x);let q=T.textures,st=T.isWebGLCubeRenderTarget===!0,rt=q.length>1;if(rt||(k.__webglTexture===void 0&&(k.__webglTexture=i.createTexture()),k.__version=_.version,o.memory.textures++),st){L.__webglFramebuffer=[];for(let Z=0;Z<6;Z++)if(_.mipmaps&&_.mipmaps.length>0){L.__webglFramebuffer[Z]=[];for(let K=0;K<_.mipmaps.length;K++)L.__webglFramebuffer[Z][K]=i.createFramebuffer()}else L.__webglFramebuffer[Z]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){L.__webglFramebuffer=[];for(let Z=0;Z<_.mipmaps.length;Z++)L.__webglFramebuffer[Z]=i.createFramebuffer()}else L.__webglFramebuffer=i.createFramebuffer();if(rt)for(let Z=0,K=q.length;Z<K;Z++){let ct=n.get(q[Z]);ct.__webglTexture===void 0&&(ct.__webglTexture=i.createTexture(),o.memory.textures++)}if(T.samples>0&&vt(T)===!1){L.__webglMultisampledFramebuffer=i.createFramebuffer(),L.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let Z=0;Z<q.length;Z++){let K=q[Z];L.__webglColorRenderbuffer[Z]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,L.__webglColorRenderbuffer[Z]);let ct=r.convert(K.format,K.colorSpace),Ct=r.convert(K.type),ft=S(K.internalFormat,ct,Ct,K.normalized,K.colorSpace,T.isXRRenderTarget===!0),ht=St(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,ht,ft,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Z,i.RENDERBUFFER,L.__webglColorRenderbuffer[Z])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(L.__webglDepthRenderbuffer=i.createRenderbuffer(),re(L.__webglDepthRenderbuffer,T,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(st){e.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture),Kt(i.TEXTURE_CUBE_MAP,_);for(let Z=0;Z<6;Z++)if(_.mipmaps&&_.mipmaps.length>0)for(let K=0;K<_.mipmaps.length;K++)Lt(L.__webglFramebuffer[Z][K],T,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,K);else Lt(L.__webglFramebuffer[Z],T,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0);p(_)&&C(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(rt){for(let Z=0,K=q.length;Z<K;Z++){let ct=q[Z],Ct=n.get(ct),ft=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ft=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ft,Ct.__webglTexture),Kt(ft,ct),Lt(L.__webglFramebuffer,T,ct,i.COLOR_ATTACHMENT0+Z,ft,0),p(ct)&&C(ft)}e.unbindTexture()}else{let Z=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(Z=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(Z,k.__webglTexture),Kt(Z,_),_.mipmaps&&_.mipmaps.length>0)for(let K=0;K<_.mipmaps.length;K++)Lt(L.__webglFramebuffer[K],T,_,i.COLOR_ATTACHMENT0,Z,K);else Lt(L.__webglFramebuffer,T,_,i.COLOR_ATTACHMENT0,Z,0);p(_)&&C(Z),e.unbindTexture()}T.depthBuffer&&Wt(T)}function z(T){let _=T.textures;for(let L=0,k=_.length;L<k;L++){let q=_[L];if(p(q)){let st=w(T),rt=n.get(q).__webglTexture;e.bindTexture(st,rt),C(st),e.unbindTexture()}}}let J=[],dt=[];function Mt(T){if(T.samples>0){if(vt(T)===!1){let _=T.textures,L=T.width,k=T.height,q=i.COLOR_BUFFER_BIT,st=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,rt=n.get(T),Z=_.length>1;if(Z)for(let ct=0;ct<_.length;ct++)e.bindFramebuffer(i.FRAMEBUFFER,rt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,rt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,rt.__webglMultisampledFramebuffer);let K=T.texture.mipmaps;K&&K.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,rt.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,rt.__webglFramebuffer);for(let ct=0;ct<_.length;ct++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(q|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(q|=i.STENCIL_BUFFER_BIT)),Z){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,rt.__webglColorRenderbuffer[ct]);let Ct=n.get(_[ct]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ct,0)}i.blitFramebuffer(0,0,L,k,0,0,L,k,q,i.NEAREST),l===!0&&(J.length=0,dt.length=0,J.push(i.COLOR_ATTACHMENT0+ct),T.depthBuffer&&T.resolveDepthBuffer===!1&&(J.push(st),dt.push(st),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,dt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,J))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Z)for(let ct=0;ct<_.length;ct++){e.bindFramebuffer(i.FRAMEBUFFER,rt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.RENDERBUFFER,rt.__webglColorRenderbuffer[ct]);let Ct=n.get(_[ct]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,rt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.TEXTURE_2D,Ct,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,rt.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){let _=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function St(T){return Math.min(s.maxSamples,T.samples)}function vt(T){let _=n.get(T);return T.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function P(T){let _=o.render.frame;h.get(T)!==_&&(h.set(T,_),T.update())}function At(T,_){let L=T.colorSpace,k=T.format,q=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||L!==as&&L!==In&&(Qt.getTransfer(L)===ne?(k!==Ke||q!==ke)&&Ut("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ot("WebGLTextures: Unsupported texture color space:",L)),_}function Nt(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=B,this.resetTextureUnits=X,this.getTextureUnits=Y,this.setTextureUnits=F,this.setTexture2D=$,this.setTexture2DArray=tt,this.setTexture3D=it,this.setTextureCube=at,this.rebindTextures=Zt,this.setupRenderTarget=jt,this.updateRenderTargetMipmap=z,this.updateMultisampleRenderTarget=Mt,this.setupDepthRenderbuffer=Wt,this.setupFrameBufferTexture=Lt,this.useMultisampledRTT=vt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function cg(i,t){function e(n,s=In){let r,o=Qt.getTransfer(s);if(n===ke)return i.UNSIGNED_BYTE;if(n===Xr)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Yr)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Ba)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===za)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Fa)return i.BYTE;if(n===Oa)return i.SHORT;if(n===$i)return i.UNSIGNED_SHORT;if(n===Wr)return i.INT;if(n===rn)return i.UNSIGNED_INT;if(n===on)return i.FLOAT;if(n===xn)return i.HALF_FLOAT;if(n===ka)return i.ALPHA;if(n===Va)return i.RGB;if(n===Ke)return i.RGBA;if(n===fn)return i.DEPTH_COMPONENT;if(n===Kn)return i.DEPTH_STENCIL;if(n===Ha)return i.RED;if(n===qr)return i.RED_INTEGER;if(n===jn)return i.RG;if(n===$r)return i.RG_INTEGER;if(n===Zr)return i.RGBA_INTEGER;if(n===As||n===Cs||n===Rs||n===Is)if(o===ne)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===As)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Cs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Rs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Is)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===As)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Cs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Rs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Is)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Jr||n===Kr||n===jr||n===Qr)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Jr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Kr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===jr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Qr)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===to||n===eo||n===no||n===io||n===so||n===Ps||n===ro)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===to||n===eo)return o===ne?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===no)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===io)return r.COMPRESSED_R11_EAC;if(n===so)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Ps)return r.COMPRESSED_RG11_EAC;if(n===ro)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===oo||n===ao||n===lo||n===co||n===ho||n===uo||n===fo||n===po||n===mo||n===go||n===xo||n===_o||n===vo||n===yo)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===oo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ao)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===lo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===co)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ho)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===uo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===fo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===po)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===mo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===go)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===xo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===_o)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===vo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===yo)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===bo||n===Mo||n===So)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===bo)return o===ne?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Mo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===So)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Eo||n===wo||n===Ls||n===To)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===Eo)return r.COMPRESSED_RED_RGTC1_EXT;if(n===wo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ls)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===To)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Zi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}var hg=`
void main() {
...
}`,hl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){let n=new xs(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new Ue({vertexShader:hg,fragmentShader:ug,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new ge(new _s(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},ul=class extends pn{constructor(t,e){super();let n=this,s=null,r=1,o=null,a="local-floor",l=1,c=null,h=null,d=null,u=null,f=null,m=null,v=typeof XRWebGLBinding<"u",g=new hl,p={},C=e.getContextAttributes(),w=null,S=null,y=[],M=[],A=new $t,x=null,E=new Pe;E.viewport=new fe;let R=new Pe;R.viewport=new fe;let I=[E,R],N=new kr,X=null,Y=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let ot=y[Q];return ot===void 0&&(ot=new zi,y[Q]=ot),ot.getTargetRaySpace()},this.getControllerGrip=function(Q){let ot=y[Q];return ot===void 0&&(ot=new zi,y[Q]=ot),ot.getGripSpace()},this.getHand=function(Q){let ot=y[Q];return ot===void 0&&(ot=new zi,y[Q]=ot),ot.getHandSpace()};function F(Q){let ot=M.indexOf(Q.inputSource);if(ot===-1)return;let nt=y[ot];nt!==void 0&&(nt.update(Q.inputSource,Q.frame,c||o),nt.dispatchEvent({type:Q.type,data:Q.inputSource}))}function B(){s.removeEventListener("select",F),s.removeEventListener("selectstart",F),s.removeEventListener("selectend",F),s.removeEventListener("squeeze",F),s.removeEventListener("squeezestart",F),s.removeEventListener("squeezeend",F),s.removeEventListener("end",B),s.removeEventListener("inputsourceschange",V);for(let Q=0;Q<y.length;Q++){let ot=M[Q];ot!==null&&(M[Q]=null,y[Q].disconnect(ot))}X=null,Y=null,g.reset();for(let Q in p)delete p[Q];t.setRenderTarget(w),f=null,u=null,d=null,s=null,S=null,Kt.stop(),n.isPresenting=!1,t.setPixelRatio(x),t.setSize(A.width,A.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){r=Q,n.isPresenting===!0&&Ut("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){a=Q,n.isPresenting===!0&&Ut("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(Q){c=Q},this.getBaseLayer=function(){return u!==null?u:f},this.getBinding=function(){return d===null&&v&&(d=new XRWebGLBinding(s,e)),d},this.getFrame=function(){return m},this.getSession=function(){return s},this.setSession=async function(Q){if(s=Q,s!==null){if(w=t.getRenderTarget(),s.addEventListener("select",F),s.addEventListener("selectstart",F),s.addEventListener("selectend",F),s.addEventListener("squeeze",F),s.addEventListener("squeezestart",F),s.addEventListener("squeezeend",F),s.addEventListener("end",B),s.addEventListener("inputsourceschange",V),C.xrCompatible!==!0&&await e.makeXRCompatible(),x=t.getPixelRatio(),t.getSize(A),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let nt=null,Bt=null,zt=null;C.depth&&(zt=C.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,nt=C.stencil?Kn:fn,Bt=C.stencil?Zi:rn);let Lt={colorFormat:e.RGBA8,depthFormat:zt,scaleFactor:r};d=this.getBinding(),u=d.createProjectionLayer(Lt),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),S=new Xe(u.textureWidth,u.textureHeight,{format:Ke,type:ke,depthTexture:new Rn(u.textureWidth,u.textureHeight,Bt,void 0,void 0,void 0,void 0,void 0,void 0,nt),stencilBuffer:C.stencil,colorSpace:t.outputColorSpace,samples:C.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{let nt={antialias:C.antialias,alpha:!0,depth:C.depth,stencil:C.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,e,nt),s.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),S=new Xe(f.framebufferWidth,f.framebufferHeight,{format:Ke,type:ke,colorSpace:t.outputColorSpace,stencilBuffer:C.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await s.requestReferenceSpace(a),Kt.setContext(s),Kt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function V(Q){for(let ot=0;ot<Q.removed.length;ot++){let nt=Q.removed[ot],Bt=M.indexOf(nt);Bt>=0&&(M[Bt]=null,y[Bt].disconnect(nt))}for(let ot=0;ot<Q.added.length;ot++){let nt=Q.added[ot],Bt=M.indexOf(nt);if(Bt===-1){for(let Lt=0;Lt<y.length;Lt++)if(Lt>=M.length){M.push(nt),Bt=Lt;break}else if(M[Lt]===null){M[Lt]=nt,Bt=Lt;break}if(Bt===-1)break}let zt=y[Bt];zt&&zt.connect(nt)}}let $=new D,tt=new D;function it(Q,ot,nt){$.setFromMatrixPosition(ot.matrixWorld),tt.setFromMatrixPosition(nt.matrixWorld);let Bt=$.distanceTo(tt),zt=ot.projectionMatrix.elements,Lt=nt.projectionMatrix.elements,re=zt[14]/(zt[10]-1),Yt=zt[14]/(zt[10]+1),Wt=(zt[9]+1)/zt[5],Zt=(zt[9]-1)/zt[5],jt=(zt[8]-1)/zt[0],z=(Lt[8]+1)/Lt[0],J=re*jt,dt=re*z,Mt=Bt/(-jt+z),St=Mt*-jt;if(ot.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(St),Q.translateZ(Mt),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert(),zt[10]===-1)Q.projectionMatrix.copy(ot.projectionMatrix),Q.projectionMatrixInverse.copy(ot.projectionMatrixInverse);else{let vt=re+Mt,P=Yt+Mt,At=J-St,Nt=dt+(Bt-St),T=Wt*Yt/P*vt,_=Zt*Yt/P*vt;Q.projectionMatrix.makePerspective(At,Nt,T,_,vt,P),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}}function at(Q,ot){ot===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(ot.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(s===null)return;let ot=Q.near,nt=Q.far;g.texture!==null&&(g.depthNear>0&&(ot=g.depthNear),g.depthFar>0&&(nt=g.depthFar)),N.near=R.near=E.near=ot,N.far=R.far=E.far=nt,(X!==N.near||Y!==N.far)&&(s.updateRenderState({depthNear:N.near,depthFar:N.far}),X=N.near,Y=N.far),N.layers.mask=Q.layers.mask|6,E.layers.mask=N.layers.mask&-5,R.layers.mask=N.layers.mask&-3;let Bt=Q.parent,zt=N.cameras;at(N,Bt);for(let Lt=0;Lt<zt.length;Lt++)at(zt[Lt],Bt);zt.length===2?it(N,E,R):N.projectionMatrix.copy(E.projectionMatrix),mt(Q,N,Bt)};function mt(Q,ot,nt){nt===null?Q.matrix.copy(ot.matrixWorld):(Q.matrix.copy(nt.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(ot.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(ot.projectionMatrix),Q.projectionMatrixInverse.copy(ot.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=Fi*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(u===null&&f===null))return l},this.setFoveation=function(Q){l=Q,u!==null&&(u.fixedFoveation=Q),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=Q)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(N)},this.getCameraTexture=function(Q){return p[Q]};let Jt=null;function le(Q,ot){if(h=ot.getViewerPose(c||o),m=ot,h!==null){let nt=h.views;f!==null&&(t.setRenderTargetFramebuffer(S,f.framebuffer),t.setRenderTarget(S));let Bt=!1;nt.length!==N.cameras.length&&(N.cameras.length=0,Bt=!0);for(let Yt=0;Yt<nt.length;Yt++){let Wt=nt[Yt],Zt=null;if(f!==null)Zt=f.getViewport(Wt);else{let z=d.getViewSubImage(u,Wt);Zt=z.viewport,Yt===0&&(t.setRenderTargetTextures(S,z.colorTexture,z.depthStencilTexture),t.setRenderTarget(S))}let jt=I[Yt];jt===void 0&&(jt=new Pe,jt.layers.enable(Yt),jt.viewport=new fe,I[Yt]=jt),jt.matrix.fromArray(Wt.transform.matrix),jt.matrix.decompose(jt.position,jt.quaternion,jt.scale),jt.projectionMatrix.fromArray(Wt.projectionMatrix),jt.projectionMatrixInverse.copy(jt.projectionMatrix).invert(),jt.viewport.set(Zt.x,Zt.y,Zt.width,Zt.height),Yt===0&&(N.matrix.copy(jt.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),Bt===!0&&N.cameras.push(jt)}let zt=s.enabledFeatures;if(zt&&zt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&v){d=n.getBinding();let Yt=d.getDepthInformation(nt[0]);Yt&&Yt.isValid&&Yt.texture&&g.init(Yt,s.renderState)}if(zt&&zt.includes("camera-access")&&v){t.state.unbindTexture(),d=n.getBinding();for(let Yt=0;Yt<nt.length;Yt++){let Wt=nt[Yt].camera;if(Wt){let Zt=p[Wt];Zt||(Zt=new xs,p[Wt]=Zt);let jt=d.getCameraImage(Wt);Zt.sourceTexture=jt}}}}for(let nt=0;nt<y.length;nt++){let Bt=M[nt],zt=y[nt];Bt!==null&&zt!==void 0&&zt.update(Bt,ot,c||o)}Jt&&Jt(Q,ot),ot.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ot}),m=null}let Kt=new nh;Kt.setAnimationLoop(le),this.setAnimationLoop=function(Q){Jt=Q},this.dispose=function(){}}},dg=new de,lh=new kt;lh.set(-1,0,0,0,1,0,0,0,1);function fg(i,t){function e(g,p){g.matrixAutoUpdate===!0&&g.updateMatrix(),p.value.copy(g.matrix)}function n(g,p){p.color.getRGB(g.fogColor.value,qa(i)),p.isFog?(g.fogNear.value=p.near,g.fogFar.value=p.far):p.isFogExp2&&(g.fogDensity.value=p.density)}function s(g,p,C,w,S){p.isNodeMaterial?p.uniformsNeedUpdate=!1:p.isMeshBasicMaterial?r(g,p):p.isMeshLambertMaterial?(r(g,p),p.envMap&&(g.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(r(g,p),d(g,p)):p.isMeshPhongMaterial?(r(g,p),h(g,p),p.envMap&&(g.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(r(g,p),u(g,p),p.isMeshPhysicalMaterial&&f(g,p,S)):p.isMeshMatcapMaterial?(r(g,p),m(g,p)):p.isMeshDepthMaterial?r(g,p):p.isMeshDistanceMaterial?(r(g,p),v(g,p)):p.isMeshNormalMaterial?r(g,p):p.isLineBasicMaterial?(o(g,p),p.isLineDashedMaterial&&a(g,p)):p.isPointsMaterial?l(g,p,C,w):p.isSpriteMaterial?c(g,p):p.isShadowMaterial?(g.color.value.copy(p.color),g.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(g,p){g.opacity.value=p.opacity,p.color&&g.diffuse.value.copy(p.color),p.emissive&&g.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(g.map.value=p.map,e(p.map,g.mapTransform)),p.alphaMap&&(g.alphaMap.value=p.alphaMap,e(p.alphaMap,g.alphaMapTransform)),p.bumpMap&&(g.bumpMap.value=p.bumpMap,e(p.bumpMap,g.bumpMapTransform),g.bumpScale.value=p.bumpScale,p.side===Ae&&(g.bumpScale.value*=-1)),p.normalMap&&(g.normalMap.value=p.normalMap,e(p.normalMap,g.normalMapTransform),g.normalScale.value.copy(p.normalScale),p.side===Ae&&g.normalScale.value.negate()),p.displacementMap&&(g.displacementMap.value=p.displacementMap,e(p.displacementMap,g.displacementMapTransform),g.displacementScale.value=p.displacementScale,g.displacementBias.value=p.displacementBias),p.emissiveMap&&(g.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,g.emissiveMapTransform)),p.specularMap&&(g.specularMap.value=p.specularMap,e(p.specularMap,g.specularMapTransform)),p.alphaTest>0&&(g.alphaTest.value=p.alphaTest);let C=t.get(p),w=C.envMap,S=C.envMapRotation;w&&(g.envMap.value=w,g.envMapRotation.value.setFromMatrix4(dg.makeRotationFromEuler(S)).transpose(),w.isCubeTexture&&w.isRenderTargetTexture===!1&&g.envMapRotation.value.premultiply(lh),g.reflectivity.value=p.reflectivity,g.ior.value=p.ior,g.refractionRatio.value=p.refractionRatio),p.lightMap&&(g.lightMap.value=p.lightMap,g.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,g.lightMapTransform)),p.aoMap&&(g.aoMap.value=p.aoMap,g.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,g.aoMapTransform))}function o(g,p){g.diffuse.value.copy(p.color),g.opacity.value=p.opacity,p.map&&(g.map.value=p.map,e(p.map,g.mapTransform))}function a(g,p){g.dashSize.value=p.dashSize,g.totalSize.value=p.dashSize+p.gapSize,g.scale.value=p.scale}function l(g,p,C,w){g.diffuse.value.copy(p.color),g.opacity.value=p.opacity,g.size.value=p.size*C,g.scale.value=w*.5,p.map&&(g.map.value=p.map,e(p.map,g.uvTransform)),p.alphaMap&&(g.alphaMap.value=p.alphaMap,e(p.alphaMap,g.alphaMapTransform)),p.alphaTest>0&&(g.alphaTest.value=p.alphaTest)}function c(g,p){g.diffuse.value.copy(p.color),g.opacity.value=p.opacity,g.rotation.value=p.rotation,p.map&&(g.map.value=p.map,e(p.map,g.mapTransform)),p.alphaMap&&(g.alphaMap.value=p.alphaMap,e(p.alphaMap,g.alphaMapTransform)),p.alphaTest>0&&(g.alphaTest.value=p.alphaTest)}function h(g,p){g.specular.value.copy(p.specular),g.shininess.value=Math.max(p.shininess,1e-4)}function d(g,p){p.gradientMap&&(g.gradientMap.value=p.gradientMap)}function u(g,p){g.metalness.value=p.metalness,p.metalnessMap&&(g.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,g.metalnessMapTransform)),g.roughness.value=p.roughness,p.roughnessMap&&(g.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,g.roughnessMapTransform)),p.envMap&&(g.envMapIntensity.value=p.envMapIntensity)}function f(g,p,C){g.ior.value=p.ior,p.sheen>0&&(g.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),g.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(g.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,g.sheenColorMapTransform)),p.sheenRoughnessMap&&(g.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,g.sheenRoughnessMapTransform))),p.clearcoat>0&&(g.clearcoat.value=p.clearcoat,g.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(g.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,g.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(g.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Ae&&g.clearcoatNormalScale.value.negate())),p.dispersion>0&&(g.dispersion.value=p.dispersion),p.iridescence>0&&(g.iridescence.value=p.iridescence,g.iridescenceIOR.value=p.iridescenceIOR,g.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(g.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,g.iridescenceMapTransform)),p.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),p.transmission>0&&(g.transmission.value=p.transmission,g.transmissionSamplerMap.value=C.texture,g.transmissionSamplerSize.value.set(C.width,C.height),p.transmissionMap&&(g.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,g.transmissionMapTransform)),g.thickness.value=p.thickness,p.thicknessMap&&(g.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=p.attenuationDistance,g.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(g.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(g.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=p.specularIntensity,g.specularColor.value.copy(p.specularColor),p.specularColorMap&&(g.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,g.specularColorMapTransform)),p.specularIntensityMap&&(g.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,g.specularIntensityMapTransform))}function m(g,p){p.matcap&&(g.matcap.value=p.matcap)}function v(g,p){let C=t.get(p).light;g.referencePosition.value.setFromMatrixPosition(C.matrixWorld),g.nearDistance.value=C.shadow.camera.near,g.farDistance.value=C.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function pg(i,t,e,n){let s={},r={},o=[],a=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(S,y){let M=y.program;n.uniformBlockBinding(S,M)}function c(S,y){let M=s[S.id];M===void 0&&(g(S),M=h(S),s[S.id]=M,S.addEventListener("dispose",C));let A=y.program;n.updateUBOMapping(S,A);let x=t.render.frame;r[S.id]!==x&&(u(S),r[S.id]=x)}function h(S){let y=d();S.__bindingPointIndex=y;let M=i.createBuffer(),A=S.__size,x=S.usage;return i.bindBuffer(i.UNIFORM_BUFFER,M),i.bufferData(i.UNIFORM_BUFFER,A,x),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,y,M),M}function d(){for(let S=0;S<a;S++)if(o.indexOf(S)===-1)return o.push(S),S;return Ot("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(S){let y=s[S.id],M=S.uniforms,A=S.__cache;i.bindBuffer(i.UNIFORM_BUFFER,y);for(let x=0,E=M.length;x<E;x++){let R=M[x];if(Array.isArray(R))for(let I=0,N=R.length;I<N;I++)f(R[I],x,I,A);else f(R,x,0,A)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(S,y,M,A){if(v(S,y,M,A)===!0){let x=S.__offset,E=S.value;if(Array.isArray(E)){let R=0;for(let I=0;I<E.length;I++){let N=E[I],X=p(N);m(N,S.__data,R),typeof N!="number"&&typeof N!="boolean"&&!N.isMatrix3&&!ArrayBuffer.isView(N)&&(R+=X.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(E,S.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,x,S.__data)}}function m(S,y,M){typeof S=="number"||typeof S=="boolean"?y[0]=S:S.isMatrix3?(y[0]=S.elements[0],y[1]=S.elements[1],y[2]=S.elements[2],y[3]=0,y[4]=S.elements[3],y[5]=S.elements[4],y[6]=S.elements[5],y[7]=0,y[8]=S.elements[6],y[9]=S.elements[7],y[10]=S.elements[8],y[11]=0):ArrayBuffer.isView(S)?y.set(new S.constructor(S.buffer,S.byteOffset,y.length)):S.toArray(y,M)}function v(S,y,M,A){let x=S.value,E=y+"_"+M;if(A[E]===void 0)return typeof x=="number"||typeof x=="boolean"?A[E]=x:ArrayBuffer.isView(x)?A[E]=x.slice():A[E]=x.clone(),!0;{let R=A[E];if(typeof x=="number"||typeof x=="boolean"){if(R!==x)return A[E]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(R.equals(x)===!1)return R.copy(x),!0}}return!1}function g(S){let y=S.uniforms,M=0,A=16;for(let E=0,R=y.length;E<R;E++){let I=Array.isArray(y[E])?y[E]:[y[E]];for(let N=0,X=I.length;N<X;N++){let Y=I[N],F=Array.isArray(Y.value)?Y.value:[Y.value];for(let B=0,V=F.length;B<V;B++){let $=F[B],tt=p($),it=M%A,at=it%tt.boundary,mt=it+at;M+=at,mt!==0&&A-mt<tt.storage&&(M+=A-mt),Y.__data=new Float32Array(tt.storage/Float32Array.BYTES_PER_ELEMENT),Y.__offset=M,M+=tt.storage}}}let x=M%A;return x>0&&(M+=A-x),S.__size=M,S.__cache={},this}function p(S){let y={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(y.boundary=4,y.storage=4):S.isVector2?(y.boundary=8,y.storage=8):S.isVector3||S.isColor?(y.boundary=16,y.storage=12):S.isVector4?(y.boundary=16,y.storage=16):S.isMatrix3?(y.boundary=48,y.storage=48):S.isMatrix4?(y.boundary=64,y.storage=64):S.isTexture?Ut("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(S)?(y.boundary=16,y.storage=S.byteLength):Ut("WebGLRenderer: Unsupported uniform value type.",S),y}function C(S){let y=S.target;y.removeEventListener("dispose",C);let M=o.indexOf(y.__bindingPointIndex);o.splice(M,1),i.deleteBuffer(s[y.id]),delete s[y.id],delete r[y.id]}function w(){for(let S in s)i.deleteBuffer(s[S]);o=[],s={},r={}}return{bind:l,update:c,dispose:w}}var mg=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),_n=null;function gg(){return _n===null&&(_n=new Er(mg,16,16,jn,xn),_n.name="DFG_LUT",_n.minFilter=Te,_n.magFilter=Te,_n.wrapS=dn,_n.wrapT=dn,_n.generateMipmaps=!1,_n.needsUpdate=!0),_n}var No=class{constructor(t={}){let{canvas:e=Ac(),context:n=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:u=!1,outputBufferType:f=ke}=t;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=o;let v=f,g=new Set([Zr,$r,qr]),p=new Set([ke,rn,$i,Zi,Xr,Yr]),C=new Uint32Array(4),w=new Int32Array(4),S=new D,y=null,M=null,A=[],x=[],E=null;this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=sn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let R=this,I=!1,N=null,X=null,Y=null,F=null;this._outputColorSpace=We;let B=0,V=0,$=null,tt=-1,it=null,at=new fe,mt=new fe,Jt=null,le=new Vt(0),Kt=0,Q=e.width,ot=e.height,nt=1,Bt=null,zt=null,Lt=new fe(0,0,Q,ot),re=new fe(0,0,Q,ot),Yt=!1,Wt=new Vi,Zt=!1,jt=!1,z=new de,J=new D,dt=new fe,Mt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},St=!1;function vt(){return $===null?nt:1}let P=n;function At(b,O){return e.getContext(b,O)}try{let b={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${"185"}`),e.addEventListener("webglcontextlost",pe,!1),e.addEventListener("webglcontextrestored",ce,!1),e.addEventListener("webglcontextcreationerror",ln,!1),P===null){let O="webgl2";if(P=At(O,b),P===null)throw At(O)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(b){throw Ot("WebGLRenderer: "+b.message),b}let Nt,T,_,L,k,q,st,rt,Z,K,ct,Ct,ft,ht,Dt,Ft,Ht,U,lt,j,ut,_t,et;function Tt(){Nt=new Sp(P),Nt.init(),ut=new cg(P,Nt),T=new mp(P,Nt,t,ut),_=new ag(P,Nt),T.reversedDepthBuffer&&u&&_.buffers.depth.setReversed(!0),X=P.createFramebuffer(),Y=P.createFramebuffer(),F=P.createFramebuffer(),L=new Tp(P),k=new qm,q=new lg(P,Nt,_,k,T,ut,L),st=new Mp(R),rt=new Ru(P),_t=new fp(P,rt),Z=new Ep(P,rt,L,_t),K=new Cp(P,Z,rt,_t,L),U=new Ap(P,T,q),Dt=new gp(k),ct=new Ym(R,st,Nt,T,_t,Dt),Ct=new fg(R,k),ft=new Zm,ht=new eg(Nt),Ht=new dp(R,st,_,K,m,l),Ft=new og(R,K,T),et=new pg(P,L,T,_),lt=new pp(P,Nt,L),j=new wp(P,Nt,L),L.programs=ct.programs,R.capabilities=T,R.extensions=Nt,R.properties=k,R.renderLists=ft,R.shadowMap=Ft,R.state=_,R.info=L}Tt(),v!==ke&&(E=new Ip(v,e.width,e.height,a,s,r));let Et=new ul(R,P);this.xr=Et,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){let b=Nt.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){let b=Nt.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return nt},this.setPixelRatio=function(b){b!==void 0&&(nt=b,this.setSize(Q,ot,!1))},this.getSize=function(b){return b.set(Q,ot)},this.setSize=function(b,O,W=!0){if(Et.isPresenting){Ut("WebGLRenderer: Can't change size while VR device is presenting.");return}Q=b,ot=O,e.width=Math.floor(b*nt),e.height=Math.floor(O*nt),W===!0&&(e.style.width=b+"px",e.style.height=O+"px"),E!==null&&E.setSize(e.width,e.height),this.setViewport(0,0,b,O)},this.getDrawingBufferSize=function(b){return b.set(Q*nt,ot*nt).floor()},this.setDrawingBufferSize=function(b,O,W){Q=b,ot=O,nt=W,e.width=Math.floor(b*W),e.height=Math.floor(O*W),this.setViewport(0,0,b,O)},this.setEffects=function(b){if(v===ke){Ot("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(b){for(let O=0;O<b.length;O++)if(b[O].isOutputPass===!0){Ut("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}E.setEffects(b||[])},this.getCurrentViewport=function(b){return b.copy(at)},this.getViewport=function(b){return b.copy(Lt)},this.setViewport=function(b,O,W,H){b.isVector4?Lt.set(b.x,b.y,b.z,b.w):Lt.set(b,O,W,H),_.viewport(at.copy(Lt).multiplyScalar(nt).round())},this.getScissor=function(b){return b.copy(re)},this.setScissor=function(b,O,W,H){b.isVector4?re.set(b.x,b.y,b.z,b.w):re.set(b,O,W,H),_.scissor(mt.copy(re).multiplyScalar(nt).round())},this.getScissorTest=function(){return Yt},this.setScissorTest=function(b){_.setScissorTest(Yt=b)},this.setOpaqueSort=function(b){Bt=b},this.setTransparentSort=function(b){zt=b},this.getClearColor=function(b){return b.copy(Ht.getClearColor())},this.setClearColor=function(){Ht.setClearColor(...arguments)},this.getClearAlpha=function(){return Ht.getClearAlpha()},this.setClearAlpha=function(){Ht.setClearAlpha(...arguments)},this.clear=function(b=!0,O=!0,W=!0){let H=0;if(b){let G=!1;if($!==null){let xt=$.texture.format;G=g.has(xt)}if(G){let xt=$.texture.type,bt=p.has(xt),gt=Ht.getClearColor(),wt=Ht.getClearAlpha(),Rt=gt.r,Gt=gt.g,qt=gt.b;bt?(C[0]=Rt,C[1]=Gt,C[2]=qt,C[3]=wt,P.clearBufferuiv(P.COLOR,0,C)):(w[0]=Rt,w[1]=Gt,w[2]=qt,w[3]=wt,P.clearBufferiv(P.COLOR,0,w))}else H|=P.COLOR_BUFFER_BIT}O&&(H|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),W&&(H|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H!==0&&P.clear(H)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(b){b.setRenderer(this),N=b},this.dispose=function(){e.removeEventListener("webglcontextlost",pe,!1),e.removeEventListener("webglcontextrestored",ce,!1),e.removeEventListener("webglcontextcreationerror",ln,!1),Ht.dispose(),ft.dispose(),ht.dispose(),k.dispose(),st.dispose(),K.dispose(),_t.dispose(),et.dispose(),ct.dispose(),Et.dispose(),Et.removeEventListener("sessionstart",_l),Et.removeEventListener("sessionend",vl),ei.stop()};function pe(b){b.preventDefault(),Xa("WebGLRenderer: Context Lost."),I=!0}function ce(){Xa("WebGLRenderer: Context Restored."),I=!1;let b=L.autoReset,O=Ft.enabled,W=Ft.autoUpdate,H=Ft.needsUpdate,G=Ft.type;Tt(),L.autoReset=b,Ft.enabled=O,Ft.autoUpdate=W,Ft.needsUpdate=H,Ft.type=G}function ln(b){Ot("WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function cn(b){let O=b.target;O.removeEventListener("dispose",cn),Ah(O)}function Ah(b){Ch(b),k.remove(b)}function Ch(b){let O=k.get(b).programs;O!==void 0&&(O.forEach(function(W){ct.releaseProgram(W)}),b.isShaderMaterial&&ct.releaseShaderCache(b))}this.renderBufferDirect=function(b,O,W,H,G,xt){O===null&&(O=Mt);let bt=G.isMesh&&G.matrixWorld.determinantAffine()<0,gt=Ph(b,O,W,H,G);_.setMaterial(H,bt);let wt=W.index,Rt=1;if(H.wireframe===!0){if(wt=Z.getWireframeAttribute(W),wt===void 0)return;Rt=2}let Gt=W.drawRange,qt=W.attributes.position,Pt=Gt.start*Rt,ie=(Gt.start+Gt.count)*Rt;xt!==null&&(Pt=Math.max(Pt,xt.start*Rt),ie=Math.min(ie,(xt.start+xt.count)*Rt)),wt!==null?(Pt=Math.max(Pt,0),ie=Math.min(ie,wt.count)):qt!=null&&(Pt=Math.max(Pt,0),ie=Math.min(ie,qt.count));let xe=ie-Pt;if(xe<0||xe===1/0)return;_t.setup(G,H,gt,W,wt);let me,oe=lt;if(wt!==null&&(me=rt.get(wt),oe=j,oe.setIndex(me)),G.isMesh)H.wireframe===!0?(_.setLineWidth(H.wireframeLinewidth*vt()),oe.setMode(P.LINES)):oe.setMode(P.TRIANGLES);else if(G.isLine){let Ce=H.linewidth;Ce===void 0&&(Ce=1),_.setLineWidth(Ce*vt()),G.isLineSegments?oe.setMode(P.LINES):G.isLineLoop?oe.setMode(P.LINE_LOOP):oe.setMode(P.LINE_STRIP)}else G.isPoints?oe.setMode(P.POINTS):G.isSprite&&oe.setMode(P.TRIANGLES);if(G.isBatchedMesh)if(Nt.get("WEBGL_multi_draw"))oe.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{let Ce=G._multiDrawStarts,yt=G._multiDrawCounts,Ve=G._multiDrawCount,ee=wt?rt.get(wt).bytesPerElement:1,qe=k.get(H).currentProgram.getUniforms();for(let hn=0;hn<Ve;hn++)qe.setValue(P,"_gl_DrawID",hn),oe.render(Ce[hn]/ee,yt[hn])}else if(G.isInstancedMesh)oe.renderInstances(Pt,xe,G.count);else if(W.isInstancedBufferGeometry){let Ce=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,yt=Math.min(W.instanceCount,Ce);oe.renderInstances(Pt,xe,yt)}else oe.render(Pt,xe)};function xl(b,O,W){b.transparent===!0&&b.side===Fe&&b.forceSinglePass===!1?(b.side=Ae,b.needsUpdate=!0,ks(b,O,W),b.side=An,b.needsUpdate=!0,ks(b,O,W),b.side=Fe):ks(b,O,W)}this.compile=function(b,O,W=null){W===null&&(W=b),M=ht.get(W),M.init(O),x.push(M),W.traverseVisible(function(G){G.isLight&&G.layers.test(O.layers)&&(M.pushLight(G),G.castShadow&&M.pushShadow(G))}),b!==W&&b.traverseVisible(function(G){G.isLight&&G.layers.test(O.layers)&&(M.pushLight(G),G.castShadow&&M.pushShadow(G))}),M.setupLights();let H=new Set;return b.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;let xt=G.material;if(xt)if(Array.isArray(xt))for(let bt=0;bt<xt.length;bt++){let gt=xt[bt];xl(gt,W,G),H.add(gt)}else xl(xt,W,G),H.add(xt)}),M=x.pop(),H},this.compileAsync=function(b,O,W=null){let H=this.compile(b,O,W);return new Promise(G=>{function xt(){if(H.forEach(function(bt){k.get(bt).currentProgram.isReady()&&H.delete(bt)}),H.size===0){G(b);return}setTimeout(xt,10)}Nt.get("KHR_parallel_shader_compile")!==null?xt():setTimeout(xt,10)})};let ko=null;function Rh(b){ko&&ko(b)}function _l(){ei.stop()}function vl(){ei.start()}let ei=new nh;ei.setAnimationLoop(Rh),typeof self<"u"&&ei.setContext(self),this.setAnimationLoop=function(b){ko=b,Et.setAnimationLoop(b),b===null?ei.stop():ei.start()},Et.addEventListener("sessionstart",_l),Et.addEventListener("sessionend",vl),this.render=function(b,O){if(O!==void 0&&O.isCamera!==!0){Ot("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;N!==null&&N.renderStart(b,O);let W=Et.enabled===!0&&Et.isPresenting===!0,H=E!==null&&($===null||W)&&E.begin(R,$);if(b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),Et.enabled===!0&&Et.isPresenting===!0&&(E===null||E.isCompositing()===!1)&&(Et.cameraAutoUpdate===!0&&Et.updateCamera(O),O=Et.getCamera()),b.isScene===!0&&b.onBeforeRender(R,b,O,$),M=ht.get(b,x.length),M.init(O),M.state.textureUnits=q.getTextureUnits(),x.push(M),z.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),Wt.setFromProjectionMatrix(z,en,O.reversedDepth),jt=this.localClippingEnabled,Zt=Dt.init(this.clippingPlanes,jt),y=ft.get(b,A.length),y.init(),A.push(y),Et.enabled===!0&&Et.isPresenting===!0){let bt=R.xr.getDepthSensingMesh();bt!==null&&Vo(bt,O,-1/0,R.sortObjects)}Vo(b,O,0,R.sortObjects),y.finish(),R.sortObjects===!0&&y.sort(Bt,zt,O.reversedDepth),St=Et.enabled===!1||Et.isPresenting===!1||Et.hasDepthSensing()===!1,St&&Ht.addToRenderList(y,b),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Zt===!0&&Dt.beginShadows();let G=M.state.shadowsArray;if(Ft.render(G,b,O),Zt===!0&&Dt.endShadows(),(H&&E.hasRenderPass())===!1){let bt=y.opaque,gt=y.transmissive;if(M.setupLights(),O.isArrayCamera){let wt=O.cameras;if(gt.length>0)for(let Rt=0,Gt=wt.length;Rt<Gt;Rt++){let qt=wt[Rt];bl(bt,gt,b,qt)}St&&Ht.render(b);for(let Rt=0,Gt=wt.length;Rt<Gt;Rt++){let qt=wt[Rt];yl(y,b,qt,qt.viewport)}}else gt.length>0&&bl(bt,gt,b,O),St&&Ht.render(b),yl(y,b,O)}$!==null&&V===0&&(q.updateMultisampleRenderTarget($),q.updateRenderTargetMipmap($)),H&&E.end(R),b.isScene===!0&&b.onAfterRender(R,b,O),_t.resetDefaultState(),tt=-1,it=null,x.pop(),x.length>0?(M=x[x.length-1],q.setTextureUnits(M.state.textureUnits),Zt===!0&&Dt.setGlobalState(R.clippingPlanes,M.state.camera)):M=null,A.pop(),A.length>0?y=A[A.length-1]:y=null,N!==null&&N.renderEnd()};function Vo(b,O,W,H){if(b.visible===!1)return;if(b.layers.test(O.layers)){if(b.isGroup)W=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(O);else if(b.isLightProbeGrid)M.pushLightProbeGrid(b);else if(b.isLight)M.pushLight(b),b.castShadow&&M.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||Wt.intersectsSprite(b)){H&&dt.setFromMatrixPosition(b.matrixWorld).applyMatrix4(z);let bt=K.update(b),gt=b.material;gt.visible&&y.push(b,bt,gt,W,dt.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||Wt.intersectsObject(b))){let bt=K.update(b),gt=b.material;if(H&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),dt.copy(b.boundingSphere.center)):(bt.boundingSphere===null&&bt.computeBoundingSphere(),dt.copy(bt.boundingSphere.center)),dt.applyMatrix4(b.matrixWorld).applyMatrix4(z)),Array.isArray(gt)){let wt=bt.groups;for(let Rt=0,Gt=wt.length;Rt<Gt;Rt++){let qt=wt[Rt],Pt=gt[qt.materialIndex];Pt&&Pt.visible&&y.push(b,bt,Pt,W,dt.z,qt)}}else gt.visible&&y.push(b,bt,gt,W,dt.z,null)}}let xt=b.children;for(let bt=0,gt=xt.length;bt<gt;bt++)Vo(xt[bt],O,W,H)}function yl(b,O,W,H){let{opaque:G,transmissive:xt,transparent:bt}=b;M.setupLightsView(W),Zt===!0&&Dt.setGlobalState(R.clippingPlanes,W),H&&_.viewport(at.copy(H)),G.length>0&&zs(G,O,W),xt.length>0&&zs(xt,O,W),bt.length>0&&zs(bt,O,W),_.buffers.depth.setTest(!0),_.buffers.depth.setMask(!0),_.buffers.color.setMask(!0),_.setPolygonOffset(!1)}function bl(b,O,W,H){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;if(M.state.transmissionRenderTarget[H.id]===void 0){let Pt=Nt.has("EXT_color_buffer_half_float")||Nt.has("EXT_color_buffer_float");M.state.transmissionRenderTarget[H.id]=new Xe(1,1,{generateMipmaps:!0,type:Pt?xn:ke,minFilter:Jn,samples:Math.max(4,T.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Qt.workingColorSpace})}let xt=M.state.transmissionRenderTarget[H.id],bt=H.viewport||at;xt.setSize(bt.z*R.transmissionResolutionScale,bt.w*R.transmissionResolutionScale);let gt=R.getRenderTarget(),wt=R.getActiveCubeFace(),Rt=R.getActiveMipmapLevel();R.setRenderTarget(xt),R.getClearColor(le),Kt=R.getClearAlpha(),Kt<1&&R.setClearColor(16777215,.5),R.clear(),St&&Ht.render(W);let Gt=R.toneMapping;R.toneMapping=sn;let qt=H.viewport;if(H.viewport!==void 0&&(H.viewport=void 0),M.setupLightsView(H),Zt===!0&&Dt.setGlobalState(R.clippingPlanes,H),zs(b,W,H),q.updateMultisampleRenderTarget(xt),q.updateRenderTargetMipmap(xt),Nt.has("WEBGL_multisampled_render_to_texture")===!1){let Pt=!1;for(let ie=0,xe=O.length;ie<xe;ie++){let me=O[ie],{object:oe,geometry:Ce,material:yt,group:Ve}=me;if(yt.side===Fe&&oe.layers.test(H.layers)){let ee=yt.side;yt.side=Ae,yt.needsUpdate=!0,Ml(oe,W,H,Ce,yt,Ve),yt.side=ee,yt.needsUpdate=!0,Pt=!0}}Pt===!0&&(q.updateMultisampleRenderTarget(xt),q.updateRenderTargetMipmap(xt))}R.setRenderTarget(gt,wt,Rt),R.setClearColor(le,Kt),qt!==void 0&&(H.viewport=qt),R.toneMapping=Gt}function zs(b,O,W){let H=O.isScene===!0?O.overrideMaterial:null;for(let G=0,xt=b.length;G<xt;G++){let bt=b[G],{object:gt,geometry:wt,group:Rt}=bt,Gt=bt.material;Gt.allowOverride===!0&&H!==null&&(Gt=H),gt.layers.test(W.layers)&&Ml(gt,O,W,wt,Gt,Rt)}}function Ml(b,O,W,H,G,xt){b.onBeforeRender(R,O,W,H,G,xt),b.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),G.onBeforeRender(R,O,W,H,b,xt),G.transparent===!0&&G.side===Fe&&G.forceSinglePass===!1?(G.side=Ae,G.needsUpdate=!0,R.renderBufferDirect(W,O,H,G,b,xt),G.side=An,G.needsUpdate=!0,R.renderBufferDirect(W,O,H,G,b,xt),G.side=Fe):R.renderBufferDirect(W,O,H,G,b,xt),b.onAfterRender(R,O,W,H,G,xt)}function ks(b,O,W){O.isScene!==!0&&(O=Mt);let H=k.get(b),G=M.state.lights,xt=M.state.shadowsArray,bt=G.state.version,gt=ct.getParameters(b,G.state,xt,O,W,M.state.lightProbeGridArray),wt=ct.getProgramCacheKey(gt),Rt=H.programs;H.environment=b.isMeshStandardMaterial||b.isMeshLambertMaterial||b.isMeshPhongMaterial?O.environment:null,H.fog=O.fog;let Gt=b.isMeshStandardMaterial||b.isMeshLambertMaterial&&!b.envMap||b.isMeshPhongMaterial&&!b.envMap;H.envMap=st.get(b.envMap||H.environment,Gt),H.envMapRotation=H.environment!==null&&b.envMap===null?O.environmentRotation:b.envMapRotation,Rt===void 0&&(b.addEventListener("dispose",cn),Rt=new Map,H.programs=Rt);let qt=Rt.get(wt);if(qt!==void 0){if(H.currentProgram===qt&&H.lightsStateVersion===bt)return El(b,gt),qt}else gt.uniforms=ct.getUniforms(b),N!==null&&b.isNodeMaterial&&N.build(b,W,gt),b.onBeforeCompile(gt,R),qt=ct.acquireProgram(gt,wt),Rt.set(wt,qt),H.uniforms=gt.uniforms;let Pt=H.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(Pt.clippingPlanes=Dt.uniform),El(b,gt),H.needsLights=Dh(b),H.lightsStateVersion=bt,H.needsLights&&(Pt.ambientLightColor.value=G.state.ambient,Pt.lightProbe.value=G.state.probe,Pt.directionalLights.value=G.state.directional,Pt.directionalLightShadows.value=G.state.directionalShadow,Pt.spotLights.value=G.state.spot,Pt.spotLightShadows.value=G.state.spotShadow,Pt.rectAreaLights.value=G.state.rectArea,Pt.ltc_1.value=G.state.rectAreaLTC1,Pt.ltc_2.value=G.state.rectAreaLTC2,Pt.pointLights.value=G.state.point,Pt.pointLightShadows.value=G.state.pointShadow,Pt.hemisphereLights.value=G.state.hemi,Pt.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Pt.spotLightMatrix.value=G.state.spotLightMatrix,Pt.spotLightMap.value=G.state.spotLightMap,Pt.pointShadowMatrix.value=G.state.pointShadowMatrix),H.lightProbeGrid=M.state.lightProbeGridArray.length>0,H.currentProgram=qt,H.uniformsList=null,qt}function Sl(b){if(b.uniformsList===null){let O=b.currentProgram.getUniforms();b.uniformsList=ji.seqWithValue(O.seq,b.uniforms)}return b.uniformsList}function El(b,O){let W=k.get(b);W.outputColorSpace=O.outputColorSpace,W.batching=O.batching,W.batchingColor=O.batchingColor,W.instancing=O.instancing,W.instancingColor=O.instancingColor,W.instancingMorph=O.instancingMorph,W.skinning=O.skinning,W.morphTargets=O.morphTargets,W.morphNormals=O.morphNormals,W.morphColors=O.morphColors,W.morphTargetsCount=O.morphTargetsCount,W.numClippingPlanes=O.numClippingPlanes,W.numIntersection=O.numClipIntersection,W.vertexAlphas=O.vertexAlphas,W.vertexTangents=O.vertexTangents,W.toneMapping=O.toneMapping}function Ih(b,O){if(b.length===0)return null;if(b.length===1)return b[0].texture!==null?b[0]:null;S.setFromMatrixPosition(O.matrixWorld);for(let W=0,H=b.length;W<H;W++){let G=b[W];if(G.texture!==null&&G.boundingBox.containsPoint(S))return G}return null}function Ph(b,O,W,H,G){O.isScene!==!0&&(O=Mt),q.resetTextureUnits();let xt=O.fog,bt=H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial?O.environment:null,gt=$===null?R.outputColorSpace:$.isXRRenderTarget===!0?$.texture.colorSpace:Qt.workingColorSpace,wt=H.isMeshStandardMaterial||H.isMeshLambertMaterial&&!H.envMap||H.isMeshPhongMaterial&&!H.envMap,Rt=st.get(H.envMap||bt,wt),Gt=H.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,qt=!!W.attributes.tangent&&(!!H.normalMap||H.anisotropy>0),Pt=!!W.morphAttributes.position,ie=!!W.morphAttributes.normal,xe=!!W.morphAttributes.color,me=sn;H.toneMapped&&($===null||$.isXRRenderTarget===!0)&&(me=R.toneMapping);let oe=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,Ce=oe!==void 0?oe.length:0,yt=k.get(H),Ve=M.state.lights;if(Zt===!0&&(jt===!0||b!==it)){let he=b===it&&H.id===tt;Dt.setState(H,b,he)}let ee=!1;H.version===yt.__version?(yt.needsLights&&yt.lightsStateVersion!==Ve.state.version||yt.outputColorSpace!==gt||G.isBatchedMesh&&yt.batching===!1||!G.isBatchedMesh&&yt.batching===!0||G.isBatchedMesh&&yt.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&yt.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&yt.instancing===!1||!G.isInstancedMesh&&yt.instancing===!0||G.isSkinnedMesh&&yt.skinning===!1||!G.isSkinnedMesh&&yt.skinning===!0||G.isInstancedMesh&&yt.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&yt.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&yt.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&yt.instancingMorph===!1&&G.morphTexture!==null||yt.envMap!==Rt||H.fog===!0&&yt.fog!==xt||yt.numClippingPlanes!==void 0&&(yt.numClippingPlanes!==Dt.numPlanes||yt.numIntersection!==Dt.numIntersection)||yt.vertexAlphas!==Gt||yt.vertexTangents!==qt||yt.morphTargets!==Pt||yt.morphNormals!==ie||yt.morphColors!==xe||yt.toneMapping!==me||yt.morphTargetsCount!==Ce||!!yt.lightProbeGrid!=M.state.lightProbeGridArray.length>0)&&(ee=!0):(ee=!0,yt.__version=H.version);let qe=yt.currentProgram;ee===!0&&(qe=ks(H,O,G),N&&H.isNodeMaterial&&N.onUpdateProgram(H,qe,yt));let hn=!1,Dn=!1,_i=!1,ae=qe.getUniforms(),_e=yt.uniforms;if(_.useProgram(qe.program)&&(hn=!0,Dn=!0,_i=!0),H.id!==tt&&(tt=H.id,Dn=!0),yt.needsLights){let he=Ih(M.state.lightProbeGridArray,G);yt.lightProbeGrid!==he&&(yt.lightProbeGrid=he,Dn=!0)}if(hn||it!==b){_.buffers.depth.getReversed()&&b.reversedDepth!==!0&&(b._reversedDepth=!0,b.updateProjectionMatrix()),ae.setValue(P,"projectionMatrix",b.projectionMatrix),ae.setValue(P,"viewMatrix",b.matrixWorldInverse);let Un=ae.map.cameraPosition;Un!==void 0&&Un.setValue(P,J.setFromMatrixPosition(b.matrixWorld)),T.logarithmicDepthBuffer&&ae.setValue(P,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(H.isMeshPhongMaterial||H.isMeshToonMaterial||H.isMeshLambertMaterial||H.isMeshBasicMaterial||H.isMeshStandardMaterial||H.isShaderMaterial)&&ae.setValue(P,"isOrthographic",b.isOrthographicCamera===!0),it!==b&&(it=b,Dn=!0,_i=!0)}if(yt.needsLights&&(Ve.state.directionalShadowMap.length>0&&ae.setValue(P,"directionalShadowMap",Ve.state.directionalShadowMap,q),Ve.state.spotShadowMap.length>0&&ae.setValue(P,"spotShadowMap",Ve.state.spotShadowMap,q),Ve.state.pointShadowMap.length>0&&ae.setValue(P,"pointShadowMap",Ve.state.pointShadowMap,q)),G.isSkinnedMesh){ae.setOptional(P,G,"bindMatrix"),ae.setOptional(P,G,"bindMatrixInverse");let he=G.skeleton;he&&(he.boneTexture===null&&he.computeBoneTexture(),ae.setValue(P,"boneTexture",he.boneTexture,q))}G.isBatchedMesh&&(ae.setOptional(P,G,"batchingTexture"),ae.setValue(P,"batchingTexture",G._matricesTexture,q),ae.setOptional(P,G,"batchingIdTexture"),ae.setValue(P,"batchingIdTexture",G._indirectTexture,q),ae.setOptional(P,G,"batchingColorTexture"),G._colorsTexture!==null&&ae.setValue(P,"batchingColorTexture",G._colorsTexture,q));let Nn=W.morphAttributes;if((Nn.position!==void 0||Nn.normal!==void 0||Nn.color!==void 0)&&U.update(G,W,qe),(Dn||yt.receiveShadow!==G.receiveShadow)&&(yt.receiveShadow=G.receiveShadow,ae.setValue(P,"receiveShadow",G.receiveShadow)),(H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial)&&H.envMap===null&&O.environment!==null&&(_e.envMapIntensity.value=O.environmentIntensity),_e.dfgLUT!==void 0&&(_e.dfgLUT.value=gg()),Dn){if(ae.setValue(P,"toneMappingExposure",R.toneMappingExposure),yt.needsLights&&Lh(_e,_i),xt&&H.fog===!0&&Ct.refreshFogUniforms(_e,xt),Ct.refreshMaterialUniforms(_e,H,nt,ot,M.state.transmissionRenderTarget[b.id]),yt.needsLights&&yt.lightProbeGrid){let he=yt.lightProbeGrid;_e.probesSH.value=he.texture,_e.probesMin.value.copy(he.boundingBox.min),_e.probesMax.value.copy(he.boundingBox.max),_e.probesResolution.value.copy(he.resolution)}ji.upload(P,Sl(yt),_e,q)}if(H.isShaderMaterial&&H.uniformsNeedUpdate===!0&&(ji.upload(P,Sl(yt),_e,q),H.uniformsNeedUpdate=!1),H.isSpriteMaterial&&ae.setValue(P,"center",G.center),ae.setValue(P,"modelViewMatrix",G.modelViewMatrix),ae.setValue(P,"normalMatrix",G.normalMatrix),ae.setValue(P,"modelMatrix",G.matrixWorld),H.uniformsGroups!==void 0){let he=H.uniformsGroups;for(let Un=0,vi=he.length;Un<vi;Un++){let wl=he[Un];et.update(wl,qe),et.bind(wl,qe)}}return qe}function Lh(b,O){b.ambientLightColor.needsUpdate=O,b.lightProbe.needsUpdate=O,b.directionalLights.needsUpdate=O,b.directionalLightShadows.needsUpdate=O,b.pointLights.needsUpdate=O,b.pointLightShadows.needsUpdate=O,b.spotLights.needsUpdate=O,b.spotLightShadows.needsUpdate=O,b.rectAreaLights.needsUpdate=O,b.hemisphereLights.needsUpdate=O}function Dh(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return B},this.getActiveMipmapLevel=function(){return V},this.getRenderTarget=function(){return $},this.setRenderTargetTextures=function(b,O,W){let H=k.get(b);H.__autoAllocateDepthBuffer=b.resolveDepthBuffer===!1,H.__autoAllocateDepthBuffer===!1&&(H.__useRenderToTexture=!1),k.get(b.texture).__webglTexture=O,k.get(b.depthTexture).__webglTexture=H.__autoAllocateDepthBuffer?void 0:W,H.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(b,O){let W=k.get(b);W.__webglFramebuffer=O,W.__useDefaultFramebuffer=O===void 0},this.setRenderTarget=function(b,O=0,W=0){$=b,B=O,V=W;let H=null,G=!1,xt=!1;if(b){let gt=k.get(b);if(gt.__useDefaultFramebuffer!==void 0){_.bindFramebuffer(P.FRAMEBUFFER,gt.__webglFramebuffer),at.copy(b.viewport),mt.copy(b.scissor),Jt=b.scissorTest,_.viewport(at),_.scissor(mt),_.setScissorTest(Jt),tt=-1;return}else if(gt.__webglFramebuffer===void 0)q.setupRenderTarget(b);else if(gt.__hasExternalTextures)q.rebindTextures(b,k.get(b.texture).__webglTexture,k.get(b.depthTexture).__webglTexture);else if(b.depthBuffer){let Gt=b.depthTexture;if(gt.__boundDepthTexture!==Gt){if(Gt!==null&&k.has(Gt)&&(b.width!==Gt.image.width||b.height!==Gt.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");q.setupDepthRenderbuffer(b)}}let wt=b.texture;(wt.isData3DTexture||wt.isDataArrayTexture||wt.isCompressedArrayTexture)&&(xt=!0);let Rt=k.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(Rt[O])?H=Rt[O][W]:H=Rt[O],G=!0):b.samples>0&&q.useMultisampledRTT(b)===!1?H=k.get(b).__webglMultisampledFramebuffer:Array.isArray(Rt)?H=Rt[W]:H=Rt,at.copy(b.viewport),mt.copy(b.scissor),Jt=b.scissorTest}else at.copy(Lt).multiplyScalar(nt).floor(),mt.copy(re).multiplyScalar(nt).floor(),Jt=Yt;if(W!==0&&(H=X),_.bindFramebuffer(P.FRAMEBUFFER,H)&&_.drawBuffers(b,H),_.viewport(at),_.scissor(mt),_.setScissorTest(Jt),G){let gt=k.get(b.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+O,gt.__webglTexture,W)}else if(xt){let gt=O;for(let wt=0;wt<b.textures.length;wt++){let Rt=k.get(b.textures[wt]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+wt,Rt.__webglTexture,W,gt)}}else if(b!==null&&W!==0){let gt=k.get(b.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,gt.__webglTexture,W)}tt=-1},this.readRenderTargetPixels=function(b,O,W,H,G,xt,bt,gt=0){if(!(b&&b.isWebGLRenderTarget)){Ot("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let wt=k.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&bt!==void 0&&(wt=wt[bt]),wt){_.bindFramebuffer(P.FRAMEBUFFER,wt);try{let Rt=b.textures[gt],Gt=Rt.format,qt=Rt.type;if(b.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+gt),!T.textureFormatReadable(Gt)){Ot("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!T.textureTypeReadable(qt)){Ot("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=b.width-H&&W>=0&&W<=b.height-G&&P.readPixels(O,W,H,G,ut.convert(Gt),ut.convert(qt),xt)}finally{let Rt=$!==null?k.get($).__webglFramebuffer:null;_.bindFramebuffer(P.FRAMEBUFFER,Rt)}}},this.readRenderTargetPixelsAsync=async function(b,O,W,H,G,xt,bt,gt=0){if(!(b&&b.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let wt=k.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&bt!==void 0&&(wt=wt[bt]),wt)if(O>=0&&O<=b.width-H&&W>=0&&W<=b.height-G){_.bindFramebuffer(P.FRAMEBUFFER,wt);let Rt=b.textures[gt],Gt=Rt.format,qt=Rt.type;if(b.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+gt),!T.textureFormatReadable(Gt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!T.textureTypeReadable(qt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Pt=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,Pt),P.bufferData(P.PIXEL_PACK_BUFFER,xt.byteLength,P.STREAM_READ),P.readPixels(O,W,H,G,ut.convert(Gt),ut.convert(qt),0);let ie=$!==null?k.get($).__webglFramebuffer:null;_.bindFramebuffer(P.FRAMEBUFFER,ie);let xe=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await Rc(P,xe,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,Pt),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,xt),P.deleteBuffer(Pt),P.deleteSync(xe),xt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(b,O=null,W=0){let H=Math.pow(2,-W),G=Math.floor(b.image.width*H),xt=Math.floor(b.image.height*H),bt=O!==null?O.x:0,gt=O!==null?O.y:0;q.setTexture2D(b,0),P.copyTexSubImage2D(P.TEXTURE_2D,W,0,0,bt,gt,G,xt),_.unbindTexture()},this.copyTextureToTexture=function(b,O,W=null,H=null,G=0,xt=0){let bt,gt,wt,Rt,Gt,qt,Pt,ie,xe,me=b.isCompressedTexture?b.mipmaps[xt]:b.image;if(W!==null)bt=W.max.x-W.min.x,gt=W.max.y-W.min.y,wt=W.isBox3?W.max.z-W.min.z:1,Rt=W.min.x,Gt=W.min.y,qt=W.isBox3?W.min.z:0;else{let _e=Math.pow(2,-G);bt=Math.floor(me.width*_e),gt=Math.floor(me.height*_e),b.isDataArrayTexture?wt=me.depth:b.isData3DTexture?wt=Math.floor(me.depth*_e):wt=1,Rt=0,Gt=0,qt=0}H!==null?(Pt=H.x,ie=H.y,xe=H.z):(Pt=0,ie=0,xe=0);let oe=ut.convert(O.format),Ce=ut.convert(O.type),yt;O.isData3DTexture?(q.setTexture3D(O,0),yt=P.TEXTURE_3D):O.isDataArrayTexture||O.isCompressedArrayTexture?(q.setTexture2DArray(O,0),yt=P.TEXTURE_2D_ARRAY):(q.setTexture2D(O,0),yt=P.TEXTURE_2D),_.activeTexture(P.TEXTURE0),_.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,O.flipY),_.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),_.pixelStorei(P.UNPACK_ALIGNMENT,O.unpackAlignment);let Ve=_.getParameter(P.UNPACK_ROW_LENGTH),ee=_.getParameter(P.UNPACK_IMAGE_HEIGHT),qe=_.getParameter(P.UNPACK_SKIP_PIXELS),hn=_.getParameter(P.UNPACK_SKIP_ROWS),Dn=_.getParameter(P.UNPACK_SKIP_IMAGES);_.pixelStorei(P.UNPACK_ROW_LENGTH,me.width),_.pixelStorei(P.UNPACK_IMAGE_HEIGHT,me.height),_.pixelStorei(P.UNPACK_SKIP_PIXELS,Rt),_.pixelStorei(P.UNPACK_SKIP_ROWS,Gt),_.pixelStorei(P.UNPACK_SKIP_IMAGES,qt);let _i=b.isDataArrayTexture||b.isData3DTexture,ae=O.isDataArrayTexture||O.isData3DTexture;if(b.isDepthTexture){let _e=k.get(b),Nn=k.get(O),he=k.get(_e.__renderTarget),Un=k.get(Nn.__renderTarget);_.bindFramebuffer(P.READ_FRAMEBUFFER,he.__webglFramebuffer),_.bindFramebuffer(P.DRAW_FRAMEBUFFER,Un.__webglFramebuffer);for(let vi=0;vi<wt;vi++)_i&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,k.get(b).__webglTexture,G,qt+vi),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,k.get(O).__webglTexture,xt,xe+vi)),P.blitFramebuffer(Rt,Gt,bt,gt,Pt,ie,bt,gt,P.DEPTH_BUFFER_BIT,P.NEAREST);_.bindFramebuffer(P.READ_FRAMEBUFFER,null),_.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(G!==0||b.isRenderTargetTexture||k.has(b)){let _e=k.get(b),Nn=k.get(O);_.bindFramebuffer(P.READ_FRAMEBUFFER,Y),_.bindFramebuffer(P.DRAW_FRAMEBUFFER,F);for(let he=0;he<wt;he++)_i?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,_e.__webglTexture,G,qt+he):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,_e.__webglTexture,G),ae?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Nn.__webglTexture,xt,xe+he):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Nn.__webglTexture,xt),G!==0?P.blitFramebuffer(Rt,Gt,bt,gt,Pt,ie,bt,gt,P.COLOR_BUFFER_BIT,P.NEAREST):ae?P.copyTexSubImage3D(yt,xt,Pt,ie,xe+he,Rt,Gt,bt,gt):P.copyTexSubImage2D(yt,xt,Pt,ie,Rt,Gt,bt,gt);_.bindFramebuffer(P.READ_FRAMEBUFFER,null),_.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else ae?b.isDataTexture||b.isData3DTexture?P.texSubImage3D(yt,xt,Pt,ie,xe,bt,gt,wt,oe,Ce,me.data):O.isCompressedArrayTexture?P.compressedTexSubImage3D(yt,xt,Pt,ie,xe,bt,gt,wt,oe,me.data):P.texSubImage3D(yt,xt,Pt,ie,xe,bt,gt,wt,oe,Ce,me):b.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,xt,Pt,ie,bt,gt,oe,Ce,me.data):b.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,xt,Pt,ie,me.width,me.height,oe,me.data):P.texSubImage2D(P.TEXTURE_2D,xt,Pt,ie,bt,gt,oe,Ce,me);_.pixelStorei(P.UNPACK_ROW_LENGTH,Ve),_.pixelStorei(P.UNPACK_IMAGE_HEIGHT,ee),_.pixelStorei(P.UNPACK_SKIP_PIXELS,qe),_.pixelStorei(P.UNPACK_SKIP_ROWS,hn),_.pixelStorei(P.UNPACK_SKIP_IMAGES,Dn),xt===0&&O.generateMipmaps&&P.generateMipmap(yt),_.unbindTexture()},this.initRenderTarget=function(b){k.get(b).__webglFramebuffer===void 0&&q.setupRenderTarget(b)},this.initTexture=function(b){b.isCubeTexture?q.setTextureCube(b,0):b.isData3DTexture?q.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?q.setTexture2DArray(b,0):q.setTexture2D(b,0),_.unbindTexture()},this.resetState=function(){B=0,V=0,$=null,_.reset(),_t.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return en}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorSpace=Qt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Qt._getUnpackColorSpace()}};var _g=1-Math.pow(.001,.0033333333333333335),dl=.6,vg=.25,yg=.25,Oo={x:0,y:0,z:0,r:120},fl=class{state=7;next(){return this.state=(this.state*1664525+1013904223)%4294967296,this.state/4294967296}jiggle(){return(this.next()-.5)*1e-6}};function bg(i,t,e){let s=new Float64Array(721),r=t,o=0;for(let h=1;h<=720;h++){let d=h/720*Math.PI*2,u=Math.cos(d)*t,f=Math.sin(d)*e;s[h]=(s[h-1]??0)+Math.hypot(u-r,f-o),r=u,o=f}let a=s[720]??1,l=[],c=0;for(let h=0;h<i;h++){let d=(h/i+.75)%1*a;for(c=0;c<720&&(s[c+1]??a)<d;)c++;l.push(c/720*Math.PI*2)}return l}function pi(i){return 30*Math.sqrt(Math.max(1,i))+34}function pl(i,t,e){let n=[...i.entries()],s=new Map;if(n.length===0)return s;let r=0;if(e!==void 0&&i.has(e)&&n.length>1&&(r=pi(i.get(e)??1),s.set(e,{x:0,y:0,z:0,r}),n=n.filter(([d])=>d!==e)),n.length===1){let d=n[0];if(d){let u=r>0?r+pi(d[1]):0;s.set(d[0],{x:u,y:0,z:0,r:pi(d[1])})}return s}let o=n.length,a=Math.pow(Math.max(.7,Math.min(2.2,t)),.85),c=bg(o,a,1/a).map((d,u)=>({x:Math.cos(d)*a,y:u%2===0?.26:-.26,z:Math.sin(d)/a})),h=0;for(let d=0;d<o;d++)for(let u=d+1;u<o;u++){let f=c[d],m=c[u],v=n[d],g=n[u];if(!f||!m||!v||!g)continue;let p=Math.hypot(f.x-m.x,f.y-m.y,f.z-m.z);p<=0||(h=Math.max(h,(pi(v[1])+pi(g[1]))/p))}return h*=1.18,r>0&&n.forEach(([,d],u)=>{let f=c[u];if(!f)return;let m=Math.hypot(f.x,f.y,f.z);m<=0||(h=Math.max(h,(r+pi(d))*1.12/m))}),n.forEach(([d,u],f)=>{let m=c[f]??{x:0,y:0,z:0};s.set(d,{x:m.x*h,y:m.y*h,z:m.z*h,r:pi(u)})}),s}var Mg=Math.PI*(3-Math.sqrt(5));function ch(i){return i.x!==void 0&&i.y!==void 0&&i.z!==void 0}function Sg(i,t,e){let n=new Map,s=0;for(let a of i)ch(a)||(n.set(a.group,(n.get(a.group)??0)+1),s+=1);let r=new Map,o=0;return i.map(a=>{if(ch(a))return{id:a.id,group:a.group,radius:a.radius,x:a.x,y:a.y,z:a.z,vx:0,vy:0,vz:0,fx:null,fy:null,fz:null};let l=r.get(a.group)??0;r.set(a.group,l+1);let c=t==="grouped"?l:o++,h=(t==="grouped"?n.get(a.group):s)??1,d=t==="grouped"?e.get(a.group)??Oo:Oo,u=9*Math.sqrt(c+.5),f=c*Mg,m=1-2*(c+.5)/h,v=Math.sqrt(Math.max(0,1-m*m));return{id:a.id,group:a.group,radius:a.radius,x:d.x+u*v*Math.cos(f),y:d.y+u*m,z:d.z+u*v*Math.sin(f),vx:0,vy:0,vz:0,fx:null,fy:null,fz:null}})}function Eg(i,t,e){let n=[],s=new Map;for(let o of i)!t.has(o.source)||!t.has(o.target)||(n.push(o),s.set(o.source,(s.get(o.source)??0)+1),s.set(o.target,(s.get(o.target)??0)+1));let r=[];for(let o of n){let a=t.get(o.source),l=t.get(o.target);if(!a||!l)continue;let c=a.group===l.group,h=e==="grouped"?c?62:190:76,d=e==="grouped"?c?.5:.015:.6,u=s.get(o.source)??0,f=s.get(o.target)??0;r.push({source:a,target:l,distance:h,strength:d,bias:u/(u+f)})}return r}var Fs=class{nodes;nodesById;links;layout;centres;rng=new fl;simAlpha=1;simAlphaTarget=0;constructor(t){this.layout=t.layout,this.centres=t.centres,this.nodes=Sg(t.nodes,t.layout,t.centres),this.nodesById=new Map(this.nodes.map(e=>[e.id,e])),this.links=Eg(t.links,this.nodesById,t.layout)}byId(t){return this.nodesById.get(t)}alpha(){return this.simAlpha}reheat(){this.simAlphaTarget=vg,this.simAlpha=Math.max(this.simAlpha,yg)}cool(){this.simAlphaTarget=0}pin(t,e,n,s){let r=this.nodesById.get(t);r&&(r.fx=e,r.fy=n,r.fz=s)}unpin(t){let e=this.nodesById.get(t);e&&(e.fx=null,e.fy=null,e.fz=null)}tick(t=1){for(let e=0;e<t;e++)this.stepOnce()}stepOnce(){this.simAlpha+=(this.simAlphaTarget-this.simAlpha)*_g,this.applyCharge(),this.applyLink(),this.layout==="free"&&this.applyCenterMeanShift(),this.applyPositional(),this.applyCollide();for(let t of this.nodes)t.fx!==null&&t.fy!==null&&t.fz!==null?(t.x=t.fx,t.y=t.fy,t.z=t.fz,t.vx=0,t.vy=0,t.vz=0):(t.vx*=dl,t.vy*=dl,t.vz*=dl,t.x+=t.vx,t.y+=t.vy,t.z+=t.vz)}centreOf(t){return this.centres.get(t)??Oo}applyCharge(){let t=this.layout==="grouped"?-165:-150,e=this.layout==="grouped"?300:520,n=e*e,s=this.nodes;for(let r=0;r<s.length;r++){let o=s[r];if(o)for(let a=r+1;a<s.length;a++){let l=s[a];if(!l)continue;let c=l.x-o.x,h=l.y-o.y,d=l.z-o.z,u=c*c+h*h+d*d;if(u===0&&(c=this.rng.jiggle(),h=this.rng.jiggle(),d=this.rng.jiggle(),u=c*c+h*h+d*d),u>=n)continue;u<1&&(u=Math.sqrt(u));let f=t*this.simAlpha/u;o.vx+=c*f,o.vy+=h*f,o.vz+=d*f,l.vx-=c*f,l.vy-=h*f,l.vz-=d*f}}}applyLink(){for(let t of this.links){let{source:e,target:n,distance:s,strength:r,bias:o}=t,a=n.x+n.vx-e.x-e.vx,l=n.y+n.vy-e.y-e.vy,c=n.z+n.vz-e.z-e.vz,h=Math.sqrt(a*a+l*l+c*c);h===0&&(a=this.rng.jiggle(),l=this.rng.jiggle(),c=this.rng.jiggle(),h=Math.sqrt(a*a+l*l+c*c));let d=(h-s)/h*this.simAlpha*r;a*=d,l*=d,c*=d,n.vx-=a*o,n.vy-=l*o,n.vz-=c*o;let u=1-o;e.vx+=a*u,e.vy+=l*u,e.vz+=c*u}}applyCenterMeanShift(){let t=this.nodes,e=t.length;if(e===0)return;let n=0,s=0,r=0;for(let c of t)n+=c.x,s+=c.y,r+=c.z;let o=n/e,a=s/e,l=r/e;for(let c of t)c.x-=o,c.y-=a,c.z-=l}applyPositional(){let t=this.layout==="grouped"?.15:.055;for(let e of this.nodes){let n=this.layout==="grouped"?this.centreOf(e.group):Oo;e.vx+=(n.x-e.x)*t*this.simAlpha,e.vy+=(n.y-e.y)*t*this.simAlpha,e.vz+=(n.z-e.z)*t*this.simAlpha}}applyCollide(){let t=this.nodes,e=.9;for(let n=0;n<t.length;n++){let s=t[n];if(!s)continue;let r=s.radius+5,o=r*r,a=s.x+s.vx,l=s.y+s.vy,c=s.z+s.vz;for(let h=n+1;h<t.length;h++){let d=t[h];if(!d)continue;let u=d.radius+5,f=r+u,m=a-(d.x+d.vx),v=l-(d.y+d.vy),g=c-(d.z+d.vz),p=m*m+v*v+g*g;if(p>=f*f)continue;m===0&&(m=this.rng.jiggle(),p+=m*m),v===0&&(v=this.rng.jiggle(),p+=v*v),g===0&&(g=this.rng.jiggle(),p+=g*g),p=Math.sqrt(p);let C=(f-p)/p*e,w=m*C,S=v*C,y=g*C,M=u*u,A=M/(o+M),x=1-A;s.vx+=w*A,s.vy+=S*A,s.vz+=y*A,d.vx-=w*x,d.vy-=S*x,d.vz-=y*x}}}};var Pn="#FAF9F6",Ln="#C28E0E",mi=new Map([["parties",{colour:"#9AA0A8",ink:"#5A616B"}],["unions",{colour:"#E15759",ink:"#A93843"}],["finance",{colour:"#4E79A7",ink:"#365F86"}],["individuals",{colour:"#79706E",ink:"#57504E"}],["property",{colour:"#F28E2B",ink:"#A85A0F"}],["mining & energy",{colour:"#9C755F",ink:"#6E4F3D"}],["hospitality",{colour:"#EDC948",ink:"#7A6414"}],["media & tech",{colour:"#76B7B2",ink:"#3E7A75"}],["health & pharma",{colour:"#59A14F",ink:"#3B7134"}],["gambling",{colour:"#B07AA1",ink:"#7D5273"}],["legal & lobbying",{colour:"#6A51A3",ink:"#4A3775"}],["defence & security",{colour:"#37474F",ink:"#263238"}],["agriculture",{colour:"#6B8E23",ink:"#4A6318"}],["retail",{colour:"#FF9DA7",ink:"#B04A56"}],["tobacco & alcohol",{colour:"#A65628",ink:"#7A3C1B"}],["other",{colour:"#999966",ink:"#6B6B3D"}]]),wg={colour:"#999966",ink:"#6B6B3D"};function yn(i){return mi.get(i)??wg}var gi=40,Tg=.22,Ag=3.2,hh=380,Cg=520,Rg=230,uh=560,Ig=.22,Pg=48,dh=.35,fh=Math.PI-.55,Lg=68,Dg=86,Ng=420,Ug=560,Fg=2,ml=17,an=6;function Og(i){return Math.min(88,15+6.2*Math.sqrt(i))}function Bg(i){return i<.5?4*i*i*i:1-Math.pow(-2*i+2,3)/2}function ph(i){return Math.max(.24,Math.min(1.9,.2+.42*Math.log10(1+Math.max(0,i))))}function mh(i){return .1+.14*Math.max(0,Math.min(1,Math.log10(1+Math.max(0,i))/4))}function zg(i){return Math.max(0,Math.min(1,Math.log10(1+Math.max(0,i))/4))}var kg=`
...
`;function Jg(){if(document.getElementById(yh))return;let i=document.createElement("style");i.id=yh,i.textContent=Zg,document.head.appendChild(i)}function se(i,t,e){let n=document.createElement(i);return t&&(n.className=t),e.appendChild(n),n}function bh(i){Jg();let{engine:t,raw:e,routeBase:n}=i,s=new Map(e.nodes.map(y=>[y.id,y])),r=!1,o=null,a=null,l=null,c=null,h=y=>`/subject/topic/${y}`,d=(y,M)=>{let A=new URLSearchParams;return A.set("q",zo(y)),A.set("topic",y),M&&A.set("party",M),`/search?${A.toString()}`},u=y=>s.get(`party:${y}`)?.colour??"#79706E",f=y=>{let M=new Map;for(let E of e.nodes){if(E.kind!=="donor"||E.group!==y)continue;let R=Os[E.industry];R&&M.set(R,(M.get(R)??0)+E.total)}let A=null,x=-1;for(let[E,R]of M)R>x&&(x=R,A=E);return A},m=()=>{let y=a??(o?.kind==="donor"?o:null);return y?Os[y.industry]??null:l?f(l):null},v=()=>{let y=r&&c?m():null;if(!y||!c){t.setWordsOverlay(null);return}let M=_h(c,y).rows.filter(R=>s.has(`party:${R.party}`)),A=M[0]?.share??0,x=new Map;for(let R of M)A>0&&x.set(`party:${R.party}`,R.share/A);let E=new Map;for(let R of e.edges){let I=s.get(R.source);if(!I||Os[I.industry]!==y)continue;let N=x.get(R.target);N&&E.set(`${R.source}|${R.target}`,N)}t.setWordsOverlay({rings:x,edgeTint:E})},g=y=>{if(c){y(c);return}qg().then(M=>{M&&(c=M,y(M))})};if(i.legend){let y=se("button","mm-chip mm-words-toggle",i.legend);y.type="button",y.setAttribute("aria-pressed","false"),y.title="Ring each party in bronze by its share of the selected industry's debate",se("span","mm-words-glyph",y).setAttribute("aria-hidden","true");let M=se("span","",y);M.textContent="Words halo",y.addEventListener("click",()=>{r=!r,y.setAttribute("aria-pressed",String(r)),r?g(v):v()})}let p=(y,M,A,x)=>{let E=se("li","",y),R=se("a","mm-words-row mm-words-row-party",E);R.href=d(x,M.party),R.title=`${M.party}: ${M.count.toLocaleString("en-AU")} labelled ${zo(x)} speeches so far. Opens the filtered search.`;let I=se("span","mm-dot",R);I.style.background=u(M.party);let N=se("span","mm-words-name",R);N.textContent=M.party;let X=se("span","mm-words-track",R);X.setAttribute("aria-hidden","true");let Y=se("i","",X),F=A>0?M.share/A:0;Y.style.width=`${Math.max(F*100,1.5)}%`,Y.style.opacity=String(.35+.65*F);let B=se("span","mm-words-pct",R);B.textContent=vh(M.share)},C=(y,M,A)=>{let x=Os[M.industry];if(!x)return;let{total:E,rows:R}=_h(A,x);if(E<=0||R.length===0)return;let I=se("div","mm-legend-title",y);I.textContent="In parliament";let N=se("p","mm-words-lead",y),X=se("a","",N);X.href=h(x),X.textContent=gl[x]??x,N.append(": ");let Y=se("b","",N);if(Y.textContent=E.toLocaleString("en-AU"),N.append(" labelled speeches so far"),E<Wg){let tt=se("span","mm-words-few",N);tt.textContent=" \xB7 few labels yet, shares will move"}let F=se("ul","mm-words-rows",y),B=R[0]?.share??0;for(let tt of R)p(F,tt,B,x);let V=se("p","mm-words-fine",y);V.append("Each party's share of the speeches labelled with this topic. ");let $=se("a","",V);$.href=h(x),$.textContent=`All ${zo(x)} speeches`},w=(y,M,A,x)=>{let E=M.label;if(!A.parties.includes(E))return;let R=new Map;for(let B of x.edges){if(B.target!==M.id)continue;let V=s.get(B.source),$=V?Os[V.industry]:void 0;$&&R.set($,(R.get($)??0)+B.total)}let I=[...R.entries()].map(([B,V])=>{let $=A.totals[B]??0,tt=A.cells[B]?.[E]??0;return{slug:B,dollars:V,count:tt,share:$>0?tt/$:0}}).filter(B=>B.count>0).sort((B,V)=>V.share-B.share||V.dollars-B.dollars).slice(0,5);if(I.length===0)return;let N=se("div","mm-legend-title",y);N.textContent="What they talk about";let X=se("ul","mm-words-rows",y),Y=I[0]?.share??0;for(let B of I){let V=se("li","",X),$=se("a","mm-words-row mm-words-row-topic",V);$.href=h(B.slug),$.title=`${E}: ${B.count.toLocaleString("en-AU")} of ${(A.totals[B.slug]??0).toLocaleString("en-AU")} labelled ${zo(B.slug)} speeches so far; ${Oe(B.dollars)} disclosed from the matching donors${x.span?` in ${x.span}`:""}. Opens the topic page.`;let tt=se("span","mm-words-name",$);tt.textContent=gl[B.slug]??B.slug;let it=se("span","mm-words-track",$);it.setAttribute("aria-hidden","true");let at=se("i","",it),mt=Y>0?B.share/Y:0;at.style.width=`${Math.max(mt*100,1.5)}%`,at.style.opacity=String(.35+.65*mt);let Jt=se("span","mm-words-pct",$);Jt.textContent=vh(B.share);let le=se("span","mm-words-money",$);le.textContent=Oe(B.dollars)}let F=se("p","mm-words-fine",y);F.textContent=x.span?`${E}'s share of each debate's labelled speeches so far, across all years, beside what it received from donors in the matching industry in ${x.span}. Shown together for comparison, not as cause.`:`${E}'s share of each debate's labelled speeches so far, beside what it received from donors in the matching industry. Shown together for comparison, not as cause.`},S=(y,M,A)=>{let x=document.createElement("div");x.className="mm-words",x.hidden=!0;let E=y.querySelector(".mm-ask");E?y.insertBefore(x,E):y.appendChild(x),g(R=>{x.isConnected&&(M.kind==="donor"?C(x,M,R):w(x,M,R,A),x.hidden=x.childElementCount===0)})};return{select(y,M,A){o=y,a=null,y&&S(M,y,A),r&&g(v)},selectEdge(y){o=null,a=y?s.get(y.source)??null:null,r&&g(v)},isolate(y){l=y,r&&g(v)}}}var Eh=1e4;function xi(i,t){return i?i===t?`${i}`:`${i}\u2013${t}`:""}var wh=i=>({id:i.id,label:i.label,group:i.group,weight:i.total/Eh,kind:i.kind,industry:i.industry,total:i.total,count:i.count,firstYear:i.firstYear,lastYear:i.lastYear,...i.colour?{colour:i.colour}:{}}),Th=i=>({source:i.source,target:i.target,label:Oe(i.total),weight:i.total/Eh,total:i.total,count:i.count,firstYear:i.firstYear,lastYear:i.lastYear});function Mh(i,t,e){if(!i.byYear)return i;let n=i.undated?.[0]??0,s=i.undated?.[1]??0,r=null,o=null;for(let[a,[l,c]]of Object.entries(i.byYear)){let h=Number(a);h<t||h>e||(n+=l,s+=c,(r===null||h<r)&&(r=h),(o===null||h>o)&&(o=h))}return{...i,total:n,count:s,firstYear:r,lastYear:o}}function Kg(i){let t=new Map,e=0;for(let a of mi.keys())t.set(a,e++);let n=new Map;for(let a of i.nodes)n.set(a.group,(n.get(a.group)??0)+1);let s=new Map;for(let[a,l]of n){let c=yn(a);s.set(a,{slot:t.get(a)??t.get("other")??0,colour:c.colour,ink:c.ink,hollow:!1,count:l})}let r=i.nodes.map(wh),o=i.edges.map(Th);return{nodes:r,edges:o,groupStyles:s,degrees:Vs(o)}}var Sh="money-map-styles",jg=`
...
`;function Qg(){if(document.getElementById(Sh))return;let i=document.createElement("style");i.id=Sh,i.textContent=jg,document.head.appendChild(i)}function It(i,t,e){let n=document.createElement(i);return t&&(n.className=t),e.appendChild(n),n}async function Xv(i,t,e={}){Qg(),i.classList.add("mm-root");let n=await fetch(t);if(!n.ok)throw new Error(`money map data: HTTP ${n.status} for ${t}`);let s=await n.json();if(!gh()){let z=It("div","mm-fallback",i);z.textContent="The 3D money map needs WebGL, which this browser does not offer. The underlying data is available as JSON at "+t;let J=()=>{};return{select:J,isolate:J,fit:J,setPaused:J,destroy:()=>z.remove()}}let r=Kg(s),o=new Map(s.nodes.map(z=>[z.id,z])),a=e.chrome??"full";i.dataset.mmChrome=a;let l="",c=e.askUrl??(z=>`/ask?q=${encodeURIComponent(`What has parliament said about ${z}?`)}`),h=2026,d=1998;for(let z of s.edges)z.firstYear&&(h=Math.min(h,z.firstYear)),z.lastYear&&(d=Math.max(d,z.lastYear));let u=h,f=d,m={nodes:o,edges:s.edges,span:null},v=It("canvas","mm-canvas",i);v.tabIndex=0,v.setAttribute("role","application"),v.setAttribute("aria-label","Money map - drag to orbit, pinch or scroll to zoom, click a node for details. With the keyboard: arrows orbit, plus and minus zoom, Enter selects the node nearest the middle, Escape clears the selection.");let g=It("div","mm-labels",i);g.setAttribute("aria-hidden","true");let p=a==="full",C=p?It("div","mm-legend",i):null;if(C){let z=It("div","mm-legend-title",C);z.textContent="Industries \xB7 click to isolate"}let w=It("div","mm-card",i);w.tabIndex=-1,w.setAttribute("role","region"),w.setAttribute("aria-label","Details for the selected node"),w.hidden=!0;let S=p?It("div","mm-zoom",i):null;if(S){let z=(J,dt,Mt)=>{let St=It("button","",S);St.type="button",St.textContent=J,St.setAttribute("aria-label",dt),St.title=dt,St.addEventListener("click",Mt)};z("+","Zoom in",()=>E.zoomBy(1.3)),z("\u2212","Zoom out",()=>E.zoomBy(1/1.3)),z("\u2922","Fit the whole map to view",()=>E.fit(!0))}let y=p?It("p","mm-hint",i):null;if(y){let z=typeof s.meta?.sourceShort=="string"?s.meta.sourceShort:"AEC returns";y.textContent=`Drag to orbit \xB7 scroll to zoom \xB7 click a cluster to open it \xB7 click a node or a flow \xB7 ${z} ${s.meta?.coverage??"1998\u20132026"}`}let M=null,A=null,x=null,E=new Bo(v,g,z=>Wt(z,{user:!0}),()=>{v.replaceWith(Object.assign(document.createElement("div"),{className:"mm-fallback",textContent:"The 3D view lost its graphics context. Reload the page to restart it."}))});E.onEdgePick=z=>Zt(z);let R=bh({engine:E,raw:s,legend:C,routeBase:l}),I=()=>{let z=i.getBoundingClientRect();if(z.width<1||z.height<1)return 1.5;let J=z.width/z.height;return J<1?.8:J<1.45?1.2:1.9},N="",X=({keepFocus:z=!1}={})=>{let J=u>h||f<d,dt=L=>!J||(L.byYear?L.total>0:(L.firstYear??h)<=f&&(L.lastYear??d)>=u),Mt=J?s.nodes.map(L=>Mh(L,u,f)):s.nodes,St=(J?s.edges.map(L=>Mh(L,u,f)):s.edges).filter(dt);m={nodes:J?new Map(Mt.map(L=>[L.id,L])):o,edges:St,span:J?xi(u,f):null};let vt=new Set(St.map(L=>L.source)),P=Mt.filter(L=>L.group==="parties"?!0:x!==null&&L.group!==x?!1:!J||vt.has(L.id)),At=new Set(P.map(L=>L.id)),Nt=St.filter(L=>At.has(L.source)&&At.has(L.target)).map(Th),T={nodes:P.map(wh),edges:Nt,groupStyles:r.groupStyles,degrees:Vs(Nt),measure:"resources",layout:"grouped",aspect:I(),centralGroup:"parties"};E.setData(T);let _=`${T.aspect}|${x??"*"}`;if(_!==N){let L=N==="";N=_,E.setInsets(re()),E.fit(!L)}if(M)At.has(M)?Yt():Wt(null);else if(A){let L=A,k=L.hub?void 0:Nt.find(q=>q.source===L.source&&q.target===L.target);k?(A=k,Yt()):Zt(null)}z&&M&&At.has(M)&&(E.setInsets(re()),E.focusOn(M,null))},Y=I(),F=new ResizeObserver(()=>{let z=i.getBoundingClientRect();if(z.width<1||z.height<1)return;E.setInsets(re());let J=I();J!==Y?(Y=J,X()):E.viewOwned||E.fit(!1)});F.observe(i);let B=new Map,V=z=>{x=z!==null&&z!=="parties"&&r.groupStyles.has(z)?z:null;for(let[J,dt]of B)dt.setAttribute("aria-pressed",String(J===x)),x!==null&&J!==x?dt.setAttribute("data-dimmed",""):dt.removeAttribute("data-dimmed");X(),R.isolate(x)};if(C){let z=[...mi.keys()].filter(J=>J!=="parties"&&r.groupStyles.has(J));for(let J of z){let dt=It("button","mm-chip",C);dt.type="button",dt.setAttribute("aria-pressed","false");let Mt=It("span","mm-dot",dt);Mt.style.background=yn(J).colour;let St=It("span","",dt);St.textContent=`${J.charAt(0).toUpperCase()}${J.slice(1)} \xB7 ${r.groupStyles.get(J)?.count??0}`,dt.addEventListener("click",()=>V(x===J?null:J)),B.set(J,dt)}}let $=p?It("div","mm-find",i):null;if($){let z=It("input","",$);z.type="search",z.placeholder="Find a donor or party\u2026",z.setAttribute("aria-label","Find a donor or party by name");let J=It("ul","mm-find-list",$),dt=()=>{let Mt=z.value.trim().toLowerCase();if(J.replaceChildren(),Mt.length<2)return;let St=r.nodes.map(vt=>{let P=vt.label.toLowerCase(),At=P.indexOf(Mt),Nt=At===0?0:P.includes(` ${Mt}`)?1:At>0?2:-1;return{n:vt,score:Nt,at:At}}).filter(vt=>vt.score>=0).sort((vt,P)=>vt.score-P.score||vt.n.label.length-P.n.label.length).slice(0,8);for(let{n:vt}of St){let P=It("li","",J),At=It("button","",P);At.type="button";let Nt=It("span","mm-dot",At);Nt.style.background=vt.colour??yn(vt.group).colour;let T=It("span","mm-row-name",At);T.textContent=vt.label,At.addEventListener("click",()=>{z.value="",J.replaceChildren(),Wt(vt.id,{user:!0})})}};z.addEventListener("input",dt),z.addEventListener("keydown",Mt=>{Mt.key==="Enter"&&J.querySelector("button")?.click(),Mt.key==="Escape"&&(z.value="",J.replaceChildren(),Mt.stopPropagation())})}let tt=!p,it=(e.scrub??p)&&d>h?It("div",tt?"mm-scrub mm-scrub-mini":"mm-scrub",i):null;if(it){i.insertBefore(it,w),it.title="Financial years, by the year each begins: 2024 is 2024\u201325";let z=It("div","mm-scrub-label",it);if(!tt){let T=It("span","",z);T.textContent="FINANCIAL YEARS"}let J=It("span","mm-scrub-years",z),dt=tt?It("div","mm-scrub-rail",it):it,Mt=tt?It("div","mm-scrub-fill",It("div","mm-scrub-track",dt)):null,St=It("input","",dt),vt=It("input","",dt);for(let[T,_]of[[St,"from"],[vt,"to"]])T.type="range",T.min=String(h),T.max=String(d),T.setAttribute("aria-label",`Show flows ${_} year`);St.value=String(h),vt.value=String(d);let P=()=>{if(J.textContent=u===f?`${u}`:`${u} \u2013 ${f}`,Mt){let T=d-h;Mt.style.left=`${(u-h)/T*100}%`,Mt.style.right=`${(d-f)/T*100}%`}};P();let At=0,Nt=()=>{let T=Number(St.value),_=Number(vt.value);u=Math.min(T,_),f=Math.max(T,_),P(),!At&&(At=requestAnimationFrame(()=>{At=0,X({keepFocus:!0})}))};St.addEventListener("input",Nt),vt.addEventListener("input",Nt)}let at=(z,J,dt,Mt,St,vt)=>{let P=It("li","",z),At=It("button","mm-row",P);if(At.type="button",vt?At.addEventListener("click",vt):At.disabled=!0,J){let _=It("span","mm-dot",At);_.style.background=J}let Nt=It("span","mm-row-name",At);Nt.textContent=dt;let T=It("span","mm-row-amt",At);if(T.textContent=Oe(Mt),St){let _=It("span","mm-row-years",At);_.textContent=St}},mt=(z,J,dt,Mt=!1,St=!1)=>{let vt=It("a",Mt?"mm-ask mm-ask-quiet":"mm-ask",z);vt.href=J,vt.textContent=dt,St&&(vt.target="_blank",vt.rel="noopener")},Jt=(z,J)=>`/subject/${z}/${encodeURIComponent(J)}`,le=typeof s.meta?.jurisdiction=="string"?s.meta.jurisdiction:"federal",Kt=(z,J)=>{let dt=It("button","mm-ask",z);dt.type="button",dt.textContent="Explain this flow",dt.addEventListener("click",()=>{i.dispatchEvent(new CustomEvent("opax:explain",{bubbles:!0,detail:{...J,jurisdiction:le}}))})},Q=z=>{let J=new Map;for(let St of m.edges){if(St.target!==z)continue;let vt=m.nodes.get(St.source);if(!vt||vt.industry==="other")continue;let P=vt.industry.replace(/_/g," ");J.set(P,(J.get(P)??0)+St.total)}let dt=null,Mt=0;for(let[St,vt]of J)vt>Mt&&(Mt=vt,dt=St);return dt},ot=z=>{w.innerHTML="";let J=It("button","mm-card-close",w);J.type="button",J.textContent="\u2715",J.setAttribute("aria-label","Close details"),J.addEventListener("click",()=>Wt(null,{user:!0}));let dt=It("h2","",w);dt.textContent=z.label;let Mt=It("span","mm-card-tag",w),St=yn(z.group);Mt.style.color=z.kind==="party"?z.colour??St.ink:St.ink,Mt.textContent=z.kind==="party"?"political party":z.industry.replace(/_/g," ");let vt=It("div","mm-card-total",w);vt.textContent=Oe(z.total);let P=It("div","mm-card-sub",w),At=xi(z.firstYear,z.lastYear);P.textContent=z.count===0&&m.span?`nothing disclosed in ${m.span}`:z.kind==="party"?`received across ${z.count.toLocaleString()} receipts \xB7 ${At}`:`given across ${z.count.toLocaleString()} donations \xB7 ${At}`;let Nt=It("div","mm-legend-title",w),T=It("ul","mm-rows",w);if(z.kind==="donor"){Nt.textContent="Where it went";let _=m.edges.filter(L=>L.source===z.id).sort((L,k)=>k.total-L.total);for(let L of _){let k=m.nodes.get(L.target);k&&at(T,k.colour??"#9AA0A8",k.label,L.total,xi(L.firstYear,L.lastYear),()=>Wt(k.id,{user:!0}))}["individual","other",""].includes(z.industry.toLowerCase())||mt(w,c(z.industry.replace(/_/g," ")),"What did parliament say about this industry?"),mt(w,`/search?q=${encodeURIComponent(`"${nt(z.label)}"`)}`,`What was said about ${nt(z.label)}?`,!0),mt(w,Jt("donor",z.label),"Full profile",!0),Kt(w,{kind:"donor",from:z.label})}else{Nt.textContent="Top donors shown on the map";let _=m.edges.filter(k=>k.target===z.id).sort((k,q)=>q.total-k.total).slice(0,15);for(let k of _){let q=m.nodes.get(k.source);q&&at(T,yn(q.group).colour,q.label,k.total,xi(k.firstYear,k.lastYear),()=>Wt(q.id,{user:!0}))}let L=Q(z.id);L&&mt(w,`/ask?q=${encodeURIComponent(`What has ${z.label} said about ${L}?`)}`,`Ask what ${z.label} said about ${L}`),mt(w,Jt("party",z.label),"Full profile",!0),Kt(w,{kind:"party",to:z.label})}},nt=z=>z.replace(/\s+(Pty\.?\s*)?(Ltd|Limited|Incorporated|Inc)\.?$/i,""),Bt=(z,J)=>{let dt=m.nodes.get(z.target);if(!dt)return;w.innerHTML="";let Mt=It("button","mm-card-close",w);Mt.type="button",Mt.textContent="\u2715",Mt.setAttribute("aria-label","Close details"),Mt.addEventListener("click",()=>Zt(null));let St=yn(J),vt=J.charAt(0).toUpperCase()+J.slice(1),P=It("h2","",w);P.textContent=`${vt} \u2192 ${dt.label}`;let At=It("span","mm-card-tag",w);At.style.color=St.ink,At.textContent="industry flow";let Nt=It("div","mm-card-total",w);Nt.textContent=Oe(z.total??0);let T=It("div","mm-card-sub",w),_=xi(z.firstYear??null,z.lastYear??null),L=z.count??0;T.textContent=`from ${L===1?"1 donor":`${L.toLocaleString()} donors`} shown${_?` \xB7 ${_}`:""}`;let k=It("div","mm-legend-title",w);k.textContent="Largest donors in this flow";let q=It("ul","mm-rows",w),st=m.edges.filter(Z=>Z.target===dt.id&&m.nodes.get(Z.source)?.group===J).sort((Z,K)=>K.total-Z.total).slice(0,12);for(let Z of st){let K=m.nodes.get(Z.source);K&&at(q,St.colour,K.label,Z.total,xi(Z.firstYear,Z.lastYear),()=>Wt(K.id,{user:!0}))}["individuals","other"].includes(J)||mt(w,c(J),`What has parliament said about ${J}?`),Kt(w,{kind:"industry",from:vt,to:dt.label});let rt=It("button","mm-ask mm-ask-quiet",w);rt.type="button",rt.textContent=`Show only ${J} on the map`,rt.addEventListener("click",()=>{Zt(null),V(J)})},zt=z=>{if(z.hub){Bt(z,z.hub);return}let J=m.nodes.get(z.source),dt=m.nodes.get(z.target);if(!J||!dt)return;w.innerHTML="";let Mt=It("button","mm-card-close",w);Mt.type="button",Mt.textContent="\u2715",Mt.setAttribute("aria-label","Close details"),Mt.addEventListener("click",()=>Zt(null));let St=It("h2","",w);St.textContent=`${J.label} \u2192 ${dt.label}`;let vt=It("span","mm-card-tag",w);vt.style.color=yn(J.group).ink,vt.textContent=`${J.industry.replace(/_/g," ")} money`;let P=It("div","mm-card-total",w);P.textContent=Oe(z.total??0);let At=It("div","mm-card-sub",w),Nt=xi(z.firstYear??null,z.lastYear??null);At.textContent=`across ${(z.count??0).toLocaleString()} donations${Nt?` \xB7 ${Nt}`:""}`;let T=It("ul","mm-rows",w);if(at(T,J.colour??yn(J.group).colour,J.label,J.total,"",()=>Wt(J.id,{user:!0})),at(T,dt.colour??"#9AA0A8",dt.label,dt.total,"",()=>Wt(dt.id,{user:!0})),z.firstYear&&z.lastYear){let _=J.industry.replace(/_/g," ");mt(w,`/search?q=${encodeURIComponent(_)}&from=${z.firstYear}&to=${z.lastYear}`,`What was said about ${_} in ${Nt}?`)}Kt(w,{kind:"donor",from:J.label,to:dt.label})},Lt=()=>{let z={left:0,right:0,top:0,bottom:0},J=i.getBoundingClientRect();if(J.width<1||J.height<1)return z;let dt=10,Mt=(vt,P)=>{if(!vt)return;let At=vt.getBoundingClientRect();if(At.width<1||At.height<1)return;if(P==="top"||P==="bottom"){let _=At.right-J.left-z.left,L=J.right-At.left-z.right;if(_<=24||L<=24)return}let Nt=P==="left"?At.right-J.left:P==="right"?J.right-At.left:P==="top"?At.bottom-J.top:J.bottom-At.top,T=P==="left"||P==="right"?J.width*.4:J.height*.4;z[P]=Math.max(z[P],Math.min(Nt+dt,T))},St=C!==null&&C.getBoundingClientRect().width>J.width*.5;if(C&&!St&&Mt(C,"left"),Mt(S,"right"),C&&St&&Mt(C,"top"),Mt($,"top"),it){let vt=it.getBoundingClientRect(),P=vt.top+vt.height/2<J.top+J.height/2;Mt(it,P?"top":"bottom")}return Mt(y,"bottom"),z},re=()=>{let z=Lt();if(w.hidden)return z;let J=w.getBoundingClientRect(),dt=i.getBoundingClientRect();return J.width>=dt.width-40?z.bottom=Math.max(z.bottom,J.height+16):z.right=Math.max(z.right,J.width+24),z},Yt=()=>{let z=w.scrollTop;if(M){let J=m.nodes.get(M);if(!J)return;ot(J),R.select(J,w,m)}else A&&(E.setEmphasis({selectedId:null,pathEdges:[A],pathFrom:null}),zt(A));w.scrollTop=z};function Wt(z,{user:J=!1}={}){M=z,A=null;let dt=z?m.nodes.get(z)??null:null;E.setEmphasis({selectedId:z,pathEdges:null,pathFrom:null}),dt?(ot(dt),w.hidden=!1,requestAnimationFrame(()=>{w.hidden||(E.setInsets(re()),M&&E.focusOn(M,null))}),w.focus({preventScroll:!0})):(w.hidden=!0,w.innerHTML="",E.setInsets(Lt())),R.select(dt,w,m),J&&e.onSelect?.(dt)}function Zt(z){A=z,M=null,E.setEmphasis({selectedId:null,pathEdges:z?[z]:null,pathFrom:null}),z?(zt(z),w.hidden=!1,requestAnimationFrame(()=>{w.hidden||E.setInsets(re())}),w.focus({preventScroll:!0})):(w.hidden=!0,w.innerHTML="",E.setInsets(Lt())),R.selectEdge(z)}let jt=z=>{z.key==="Escape"&&(M||A)&&(A?Zt(null):Wt(null,{user:!0}),v.focus({preventScroll:!0}),z.stopPropagation())};return i.addEventListener("keydown",jt),X(),e.focus&&o.has(e.focus)&&Wt(e.focus),{select:z=>Wt(z),isolate:z=>V(z),fit:(z=!0)=>E.fit(z),setPaused:z=>E.setPaused(z),destroy:()=>{i.removeEventListener("keydown",jt),F.disconnect(),E.dispose();for(let z of[v,g,C,w,S,y,$,it])z?.remove();i.classList.remove("mm-root"),delete i.dataset.mmChrome}}}export{mi as CLUSTER_COLOURS,Fs as ForceSim3D,Vs as buildDegrees,Kg as buildGraph,pl as clusterCentres3D,yn as clusterColour,Oe as formatMoney,Xv as mountMoneyMap,Go as radiusFor,Ho as shortLabel,gh as webglAvailable,Mh as windowFigures};
