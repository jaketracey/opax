...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function sp(i,t,e){let n=new Float32Array(ai),s=new D(0,1,0);return new Ge({name:"SphericalGaussianBlur",defines:{n:ai,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Ra(),fragmentShader:`
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function Pc(){return new Ge({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ra(),fragmentShader:`
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function Lc(){return new Ge({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ra(),fragmentShader:`
	...
	`}var Aa=class extends Ve{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;let n={width:t,height:t,depth:1},s=[n,n,n,n,n,n];this.texture=new ls(s),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var am={[So]:"Linear",[Eo]:"Reinhard",[wo]:"Cineon",[To]:"ACESFilmic",[Co]:"AgX",[Ro]:"Neutral",[Ao]:"Custom"};function om(i,t){let e=am[t];return e===void 0?(wt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var wa=new D;function lm(){kt.getLuminanceCoefficients(wa);let i=wa.x.toFixed(4),t=wa.y.toFixed(4),e=wa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}var xm={[vs]:"SHADOWMAP_TYPE_PCF",[Oi]:"SHADOWMAP_TYPE_VSM"};function _m(i){return xm[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var vm={[Hn]:"ENVMAP_TYPE_CUBE",[si]:"ENVMAP_TYPE_CUBE",[ys]:"ENVMAP_TYPE_CUBE_UV"};function ym(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":vm[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var Mm={[si]:"ENVMAP_MODE_REFRACTION"};function bm(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Mm[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var Sm={[bo]:"ENVMAP_BLENDING_MULTIPLY",[hc]:"ENVMAP_BLENDING_MIX",[uc]:"ENVMAP_BLENDING_ADD"};function Em(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Sm[i.combine]||"ENVMAP_BLENDING_NONE"}function wm(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Tm(i,t,e,n){let s=i.getContext(),r=e.defines,a=e.vertexShader,o=e.fragmentShader,c=_m(e),l=ym(e),u=bm(e),d=Em(e),h=wm(e),p=cm(e),g=hm(r),y=s.createProgram(),m,f,E=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(Is).join(`
`)),a=el(a),a=Gc(a,e),a=Hc(a,e),o=el(o),o=Gc(o,e),o=Hc(o,e),a=Wc(a),o=Wc(o),e.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+f);let C=E+m+a,M=E+f+o,T=zc(s,s.VERTEX_SHADER,C),b=zc(s,s.FRAGMENT_SHADER,M);s.attachShader(y,T),s.attachShader(y,b),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function A(I){if(i.debug.checkShaderErrors){let F=s.getProgramInfoLog(y)||"",W=s.getShaderInfoLog(T)||"",X=s.getShaderInfoLog(b)||"",R=F.trim(),B=W.trim(),H=X.trim(),$=!0,j=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,T,b);else{let nt=kc(s,T,"vertex"),ct=kc(s,b,"fragment");Ct("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
}`,sl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){let n=new cs(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new Ge({vertexShader:Ym,fragmentShader:Zm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new me(new us(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},rl=class extends dn{constructor(t,e){super();let n=this,s=null,r=1,a=null,o="local-floor",c=1,l=null,u=null,d=null,h=null,p=null,g=null,y=typeof XRWebGLBinding<"u",m=new sl,f={},E=e.getContextAttributes(),C=null,M=null,T=[],b=[],A=new Ut,_=null,w=new Ce;w.viewport=new se;let P=new Ce;P.viewport=new se;let I=[w,P],F=new Ur,W=null,X=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let et=T[Y];return et===void 0&&(et=new Ii,T[Y]=et),et.getTargetRaySpace()},this.getControllerGrip=function(Y){let et=T[Y];return et===void 0&&(et=new Ii,T[Y]=et),et.getGripSpace()},this.getHand=function(Y){let et=T[Y];return et===void 0&&(et=new Ii,T[Y]=et),et.getHandSpace()};function R(Y){let et=b.indexOf(Y.inputSource);if(et===-1)return;let tt=T[et];tt!==void 0&&(tt.update(Y.inputSource,Y.frame,l||a),tt.dispatchEvent({type:Y.type,data:Y.inputSource}))}function B(){s.removeEventListener("select",R),s.removeEventListener("selectstart",R),s.removeEventListener("selectend",R),s.removeEventListener("squeeze",R),s.removeEventListener("squeezestart",R),s.removeEventListener("squeezeend",R),s.removeEventListener("end",B),s.removeEventListener("inputsourceschange",H);for(let Y=0;Y<T.length;Y++){let et=b[Y];et!==null&&(b[Y]=null,T[Y].disconnect(et))}W=null,X=null,m.reset();for(let Y in f)delete f[Y];t.setRenderTarget(C),p=null,h=null,d=null,s=null,M=null,Ot.stop(),n.isPresenting=!1,t.setPixelRatio(_),t.setSize(A.width,A.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){r=Y,n.isPresenting===!0&&wt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){o=Y,n.isPresenting===!0&&wt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(Y){l=Y},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return d===null&&y&&(d=new XRWebGLBinding(s,e)),d},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(Y){if(s=Y,s!==null){if(C=t.getRenderTarget(),s.addEventListener("select",R),s.addEventListener("selectstart",R),s.addEventListener("selectend",R),s.addEventListener("squeeze",R),s.addEventListener("squeezestart",R),s.addEventListener("squeezeend",R),s.addEventListener("end",B),s.addEventListener("inputsourceschange",H),E.xrCompatible!==!0&&await e.makeXRCompatible(),_=t.getPixelRatio(),t.getSize(A),y&&"createProjectionLayer"in XRWebGLBinding.prototype){let tt=null,Rt=null,Lt=null;E.depth&&(Lt=E.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,tt=E.stencil?Xn:un,Rt=E.stencil?zi:sn);let Tt={colorFormat:e.RGBA8,depthFormat:Lt,scaleFactor:r};d=this.getBinding(),h=d.createProjectionLayer(Tt),s.updateRenderState({layers:[h]}),t.setPixelRatio(1),t.setSize(h.textureWidth,h.textureHeight,!1),M=new Ve(h.textureWidth,h.textureHeight,{format:$e,type:Ne,depthTexture:new wn(h.textureWidth,h.textureHeight,Rt,void 0,void 0,void 0,void 0,void 0,void 0,tt),stencilBuffer:E.stencil,colorSpace:t.outputColorSpace,samples:E.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{let tt={antialias:E.antialias,alpha:!0,depth:E.depth,stencil:E.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,e,tt),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),M=new Ve(p.framebufferWidth,p.framebufferHeight,{format:$e,type:Ne,colorSpace:t.outputColorSpace,stencilBuffer:E.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await s.requestReferenceSpace(o),Ot.setContext(s),Ot.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function H(Y){for(let et=0;et<Y.removed.length;et++){let tt=Y.removed[et],Rt=b.indexOf(tt);Rt>=0&&(b[Rt]=null,T[Rt].disconnect(tt))}for(let et=0;et<Y.added.length;et++){let tt=Y.added[et],Rt=b.indexOf(tt);if(Rt===-1){for(let Tt=0;Tt<T.length;Tt++)if(Tt>=b.length){b.push(tt),Rt=Tt;break}else if(b[Tt]===null){b[Tt]=tt,Rt=Tt;break}if(Rt===-1)break}let Lt=T[Rt];Lt&&Lt.connect(tt)}}let $=new D,j=new D;function nt(Y,et,tt){$.setFromMatrixPosition(et.matrixWorld),j.setFromMatrixPosition(tt.matrixWorld);let Rt=$.distanceTo(j),Lt=et.projectionMatrix.elements,Tt=tt.projectionMatrix.elements,le=Lt[14]/(Lt[10]-1),Vt=Lt[14]/(Lt[10]+1),Jt=(Lt[9]+1)/Lt[5],Xt=(Lt[9]-1)/Lt[5],Ht=(Lt[8]-1)/Lt[0],de=(Tt[8]+1)/Tt[0],ge=le*Ht,ve=le*de,be=Rt/(-Ht+de),re=be*-Ht;if(et.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(re),Y.translateZ(be),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),Lt[10]===-1)Y.projectionMatrix.copy(et.projectionMatrix),Y.projectionMatrixInverse.copy(et.projectionMatrixInverse);else{let fe=le+be,N=Vt+be,Le=ge-re,Yt=ve+(Rt-re),S=Jt*Vt/N*fe,x=Xt*Vt/N*fe;Y.projectionMatrix.makePerspective(Le,Yt,S,x,fe,N),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function ct(Y,et){et===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(et.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(s===null)return;let et=Y.near,tt=Y.far;m.texture!==null&&(m.depthNear>0&&(et=m.depthNear),m.depthFar>0&&(tt=m.depthFar)),F.near=P.near=w.near=et,F.far=P.far=w.far=tt,(W!==F.near||X!==F.far)&&(s.updateRenderState({depthNear:F.near,depthFar:F.far}),W=F.near,X=F.far),F.layers.mask=Y.layers.mask|6,w.layers.mask=F.layers.mask&-5,P.layers.mask=F.layers.mask&-3;let Rt=Y.parent,Lt=F.cameras;ct(F,Rt);for(let Tt=0;Tt<Lt.length;Tt++)ct(Lt[Tt],Rt);Lt.length===2?nt(F,w,P):F.projectionMatrix.copy(w.projectionMatrix),dt(Y,F,Rt)};function dt(Y,et,tt){tt===null?Y.matrix.copy(et.matrixWorld):(Y.matrix.copy(tt.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(et.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(et.projectionMatrix),Y.projectionMatrixInverse.copy(et.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=Ai*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return F},this.getFoveation=function(){if(!(h===null&&p===null))return c},this.setFoveation=function(Y){c=Y,h!==null&&(h.fixedFoveation=Y),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Y)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(F)},this.getCameraTexture=function(Y){return f[Y]};let zt=null;function $t(Y,et){if(u=et.getViewerPose(l||a),g=et,u!==null){let tt=u.views;p!==null&&(t.setRenderTargetFramebuffer(M,p.framebuffer),t.setRenderTarget(M));let Rt=!1;tt.length!==F.cameras.length&&(F.cameras.length=0,Rt=!0);for(let Vt=0;Vt<tt.length;Vt++){let Jt=tt[Vt],Xt=null;if(p!==null)Xt=p.getViewport(Jt);else{let de=d.getViewSubImage(h,Jt);Xt=de.viewport,Vt===0&&(t.setRenderTargetTextures(M,de.colorTexture,de.depthStencilTexture),t.setRenderTarget(M))}let Ht=I[Vt];Ht===void 0&&(Ht=new Ce,Ht.layers.enable(Vt),Ht.viewport=new se,I[Vt]=Ht),Ht.matrix.fromArray(Jt.transform.matrix),Ht.matrix.decompose(Ht.position,Ht.quaternion,Ht.scale),Ht.projectionMatrix.fromArray(Jt.projectionMatrix),Ht.projectionMatrixInverse.copy(Ht.projectionMatrix).invert(),Ht.viewport.set(Xt.x,Xt.y,Xt.width,Xt.height),Vt===0&&(F.matrix.copy(Ht.matrix),F.matrix.decompose(F.position,F.quaternion,F.scale)),Rt===!0&&F.cameras.push(Ht)}let Lt=s.enabledFeatures;if(Lt&&Lt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&y){d=n.getBinding();let Vt=d.getDepthInformation(tt[0]);Vt&&Vt.isValid&&Vt.texture&&m.init(Vt,s.renderState)}if(Lt&&Lt.includes("camera-access")&&y){t.state.unbindTexture(),d=n.getBinding();for(let Vt=0;Vt<tt.length;Vt++){let Jt=tt[Vt].camera;if(Jt){let Xt=f[Jt];Xt||(Xt=new cs,f[Jt]=Xt);let Ht=d.getCameraImage(Jt);Xt.sourceTexture=Ht}}}}for(let tt=0;tt<T.length;tt++){let Rt=b[tt],Lt=T[tt];Rt!==null&&Lt!==void 0&&Lt.update(Rt,et,l||a)}zt&&zt(Y,et),et.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:et}),g=null}let Ot=new Jc;Ot.setAnimationLoop($t),this.setAnimationLoop=function(Y){zt=Y},this.dispose=function(){}}},$m=new ie,nh=new It;nh.set(-1,0,0,0,1,0,0,0,1);function Jm(i,t){function e(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function n(m,f){f.color.getRGB(m.fogColor.value,ko(i)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function s(m,f,E,C,M){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?r(m,f):f.isMeshLambertMaterial?(r(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(r(m,f),d(m,f)):f.isMeshPhongMaterial?(r(m,f),u(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(r(m,f),h(m,f),f.isMeshPhysicalMaterial&&p(m,f,M)):f.isMeshMatcapMaterial?(r(m,f),g(m,f)):f.isMeshDepthMaterial?r(m,f):f.isMeshDistanceMaterial?(r(m,f),y(m,f)):f.isMeshNormalMaterial?r(m,f):f.isLineBasicMaterial?(a(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?c(m,f,E,C):f.isSpriteMaterial?l(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function r(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,e(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===Ee&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,e(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===Ee&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,e(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,e(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,e(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);let E=t.get(f),C=E.envMap,M=E.envMapRotation;C&&(m.envMap.value=C,m.envMapRotation.value.setFromMatrix4($m.makeRotationFromEuler(M)).transpose(),C.isCubeTexture&&C.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(nh),m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,e(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,e(f.aoMap,m.aoMapTransform))}function a(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function c(m,f,E,C){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*E,m.scale.value=C*.5,f.map&&(m.map.value=f.map,e(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function l(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function u(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function d(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function h(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,e(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,e(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,E){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,e(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,e(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,e(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,e(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,e(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Ee&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,e(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,e(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=E.texture,m.transmissionSamplerSize.value.set(E.width,E.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,e(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,e(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,e(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,e(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,e(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function y(m,f){let E=t.get(f).light;m.referencePosition.value.setFromMatrixPosition(E.matrixWorld),m.nearDistance.value=E.shadow.camera.near,m.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function Km(i,t,e,n){let s={},r={},a=[],o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(M,T){let b=T.program;n.uniformBlockBinding(M,b)}function l(M,T){let b=s[M.id];b===void 0&&(m(M),b=u(M),s[M.id]=b,M.addEventListener("dispose",E));let A=T.program;n.updateUBOMapping(M,A);let _=t.render.frame;r[M.id]!==_&&(h(M),r[M.id]=_)}function u(M){let T=d();M.__bindingPointIndex=T;let b=i.createBuffer(),A=M.__size,_=M.usage;return i.bindBuffer(i.UNIFORM_BUFFER,b),i.bufferData(i.UNIFORM_BUFFER,A,_),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,b),b}function d(){for(let M=0;M<o;M++)if(a.indexOf(M)===-1)return a.push(M),M;return Ct("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(M){let T=s[M.id],b=M.uniforms,A=M.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let _=0,w=b.length;_<w;_++){let P=b[_];if(Array.isArray(P))for(let I=0,F=P.length;I<F;I++)p(P[I],_,I,A);else p(P,_,0,A)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(M,T,b,A){if(y(M,T,b,A)===!0){let _=M.__offset,w=M.value;if(Array.isArray(w)){let P=0;for(let I=0;I<w.length;I++){let F=w[I],W=f(F);g(F,M.__data,P),typeof F!="number"&&typeof F!="boolean"&&!F.isMatrix3&&!ArrayBuffer.isView(F)&&(P+=W.storage/Float32Array.BYTES_PER_ELEMENT)}}else g(w,M.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,_,M.__data)}}function g(M,T,b){typeof M=="number"||typeof M=="boolean"?T[0]=M:M.isMatrix3?(T[0]=M.elements[0],T[1]=M.elements[1],T[2]=M.elements[2],T[3]=0,T[4]=M.elements[3],T[5]=M.elements[4],T[6]=M.elements[5],T[7]=0,T[8]=M.elements[6],T[9]=M.elements[7],T[10]=M.elements[8],T[11]=0):ArrayBuffer.isView(M)?T.set(new M.constructor(M.buffer,M.byteOffset,T.length)):M.toArray(T,b)}function y(M,T,b,A){let _=M.value,w=T+"_"+b;if(A[w]===void 0)return typeof _=="number"||typeof _=="boolean"?A[w]=_:ArrayBuffer.isView(_)?A[w]=_.slice():A[w]=_.clone(),!0;{let P=A[w];if(typeof _=="number"||typeof _=="boolean"){if(P!==_)return A[w]=_,!0}else{if(ArrayBuffer.isView(_))return!0;if(P.equals(_)===!1)return P.copy(_),!0}}return!1}function m(M){let T=M.uniforms,b=0,A=16;for(let w=0,P=T.length;w<P;w++){let I=Array.isArray(T[w])?T[w]:[T[w]];for(let F=0,W=I.length;F<W;F++){let X=I[F],R=Array.isArray(X.value)?X.value:[X.value];for(let B=0,H=R.length;B<H;B++){let $=R[B],j=f($),nt=b%A,ct=nt%j.boundary,dt=nt+ct;b+=ct,dt!==0&&A-dt<j.storage&&(b+=A-dt),X.__data=new Float32Array(j.storage/Float32Array.BYTES_PER_ELEMENT),X.__offset=b,b+=j.storage}}}let _=b%A;return _>0&&(b+=A-_),M.__size=b,M.__cache={},this}function f(M){let T={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(T.boundary=4,T.storage=4):M.isVector2?(T.boundary=8,T.storage=8):M.isVector3||M.isColor?(T.boundary=16,T.storage=12):M.isVector4?(T.boundary=16,T.storage=16):M.isMatrix3?(T.boundary=48,T.storage=48):M.isMatrix4?(T.boundary=64,T.storage=64):M.isTexture?wt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(M)?(T.boundary=16,T.storage=M.byteLength):wt("WebGLRenderer: Unsupported uniform value type.",M),T}function E(M){let T=M.target;T.removeEventListener("dispose",E);let b=a.indexOf(T.__bindingPointIndex);a.splice(b,1),i.deleteBuffer(s[T.id]),delete s[T.id],delete r[T.id]}function C(){for(let M in s)i.deleteBuffer(s[M]);a=[],s={},r={}}return{bind:c,update:l,dispose:C}}var Qm=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),mn=null;function jm(){return mn===null&&(mn=new vr(Qm,16,16,qn,pn),mn.name="DFG_LUT",mn.minFilter=Se,mn.magFilter=Se,mn.wrapS=hn,mn.wrapT=hn,mn.generateMipmaps=!1,mn.needsUpdate=!0),mn}var Ca=class{constructor(t={}){let{canvas:e=Mc(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:h=!1,outputBufferType:p=Ne}=t;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;let y=p,m=new Set([Wr,Hr,Gr]),f=new Set([Ne,sn,Bi,zi,Vr,kr]),E=new Uint32Array(4),C=new Int32Array(4),M=new D,T=null,b=null,A=[],_=[],w=null;this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=nn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let P=this,I=!1,F=null,W=null,X=null,R=null;this._outputColorSpace=Be;let B=0,H=0,$=null,j=-1,nt=null,ct=new se,dt=new se,zt=null,$t=new Pt(0),Ot=0,Y=e.width,et=e.height,tt=1,Rt=null,Lt=null,Tt=new se(0,0,Y,et),le=new se(0,0,Y,et),Vt=!1,Jt=new Li,Xt=!1,Ht=!1,de=new ie,ge=new D,ve=new se,be={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},re=!1;function fe(){return $===null?tt:1}let N=n;function Le(v,U){return e.getContext(v,U)}try{let v={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${"185"}`),e.addEventListener("webglcontextlost",ae,!1),e.addEventListener("webglcontextrestored",jt,!1),e.addEventListener("webglcontextcreationerror",an,!1),N===null){let U="webgl2";if(N=Le(U,v),N===null)throw Le(U)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(v){throw Ct("WebGLRenderer: "+v.message),v}let Yt,S,x,O,k,q,it,rt,Z,K,at,Mt,ht,ot,Et,At,Dt,L,st,J,lt,mt,Q;function yt(){Yt=new ap(N),Yt.init(),lt=new qm(N,Yt),S=new Qf(N,Yt,t,lt),x=new Wm(N,Yt),S.reversedDepthBuffer&&h&&x.buffers.depth.setReversed(!0),W=N.createFramebuffer(),X=N.createFramebuffer(),R=N.createFramebuffer(),O=new cp(N),k=new Im,q=new Xm(N,Yt,x,k,S,lt,O),it=new rp(P),rt=new du(N),mt=new Jf(N,rt),Z=new op(N,rt,O,mt),K=new up(N,Z,rt,mt,O),L=new hp(N,S,q),Et=new jf(k),at=new Rm(P,it,Yt,S,mt,Et),Mt=new Jm(P,k),ht=new Lm,ot=new Bm(Yt),Dt=new $f(P,it,x,K,g,c),At=new Hm(P,K,S),Q=new Km(N,O,S,x),st=new Kf(N,Yt,O),J=new lp(N,Yt,O),O.programs=at.programs,P.capabilities=S,P.extensions=Yt,P.properties=k,P.renderLists=ht,P.shadowMap=At,P.state=x,P.info=O}yt(),y!==Ne&&(w=new fp(y,e.width,e.height,o,s,r));let _t=new rl(P,N);this.xr=_t,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){let v=Yt.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){let v=Yt.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return tt},this.setPixelRatio=function(v){v!==void 0&&(tt=v,this.setSize(Y,et,!1))},this.getSize=function(v){return v.set(Y,et)},this.setSize=function(v,U,G=!0){if(_t.isPresenting){wt("WebGLRenderer: Can't change size while VR device is presenting.");return}Y=v,et=U,e.width=Math.floor(v*tt),e.height=Math.floor(U*tt),G===!0&&(e.style.width=v+"px",e.style.height=U+"px"),w!==null&&w.setSize(e.width,e.height),this.setViewport(0,0,v,U)},this.getDrawingBufferSize=function(v){return v.set(Y*tt,et*tt).floor()},this.setDrawingBufferSize=function(v,U,G){Y=v,et=U,tt=G,e.width=Math.floor(v*G),e.height=Math.floor(U*G),this.setViewport(0,0,v,U)},this.setEffects=function(v){if(y===Ne){Ct("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let U=0;U<v.length;U++)if(v[U].isOutputPass===!0){wt("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}w.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(ct)},this.getViewport=function(v){return v.copy(Tt)},this.setViewport=function(v,U,G,z){v.isVector4?Tt.set(v.x,v.y,v.z,v.w):Tt.set(v,U,G,z),x.viewport(ct.copy(Tt).multiplyScalar(tt).round())},this.getScissor=function(v){return v.copy(le)},this.setScissor=function(v,U,G,z){v.isVector4?le.set(v.x,v.y,v.z,v.w):le.set(v,U,G,z),x.scissor(dt.copy(le).multiplyScalar(tt).round())},this.getScissorTest=function(){return Vt},this.setScissorTest=function(v){x.setScissorTest(Vt=v)},this.setOpaqueSort=function(v){Rt=v},this.setTransparentSort=function(v){Lt=v},this.getClearColor=function(v){return v.copy(Dt.getClearColor())},this.setClearColor=function(){Dt.setClearColor(...arguments)},this.getClearAlpha=function(){return Dt.getClearAlpha()},this.setClearAlpha=function(){Dt.setClearAlpha(...arguments)},this.clear=function(v=!0,U=!0,G=!0){let z=0;if(v){let V=!1;if($!==null){let pt=$.texture.format;V=m.has(pt)}if(V){let pt=$.texture.type,xt=f.has(pt),ft=Dt.getClearColor(),vt=Dt.getClearAlpha(),bt=ft.r,Nt=ft.g,Bt=ft.b;xt?(E[0]=bt,E[1]=Nt,E[2]=Bt,E[3]=vt,N.clearBufferuiv(N.COLOR,0,E)):(C[0]=bt,C[1]=Nt,C[2]=Bt,C[3]=vt,N.clearBufferiv(N.COLOR,0,C))}else z|=N.COLOR_BUFFER_BIT}U&&(z|=N.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),G&&(z|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),z!==0&&N.clear(z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(v){v.setRenderer(this),F=v},this.dispose=function(){e.removeEventListener("webglcontextlost",ae,!1),e.removeEventListener("webglcontextrestored",jt,!1),e.removeEventListener("webglcontextcreationerror",an,!1),Dt.dispose(),ht.dispose(),ot.dispose(),k.dispose(),it.dispose(),K.dispose(),mt.dispose(),Q.dispose(),at.dispose(),_t.dispose(),_t.removeEventListener("sessionstart",dl),_t.removeEventListener("sessionend",fl),Zn.stop()};function ae(v){v.preventDefault(),zo("WebGLRenderer: Context Lost."),I=!0}function jt(){zo("WebGLRenderer: Context Restored."),I=!1;let v=O.autoReset,U=At.enabled,G=At.autoUpdate,z=At.needsUpdate,V=At.type;yt(),O.autoReset=v,At.enabled=U,At.autoUpdate=G,At.needsUpdate=z,At.type=V}function an(v){Ct("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function on(v){let U=v.target;U.removeEventListener("dispose",on),hh(U)}function hh(v){uh(v),k.remove(v)}function uh(v){let U=k.get(v).programs;U!==void 0&&(U.forEach(function(G){at.releaseProgram(G)}),v.isShaderMaterial&&at.releaseShaderCache(v))}this.renderBufferDirect=function(v,U,G,z,V,pt){U===null&&(U=be);let xt=V.isMesh&&V.matrixWorld.determinantAffine()<0,ft=ph(v,U,G,z,V);x.setMaterial(z,xt);let vt=G.index,bt=1;if(z.wireframe===!0){if(vt=Z.getWireframeAttribute(G),vt===void 0)return;bt=2}let Nt=G.drawRange,Bt=G.attributes.position,St=Nt.start*bt,Zt=(Nt.start+Nt.count)*bt;pt!==null&&(St=Math.max(St,pt.start*bt),Zt=Math.min(Zt,(pt.start+pt.count)*bt)),vt!==null?(St=Math.max(St,0),Zt=Math.min(Zt,vt.count)):Bt!=null&&(St=Math.max(St,0),Zt=Math.min(Zt,Bt.count));let ce=Zt-St;if(ce<0||ce===1/0)return;mt.setup(V,z,ft,G,vt);let oe,Kt=st;if(vt!==null&&(oe=rt.get(vt),Kt=J,Kt.setIndex(oe)),V.isMesh)z.wireframe===!0?(x.setLineWidth(z.wireframeLinewidth*fe()),Kt.setMode(N.LINES)):Kt.setMode(N.TRIANGLES);else if(V.isLine){let we=z.linewidth;we===void 0&&(we=1),x.setLineWidth(we*fe()),V.isLineSegments?Kt.setMode(N.LINES):V.isLineLoop?Kt.setMode(N.LINE_LOOP):Kt.setMode(N.LINE_STRIP)}else V.isPoints?Kt.setMode(N.POINTS):V.isSprite&&Kt.setMode(N.TRIANGLES);if(V.isBatchedMesh)if(Yt.get("WEBGL_multi_draw"))Kt.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{let we=V._multiDrawStarts,gt=V._multiDrawCounts,Ue=V._multiDrawCount,Wt=vt?rt.get(vt).bytesPerElement:1,We=k.get(z).currentProgram.getUniforms();for(let ln=0;ln<Ue;ln++)We.setValue(N,"_gl_DrawID",ln),Kt.render(we[ln]/Wt,gt[ln])}else if(V.isInstancedMesh)Kt.renderInstances(St,ce,V.count);else if(G.isInstancedBufferGeometry){let we=G._maxInstanceCount!==void 0?G._maxInstanceCount:1/0,gt=Math.min(G.instanceCount,we);Kt.renderInstances(St,ce,gt)}else Kt.render(St,ce)};function ul(v,U,G){v.transparent===!0&&v.side===Ze&&v.forceSinglePass===!1?(v.side=Ee,v.needsUpdate=!0,Fs(v,U,G),v.side=Sn,v.needsUpdate=!0,Fs(v,U,G),v.side=Ze):Fs(v,U,G)}this.compile=function(v,U,G=null){G===null&&(G=v),b=ot.get(G),b.init(U),_.push(b),G.traverseVisible(function(V){V.isLight&&V.layers.test(U.layers)&&(b.pushLight(V),V.castShadow&&b.pushShadow(V))}),v!==G&&v.traverseVisible(function(V){V.isLight&&V.layers.test(U.layers)&&(b.pushLight(V),V.castShadow&&b.pushShadow(V))}),b.setupLights();let z=new Set;return v.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;let pt=V.material;if(pt)if(Array.isArray(pt))for(let xt=0;xt<pt.length;xt++){let ft=pt[xt];ul(ft,G,V),z.add(ft)}else ul(pt,G,V),z.add(pt)}),b=_.pop(),z},this.compileAsync=function(v,U,G=null){let z=this.compile(v,U,G);return new Promise(V=>{function pt(){if(z.forEach(function(xt){k.get(xt).currentProgram.isReady()&&z.delete(xt)}),z.size===0){V(v);return}setTimeout(pt,10)}Yt.get("KHR_parallel_shader_compile")!==null?pt():setTimeout(pt,10)})};let Da=null;function dh(v){Da&&Da(v)}function dl(){Zn.stop()}function fl(){Zn.start()}let Zn=new Jc;Zn.setAnimationLoop(dh),typeof self<"u"&&Zn.setContext(self),this.setAnimationLoop=function(v){Da=v,_t.setAnimationLoop(v),v===null?Zn.stop():Zn.start()},_t.addEventListener("sessionstart",dl),_t.addEventListener("sessionend",fl),this.render=function(v,U){if(U!==void 0&&U.isCamera!==!0){Ct("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;F!==null&&F.renderStart(v,U);let G=_t.enabled===!0&&_t.isPresenting===!0,z=w!==null&&($===null||G)&&w.begin(P,$);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),_t.enabled===!0&&_t.isPresenting===!0&&(w===null||w.isCompositing()===!1)&&(_t.cameraAutoUpdate===!0&&_t.updateCamera(U),U=_t.getCamera()),v.isScene===!0&&v.onBeforeRender(P,v,U,$),b=ot.get(v,_.length),b.init(U),b.state.textureUnits=q.getTextureUnits(),_.push(b),de.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),Jt.setFromProjectionMatrix(de,je,U.reversedDepth),Ht=this.localClippingEnabled,Xt=Et.init(this.clippingPlanes,Ht),T=ht.get(v,A.length),T.init(),A.push(T),_t.enabled===!0&&_t.isPresenting===!0){let xt=P.xr.getDepthSensingMesh();xt!==null&&Na(xt,U,-1/0,P.sortObjects)}Na(v,U,0,P.sortObjects),T.finish(),P.sortObjects===!0&&T.sort(Rt,Lt,U.reversedDepth),re=_t.enabled===!1||_t.isPresenting===!1||_t.hasDepthSensing()===!1,re&&Dt.addToRenderList(T,v),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Xt===!0&&Et.beginShadows();let V=b.state.shadowsArray;if(At.render(V,v,U),Xt===!0&&Et.endShadows(),(z&&w.hasRenderPass())===!1){let xt=T.opaque,ft=T.transmissive;if(b.setupLights(),U.isArrayCamera){let vt=U.cameras;if(ft.length>0)for(let bt=0,Nt=vt.length;bt<Nt;bt++){let Bt=vt[bt];ml(xt,ft,v,Bt)}re&&Dt.render(v);for(let bt=0,Nt=vt.length;bt<Nt;bt++){let Bt=vt[bt];pl(T,v,Bt,Bt.viewport)}}else ft.length>0&&ml(xt,ft,v,U),re&&Dt.render(v),pl(T,v,U)}$!==null&&H===0&&(q.updateMultisampleRenderTarget($),q.updateRenderTargetMipmap($)),z&&w.end(P),v.isScene===!0&&v.onAfterRender(P,v,U),mt.resetDefaultState(),j=-1,nt=null,_.pop(),_.length>0?(b=_[_.length-1],q.setTextureUnits(b.state.textureUnits),Xt===!0&&Et.setGlobalState(P.clippingPlanes,b.state.camera)):b=null,A.pop(),A.length>0?T=A[A.length-1]:T=null,F!==null&&F.renderEnd()};function Na(v,U,G,z){if(v.visible===!1)return;if(v.layers.test(U.layers)){if(v.isGroup)G=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(U);else if(v.isLightProbeGrid)b.pushLightProbeGrid(v);else if(v.isLight)b.pushLight(v),v.castShadow&&b.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||Jt.intersectsSprite(v)){z&&ve.setFromMatrixPosition(v.matrixWorld).applyMatrix4(de);let xt=K.update(v),ft=v.material;ft.visible&&T.push(v,xt,ft,G,ve.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||Jt.intersectsObject(v))){let xt=K.update(v),ft=v.material;if(z&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),ve.copy(v.boundingSphere.center)):(xt.boundingSphere===null&&xt.computeBoundingSphere(),ve.copy(xt.boundingSphere.center)),ve.applyMatrix4(v.matrixWorld).applyMatrix4(de)),Array.isArray(ft)){let vt=xt.groups;for(let bt=0,Nt=vt.length;bt<Nt;bt++){let Bt=vt[bt],St=ft[Bt.materialIndex];St&&St.visible&&T.push(v,xt,St,G,ve.z,Bt)}}else ft.visible&&T.push(v,xt,ft,G,ve.z,null)}}let pt=v.children;for(let xt=0,ft=pt.length;xt<ft;xt++)Na(pt[xt],U,G,z)}function pl(v,U,G,z){let{opaque:V,transmissive:pt,transparent:xt}=v;b.setupLightsView(G),Xt===!0&&Et.setGlobalState(P.clippingPlanes,G),z&&x.viewport(ct.copy(z)),V.length>0&&Us(V,U,G),pt.length>0&&Us(pt,U,G),xt.length>0&&Us(xt,U,G),x.buffers.depth.setTest(!0),x.buffers.depth.setMask(!0),x.buffers.color.setMask(!0),x.setPolygonOffset(!1)}function ml(v,U,G,z){if((G.isScene===!0?G.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[z.id]===void 0){let St=Yt.has("EXT_color_buffer_half_float")||Yt.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[z.id]=new Ve(1,1,{generateMipmaps:!0,type:St?pn:Ne,minFilter:Wn,samples:Math.max(4,S.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:kt.workingColorSpace})}let pt=b.state.transmissionRenderTarget[z.id],xt=z.viewport||ct;pt.setSize(xt.z*P.transmissionResolutionScale,xt.w*P.transmissionResolutionScale);let ft=P.getRenderTarget(),vt=P.getActiveCubeFace(),bt=P.getActiveMipmapLevel();P.setRenderTarget(pt),P.getClearColor($t),Ot=P.getClearAlpha(),Ot<1&&P.setClearColor(16777215,.5),P.clear(),re&&Dt.render(G);let Nt=P.toneMapping;P.toneMapping=nn;let Bt=z.viewport;if(z.viewport!==void 0&&(z.viewport=void 0),b.setupLightsView(z),Xt===!0&&Et.setGlobalState(P.clippingPlanes,z),Us(v,G,z),q.updateMultisampleRenderTarget(pt),q.updateRenderTargetMipmap(pt),Yt.has("WEBGL_multisampled_render_to_texture")===!1){let St=!1;for(let Zt=0,ce=U.length;Zt<ce;Zt++){let oe=U[Zt],{object:Kt,geometry:we,material:gt,group:Ue}=oe;if(gt.side===Ze&&Kt.layers.test(z.layers)){let Wt=gt.side;gt.side=Ee,gt.needsUpdate=!0,gl(Kt,G,z,we,gt,Ue),gt.side=Wt,gt.needsUpdate=!0,St=!0}}St===!0&&(q.updateMultisampleRenderTarget(pt),q.updateRenderTargetMipmap(pt))}P.setRenderTarget(ft,vt,bt),P.setClearColor($t,Ot),Bt!==void 0&&(z.viewport=Bt),P.toneMapping=Nt}function Us(v,U,G){let z=U.isScene===!0?U.overrideMaterial:null;for(let V=0,pt=v.length;V<pt;V++){let xt=v[V],{object:ft,geometry:vt,group:bt}=xt,Nt=xt.material;Nt.allowOverride===!0&&z!==null&&(Nt=z),ft.layers.test(G.layers)&&gl(ft,U,G,vt,Nt,bt)}}function gl(v,U,G,z,V,pt){v.onBeforeRender(P,U,G,z,V,pt),v.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),V.onBeforeRender(P,U,G,z,v,pt),V.transparent===!0&&V.side===Ze&&V.forceSinglePass===!1?(V.side=Ee,V.needsUpdate=!0,P.renderBufferDirect(G,U,z,V,v,pt),V.side=Sn,V.needsUpdate=!0,P.renderBufferDirect(G,U,z,V,v,pt),V.side=Ze):P.renderBufferDirect(G,U,z,V,v,pt),v.onAfterRender(P,U,G,z,V,pt)}function Fs(v,U,G){U.isScene!==!0&&(U=be);let z=k.get(v),V=b.state.lights,pt=b.state.shadowsArray,xt=V.state.version,ft=at.getParameters(v,V.state,pt,U,G,b.state.lightProbeGridArray),vt=at.getProgramCacheKey(ft),bt=z.programs;z.environment=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?U.environment:null,z.fog=U.fog;let Nt=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap;z.envMap=it.get(v.envMap||z.environment,Nt),z.envMapRotation=z.environment!==null&&v.envMap===null?U.environmentRotation:v.envMapRotation,bt===void 0&&(v.addEventListener("dispose",on),bt=new Map,z.programs=bt);let Bt=bt.get(vt);if(Bt!==void 0){if(z.currentProgram===Bt&&z.lightsStateVersion===xt)return _l(v,ft),Bt}else ft.uniforms=at.getUniforms(v),F!==null&&v.isNodeMaterial&&F.build(v,G,ft),v.onBeforeCompile(ft,P),Bt=at.acquireProgram(ft,vt),bt.set(vt,Bt),z.uniforms=ft.uniforms;let St=z.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(St.clippingPlanes=Et.uniform),_l(v,ft),z.needsLights=gh(v),z.lightsStateVersion=xt,z.needsLights&&(St.ambientLightColor.value=V.state.ambient,St.lightProbe.value=V.state.probe,St.directionalLights.value=V.state.directional,St.directionalLightShadows.value=V.state.directionalShadow,St.spotLights.value=V.state.spot,St.spotLightShadows.value=V.state.spotShadow,St.rectAreaLights.value=V.state.rectArea,St.ltc_1.value=V.state.rectAreaLTC1,St.ltc_2.value=V.state.rectAreaLTC2,St.pointLights.value=V.state.point,St.pointLightShadows.value=V.state.pointShadow,St.hemisphereLights.value=V.state.hemi,St.directionalShadowMatrix.value=V.state.directionalShadowMatrix,St.spotLightMatrix.value=V.state.spotLightMatrix,St.spotLightMap.value=V.state.spotLightMap,St.pointShadowMatrix.value=V.state.pointShadowMatrix),z.lightProbeGrid=b.state.lightProbeGridArray.length>0,z.currentProgram=Bt,z.uniformsList=null,Bt}function xl(v){if(v.uniformsList===null){let U=v.currentProgram.getUniforms();v.uniformsList=Hi.seqWithValue(U.seq,v.uniforms)}return v.uniformsList}function _l(v,U){let G=k.get(v);G.outputColorSpace=U.outputColorSpace,G.batching=U.batching,G.batchingColor=U.batchingColor,G.instancing=U.instancing,G.instancingColor=U.instancingColor,G.instancingMorph=U.instancingMorph,G.skinning=U.skinning,G.morphTargets=U.morphTargets,G.morphNormals=U.morphNormals,G.morphColors=U.morphColors,G.morphTargetsCount=U.morphTargetsCount,G.numClippingPlanes=U.numClippingPlanes,G.numIntersection=U.numClipIntersection,G.vertexAlphas=U.vertexAlphas,G.vertexTangents=U.vertexTangents,G.toneMapping=U.toneMapping}function fh(v,U){if(v.length===0)return null;if(v.length===1)return v[0].texture!==null?v[0]:null;M.setFromMatrixPosition(U.matrixWorld);for(let G=0,z=v.length;G<z;G++){let V=v[G];if(V.texture!==null&&V.boundingBox.containsPoint(M))return V}return null}function ph(v,U,G,z,V){U.isScene!==!0&&(U=be),q.resetTextureUnits();let pt=U.fog,xt=z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial?U.environment:null,ft=$===null?P.outputColorSpace:$.isXRRenderTarget===!0?$.texture.colorSpace:kt.workingColorSpace,vt=z.isMeshStandardMaterial||z.isMeshLambertMaterial&&!z.envMap||z.isMeshPhongMaterial&&!z.envMap,bt=it.get(z.envMap||xt,vt),Nt=z.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,Bt=!!G.attributes.tangent&&(!!z.normalMap||z.anisotropy>0),St=!!G.morphAttributes.position,Zt=!!G.morphAttributes.normal,ce=!!G.morphAttributes.color,oe=nn;z.toneMapped&&($===null||$.isXRRenderTarget===!0)&&(oe=P.toneMapping);let Kt=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,we=Kt!==void 0?Kt.length:0,gt=k.get(z),Ue=b.state.lights;if(Xt===!0&&(Ht===!0||v!==nt)){let te=v===nt&&z.id===j;Et.setState(z,v,te)}let Wt=!1;z.version===gt.__version?(gt.needsLights&&gt.lightsStateVersion!==Ue.state.version||gt.outputColorSpace!==ft||V.isBatchedMesh&&gt.batching===!1||!V.isBatchedMesh&&gt.batching===!0||V.isBatchedMesh&&gt.batchingColor===!0&&V.colorTexture===null||V.isBatchedMesh&&gt.batchingColor===!1&&V.colorTexture!==null||V.isInstancedMesh&&gt.instancing===!1||!V.isInstancedMesh&&gt.instancing===!0||V.isSkinnedMesh&&gt.skinning===!1||!V.isSkinnedMesh&&gt.skinning===!0||V.isInstancedMesh&&gt.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&gt.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&gt.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&gt.instancingMorph===!1&&V.morphTexture!==null||gt.envMap!==bt||z.fog===!0&&gt.fog!==pt||gt.numClippingPlanes!==void 0&&(gt.numClippingPlanes!==Et.numPlanes||gt.numIntersection!==Et.numIntersection)||gt.vertexAlphas!==Nt||gt.vertexTangents!==Bt||gt.morphTargets!==St||gt.morphNormals!==Zt||gt.morphColors!==ce||gt.toneMapping!==oe||gt.morphTargetsCount!==we||!!gt.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&(Wt=!0):(Wt=!0,gt.__version=z.version);let We=gt.currentProgram;Wt===!0&&(We=Fs(z,U,V),F&&z.isNodeMaterial&&F.onUpdateProgram(z,We,gt));let ln=!1,An=!1,ci=!1,Qt=We.getUniforms(),he=gt.uniforms;if(x.useProgram(We.program)&&(ln=!0,An=!0,ci=!0),z.id!==j&&(j=z.id,An=!0),gt.needsLights){let te=fh(b.state.lightProbeGridArray,V);gt.lightProbeGrid!==te&&(gt.lightProbeGrid=te,An=!0)}if(ln||nt!==v){x.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),Qt.setValue(N,"projectionMatrix",v.projectionMatrix),Qt.setValue(N,"viewMatrix",v.matrixWorldInverse);let Rn=Qt.map.cameraPosition;Rn!==void 0&&Rn.setValue(N,ge.setFromMatrixPosition(v.matrixWorld)),S.logarithmicDepthBuffer&&Qt.setValue(N,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(z.isMeshPhongMaterial||z.isMeshToonMaterial||z.isMeshLambertMaterial||z.isMeshBasicMaterial||z.isMeshStandardMaterial||z.isShaderMaterial)&&Qt.setValue(N,"isOrthographic",v.isOrthographicCamera===!0),nt!==v&&(nt=v,An=!0,ci=!0)}if(gt.needsLights&&(Ue.state.directionalShadowMap.length>0&&Qt.setValue(N,"directionalShadowMap",Ue.state.directionalShadowMap,q),Ue.state.spotShadowMap.length>0&&Qt.setValue(N,"spotShadowMap",Ue.state.spotShadowMap,q),Ue.state.pointShadowMap.length>0&&Qt.setValue(N,"pointShadowMap",Ue.state.pointShadowMap,q)),V.isSkinnedMesh){Qt.setOptional(N,V,"bindMatrix"),Qt.setOptional(N,V,"bindMatrixInverse");let te=V.skeleton;te&&(te.boneTexture===null&&te.computeBoneTexture(),Qt.setValue(N,"boneTexture",te.boneTexture,q))}V.isBatchedMesh&&(Qt.setOptional(N,V,"batchingTexture"),Qt.setValue(N,"batchingTexture",V._matricesTexture,q),Qt.setOptional(N,V,"batchingIdTexture"),Qt.setValue(N,"batchingIdTexture",V._indirectTexture,q),Qt.setOptional(N,V,"batchingColorTexture"),V._colorsTexture!==null&&Qt.setValue(N,"batchingColorTexture",V._colorsTexture,q));let Cn=G.morphAttributes;if((Cn.position!==void 0||Cn.normal!==void 0||Cn.color!==void 0)&&L.update(V,G,We),(An||gt.receiveShadow!==V.receiveShadow)&&(gt.receiveShadow=V.receiveShadow,Qt.setValue(N,"receiveShadow",V.receiveShadow)),(z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial)&&z.envMap===null&&U.environment!==null&&(he.envMapIntensity.value=U.environmentIntensity),he.dfgLUT!==void 0&&(he.dfgLUT.value=jm()),An){if(Qt.setValue(N,"toneMappingExposure",P.toneMappingExposure),gt.needsLights&&mh(he,ci),pt&&z.fog===!0&&Mt.refreshFogUniforms(he,pt),Mt.refreshMaterialUniforms(he,z,tt,et,b.state.transmissionRenderTarget[v.id]),gt.needsLights&&gt.lightProbeGrid){let te=gt.lightProbeGrid;he.probesSH.value=te.texture,he.probesMin.value.copy(te.boundingBox.min),he.probesMax.value.copy(te.boundingBox.max),he.probesResolution.value.copy(te.resolution)}Hi.upload(N,xl(gt),he,q)}if(z.isShaderMaterial&&z.uniformsNeedUpdate===!0&&(Hi.upload(N,xl(gt),he,q),z.uniformsNeedUpdate=!1),z.isSpriteMaterial&&Qt.setValue(N,"center",V.center),Qt.setValue(N,"modelViewMatrix",V.modelViewMatrix),Qt.setValue(N,"normalMatrix",V.normalMatrix),Qt.setValue(N,"modelMatrix",V.matrixWorld),z.uniformsGroups!==void 0){let te=z.uniformsGroups;for(let Rn=0,hi=te.length;Rn<hi;Rn++){let vl=te[Rn];Q.update(vl,We),Q.bind(vl,We)}}return We}function mh(v,U){v.ambientLightColor.needsUpdate=U,v.lightProbe.needsUpdate=U,v.directionalLights.needsUpdate=U,v.directionalLightShadows.needsUpdate=U,v.pointLights.needsUpdate=U,v.pointLightShadows.needsUpdate=U,v.spotLights.needsUpdate=U,v.spotLightShadows.needsUpdate=U,v.rectAreaLights.needsUpdate=U,v.hemisphereLights.needsUpdate=U}function gh(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return B},this.getActiveMipmapLevel=function(){return H},this.getRenderTarget=function(){return $},this.setRenderTargetTextures=function(v,U,G){let z=k.get(v);z.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,z.__autoAllocateDepthBuffer===!1&&(z.__useRenderToTexture=!1),k.get(v.texture).__webglTexture=U,k.get(v.depthTexture).__webglTexture=z.__autoAllocateDepthBuffer?void 0:G,z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,U){let G=k.get(v);G.__webglFramebuffer=U,G.__useDefaultFramebuffer=U===void 0},this.setRenderTarget=function(v,U=0,G=0){$=v,B=U,H=G;let z=null,V=!1,pt=!1;if(v){let ft=k.get(v);if(ft.__useDefaultFramebuffer!==void 0){x.bindFramebuffer(N.FRAMEBUFFER,ft.__webglFramebuffer),ct.copy(v.viewport),dt.copy(v.scissor),zt=v.scissorTest,x.viewport(ct),x.scissor(dt),x.setScissorTest(zt),j=-1;return}else if(ft.__webglFramebuffer===void 0)q.setupRenderTarget(v);else if(ft.__hasExternalTextures)q.rebindTextures(v,k.get(v.texture).__webglTexture,k.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){let Nt=v.depthTexture;if(ft.__boundDepthTexture!==Nt){if(Nt!==null&&k.has(Nt)&&(v.width!==Nt.image.width||v.height!==Nt.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");q.setupDepthRenderbuffer(v)}}let vt=v.texture;(vt.isData3DTexture||vt.isDataArrayTexture||vt.isCompressedArrayTexture)&&(pt=!0);let bt=k.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(bt[U])?z=bt[U][G]:z=bt[U],V=!0):v.samples>0&&q.useMultisampledRTT(v)===!1?z=k.get(v).__webglMultisampledFramebuffer:Array.isArray(bt)?z=bt[G]:z=bt,ct.copy(v.viewport),dt.copy(v.scissor),zt=v.scissorTest}else ct.copy(Tt).multiplyScalar(tt).floor(),dt.copy(le).multiplyScalar(tt).floor(),zt=Vt;if(G!==0&&(z=W),x.bindFramebuffer(N.FRAMEBUFFER,z)&&x.drawBuffers(v,z),x.viewport(ct),x.scissor(dt),x.setScissorTest(zt),V){let ft=k.get(v.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+U,ft.__webglTexture,G)}else if(pt){let ft=U;for(let vt=0;vt<v.textures.length;vt++){let bt=k.get(v.textures[vt]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+vt,bt.__webglTexture,G,ft)}}else if(v!==null&&G!==0){let ft=k.get(v.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,ft.__webglTexture,G)}j=-1},this.readRenderTargetPixels=function(v,U,G,z,V,pt,xt,ft=0){if(!(v&&v.isWebGLRenderTarget)){Ct("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let vt=k.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&xt!==void 0&&(vt=vt[xt]),vt){x.bindFramebuffer(N.FRAMEBUFFER,vt);try{let bt=v.textures[ft],Nt=bt.format,Bt=bt.type;if(v.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+ft),!S.textureFormatReadable(Nt)){Ct("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!S.textureTypeReadable(Bt)){Ct("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=v.width-z&&G>=0&&G<=v.height-V&&N.readPixels(U,G,z,V,lt.convert(Nt),lt.convert(Bt),pt)}finally{let bt=$!==null?k.get($).__webglFramebuffer:null;x.bindFramebuffer(N.FRAMEBUFFER,bt)}}},this.readRenderTargetPixelsAsync=async function(v,U,G,z,V,pt,xt,ft=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let vt=k.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&xt!==void 0&&(vt=vt[xt]),vt)if(U>=0&&U<=v.width-z&&G>=0&&G<=v.height-V){x.bindFramebuffer(N.FRAMEBUFFER,vt);let bt=v.textures[ft],Nt=bt.format,Bt=bt.type;if(v.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+ft),!S.textureFormatReadable(Nt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!S.textureTypeReadable(Bt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let St=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,St),N.bufferData(N.PIXEL_PACK_BUFFER,pt.byteLength,N.STREAM_READ),N.readPixels(U,G,z,V,lt.convert(Nt),lt.convert(Bt),0);let Zt=$!==null?k.get($).__webglFramebuffer:null;x.bindFramebuffer(N.FRAMEBUFFER,Zt);let ce=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await Sc(N,ce,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,St),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,pt),N.deleteBuffer(St),N.deleteSync(ce),pt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,U=null,G=0){let z=Math.pow(2,-G),V=Math.floor(v.image.width*z),pt=Math.floor(v.image.height*z),xt=U!==null?U.x:0,ft=U!==null?U.y:0;q.setTexture2D(v,0),N.copyTexSubImage2D(N.TEXTURE_2D,G,0,0,xt,ft,V,pt),x.unbindTexture()},this.copyTextureToTexture=function(v,U,G=null,z=null,V=0,pt=0){let xt,ft,vt,bt,Nt,Bt,St,Zt,ce,oe=v.isCompressedTexture?v.mipmaps[pt]:v.image;if(G!==null)xt=G.max.x-G.min.x,ft=G.max.y-G.min.y,vt=G.isBox3?G.max.z-G.min.z:1,bt=G.min.x,Nt=G.min.y,Bt=G.isBox3?G.min.z:0;else{let he=Math.pow(2,-V);xt=Math.floor(oe.width*he),ft=Math.floor(oe.height*he),v.isDataArrayTexture?vt=oe.depth:v.isData3DTexture?vt=Math.floor(oe.depth*he):vt=1,bt=0,Nt=0,Bt=0}z!==null?(St=z.x,Zt=z.y,ce=z.z):(St=0,Zt=0,ce=0);let Kt=lt.convert(U.format),we=lt.convert(U.type),gt;U.isData3DTexture?(q.setTexture3D(U,0),gt=N.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(q.setTexture2DArray(U,0),gt=N.TEXTURE_2D_ARRAY):(q.setTexture2D(U,0),gt=N.TEXTURE_2D),x.activeTexture(N.TEXTURE0),x.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,U.flipY),x.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),x.pixelStorei(N.UNPACK_ALIGNMENT,U.unpackAlignment);let Ue=x.getParameter(N.UNPACK_ROW_LENGTH),Wt=x.getParameter(N.UNPACK_IMAGE_HEIGHT),We=x.getParameter(N.UNPACK_SKIP_PIXELS),ln=x.getParameter(N.UNPACK_SKIP_ROWS),An=x.getParameter(N.UNPACK_SKIP_IMAGES);x.pixelStorei(N.UNPACK_ROW_LENGTH,oe.width),x.pixelStorei(N.UNPACK_IMAGE_HEIGHT,oe.height),x.pixelStorei(N.UNPACK_SKIP_PIXELS,bt),x.pixelStorei(N.UNPACK_SKIP_ROWS,Nt),x.pixelStorei(N.UNPACK_SKIP_IMAGES,Bt);let ci=v.isDataArrayTexture||v.isData3DTexture,Qt=U.isDataArrayTexture||U.isData3DTexture;if(v.isDepthTexture){let he=k.get(v),Cn=k.get(U),te=k.get(he.__renderTarget),Rn=k.get(Cn.__renderTarget);x.bindFramebuffer(N.READ_FRAMEBUFFER,te.__webglFramebuffer),x.bindFramebuffer(N.DRAW_FRAMEBUFFER,Rn.__webglFramebuffer);for(let hi=0;hi<vt;hi++)ci&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,k.get(v).__webglTexture,V,Bt+hi),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,k.get(U).__webglTexture,pt,ce+hi)),N.blitFramebuffer(bt,Nt,xt,ft,St,Zt,xt,ft,N.DEPTH_BUFFER_BIT,N.NEAREST);x.bindFramebuffer(N.READ_FRAMEBUFFER,null),x.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(V!==0||v.isRenderTargetTexture||k.has(v)){let he=k.get(v),Cn=k.get(U);x.bindFramebuffer(N.READ_FRAMEBUFFER,X),x.bindFramebuffer(N.DRAW_FRAMEBUFFER,R);for(let te=0;te<vt;te++)ci?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,he.__webglTexture,V,Bt+te):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,he.__webglTexture,V),Qt?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,Cn.__webglTexture,pt,ce+te):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,Cn.__webglTexture,pt),V!==0?N.blitFramebuffer(bt,Nt,xt,ft,St,Zt,xt,ft,N.COLOR_BUFFER_BIT,N.NEAREST):Qt?N.copyTexSubImage3D(gt,pt,St,Zt,ce+te,bt,Nt,xt,ft):N.copyTexSubImage2D(gt,pt,St,Zt,bt,Nt,xt,ft);x.bindFramebuffer(N.READ_FRAMEBUFFER,null),x.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else Qt?v.isDataTexture||v.isData3DTexture?N.texSubImage3D(gt,pt,St,Zt,ce,xt,ft,vt,Kt,we,oe.data):U.isCompressedArrayTexture?N.compressedTexSubImage3D(gt,pt,St,Zt,ce,xt,ft,vt,Kt,oe.data):N.texSubImage3D(gt,pt,St,Zt,ce,xt,ft,vt,Kt,we,oe):v.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,pt,St,Zt,xt,ft,Kt,we,oe.data):v.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,pt,St,Zt,oe.width,oe.height,Kt,oe.data):N.texSubImage2D(N.TEXTURE_2D,pt,St,Zt,xt,ft,Kt,we,oe);x.pixelStorei(N.UNPACK_ROW_LENGTH,Ue),x.pixelStorei(N.UNPACK_IMAGE_HEIGHT,Wt),x.pixelStorei(N.UNPACK_SKIP_PIXELS,We),x.pixelStorei(N.UNPACK_SKIP_ROWS,ln),x.pixelStorei(N.UNPACK_SKIP_IMAGES,An),pt===0&&U.generateMipmaps&&N.generateMipmap(gt),x.unbindTexture()},this.initRenderTarget=function(v){k.get(v).__webglFramebuffer===void 0&&q.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?q.setTextureCube(v,0):v.isData3DTexture?q.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?q.setTexture2DArray(v,0):q.setTexture2D(v,0),x.unbindTexture()},this.resetState=function(){B=0,H=0,$=null,x.reset(),mt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return je}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorSpace=kt._getDrawingBufferColorSpace(t),e.unpackColorSpace=kt._getUnpackColorSpace()}};var eg=1-Math.pow(.001,.0033333333333333335),al=.6,ng=.25,ig=.25,Pa={x:0,y:0,z:0,r:120},ol=class{state=7;next(){return this.state=(this.state*1664525+1013904223)%4294967296,this.state/4294967296}jiggle(){return(this.next()-.5)*1e-6}};function sg(i,t,e){let s=new Float64Array(721),r=t,a=0;for(let u=1;u<=720;u++){let d=u/720*Math.PI*2,h=Math.cos(d)*t,p=Math.sin(d)*e;s[u]=(s[u-1]??0)+Math.hypot(h-r,p-a),r=h,a=p}let o=s[720]??1,c=[],l=0;for(let u=0;u<i;u++){let d=(u/i+.75)%1*o;for(l=0;l<720&&(s[l+1]??o)<d;)l++;c.push(l/720*Math.PI*2)}return c}function oi(i){return 30*Math.sqrt(Math.max(1,i))+34}function ll(i,t,e){let n=[...i.entries()],s=new Map;if(n.length===0)return s;let r=0;if(e!==void 0&&i.has(e)&&n.length>1&&(r=oi(i.get(e)??1),s.set(e,{x:0,y:0,z:0,r}),n=n.filter(([d])=>d!==e)),n.length===1){let d=n[0];if(d){let h=r>0?r+oi(d[1]):0;s.set(d[0],{x:h,y:0,z:0,r:oi(d[1])})}return s}let a=n.length,o=Math.pow(Math.max(.7,Math.min(2.2,t)),.85),l=sg(a,o,1/o).map((d,h)=>({x:Math.cos(d)*o,y:h%2===0?.26:-.26,z:Math.sin(d)/o})),u=0;for(let d=0;d<a;d++)for(let h=d+1;h<a;h++){let p=l[d],g=l[h],y=n[d],m=n[h];if(!p||!g||!y||!m)continue;let f=Math.hypot(p.x-g.x,p.y-g.y,p.z-g.z);f<=0||(u=Math.max(u,(oi(y[1])+oi(m[1]))/f))}return u*=1.18,r>0&&n.forEach(([,d],h)=>{let p=l[h];if(!p)return;let g=Math.hypot(p.x,p.y,p.z);g<=0||(u=Math.max(u,(r+oi(d))*1.12/g))}),n.forEach(([d,h],p)=>{let g=l[p]??{x:0,y:0,z:0};s.set(d,{x:g.x*u,y:g.y*u,z:g.z*u,r:oi(h)})}),s}var rg=Math.PI*(3-Math.sqrt(5));function ih(i){return i.x!==void 0&&i.y!==void 0&&i.z!==void 0}function ag(i,t,e){let n=new Map,s=0;for(let o of i)ih(o)||(n.set(o.group,(n.get(o.group)??0)+1),s+=1);let r=new Map,a=0;return i.map(o=>{if(ih(o))return{id:o.id,group:o.group,radius:o.radius,x:o.x,y:o.y,z:o.z,vx:0,vy:0,vz:0,fx:null,fy:null,fz:null};let c=r.get(o.group)??0;r.set(o.group,c+1);let l=t==="grouped"?c:a++,u=(t==="grouped"?n.get(o.group):s)??1,d=t==="grouped"?e.get(o.group)??Pa:Pa,h=9*Math.sqrt(l+.5),p=l*rg,g=1-2*(l+.5)/u,y=Math.sqrt(Math.max(0,1-g*g));return{id:o.id,group:o.group,radius:o.radius,x:d.x+h*y*Math.cos(p),y:d.y+h*g,z:d.z+h*y*Math.sin(p),vx:0,vy:0,vz:0,fx:null,fy:null,fz:null}})}function og(i,t,e){let n=[],s=new Map;for(let a of i)!t.has(a.source)||!t.has(a.target)||(n.push(a),s.set(a.source,(s.get(a.source)??0)+1),s.set(a.target,(s.get(a.target)??0)+1));let r=[];for(let a of n){let o=t.get(a.source),c=t.get(a.target);if(!o||!c)continue;let l=o.group===c.group,u=e==="grouped"?l?62:190:76,d=e==="grouped"?l?.5:.015:.6,h=s.get(a.source)??0,p=s.get(a.target)??0;r.push({source:o,target:c,distance:u,strength:d,bias:h/(h+p)})}return r}var Ps=class{nodes;nodesById;links;layout;centres;rng=new ol;simAlpha=1;simAlphaTarget=0;constructor(t){this.layout=t.layout,this.centres=t.centres,this.nodes=ag(t.nodes,t.layout,t.centres),this.nodesById=new Map(this.nodes.map(e=>[e.id,e])),this.links=og(t.links,this.nodesById,t.layout)}byId(t){return this.nodesById.get(t)}alpha(){return this.simAlpha}reheat(){this.simAlphaTarget=ng,this.simAlpha=Math.max(this.simAlpha,ig)}cool(){this.simAlphaTarget=0}pin(t,e,n,s){let r=this.nodesById.get(t);r&&(r.fx=e,r.fy=n,r.fz=s)}unpin(t){let e=this.nodesById.get(t);e&&(e.fx=null,e.fy=null,e.fz=null)}tick(t=1){for(let e=0;e<t;e++)this.stepOnce()}stepOnce(){this.simAlpha+=(this.simAlphaTarget-this.simAlpha)*eg,this.applyCharge(),this.applyLink(),this.layout==="free"&&this.applyCenterMeanShift(),this.applyPositional(),this.applyCollide();for(let t of this.nodes)t.fx!==null&&t.fy!==null&&t.fz!==null?(t.x=t.fx,t.y=t.fy,t.z=t.fz,t.vx=0,t.vy=0,t.vz=0):(t.vx*=al,t.vy*=al,t.vz*=al,t.x+=t.vx,t.y+=t.vy,t.z+=t.vz)}centreOf(t){return this.centres.get(t)??Pa}applyCharge(){let t=this.layout==="grouped"?-165:-150,e=this.layout==="grouped"?300:520,n=e*e,s=this.nodes;for(let r=0;r<s.length;r++){let a=s[r];if(a)for(let o=r+1;o<s.length;o++){let c=s[o];if(!c)continue;let l=c.x-a.x,u=c.y-a.y,d=c.z-a.z,h=l*l+u*u+d*d;if(h===0&&(l=this.rng.jiggle(),u=this.rng.jiggle(),d=this.rng.jiggle(),h=l*l+u*u+d*d),h>=n)continue;h<1&&(h=Math.sqrt(h));let p=t*this.simAlpha/h;a.vx+=l*p,a.vy+=u*p,a.vz+=d*p,c.vx-=l*p,c.vy-=u*p,c.vz-=d*p}}}applyLink(){for(let t of this.links){let{source:e,target:n,distance:s,strength:r,bias:a}=t,o=n.x+n.vx-e.x-e.vx,c=n.y+n.vy-e.y-e.vy,l=n.z+n.vz-e.z-e.vz,u=Math.sqrt(o*o+c*c+l*l);u===0&&(o=this.rng.jiggle(),c=this.rng.jiggle(),l=this.rng.jiggle(),u=Math.sqrt(o*o+c*c+l*l));let d=(u-s)/u*this.simAlpha*r;o*=d,c*=d,l*=d,n.vx-=o*a,n.vy-=c*a,n.vz-=l*a;let h=1-a;e.vx+=o*h,e.vy+=c*h,e.vz+=l*h}}applyCenterMeanShift(){let t=this.nodes,e=t.length;if(e===0)return;let n=0,s=0,r=0;for(let l of t)n+=l.x,s+=l.y,r+=l.z;let a=n/e,o=s/e,c=r/e;for(let l of t)l.x-=a,l.y-=o,l.z-=c}applyPositional(){let t=this.layout==="grouped"?.15:.055;for(let e of this.nodes){let n=this.layout==="grouped"?this.centreOf(e.group):Pa;e.vx+=(n.x-e.x)*t*this.simAlpha,e.vy+=(n.y-e.y)*t*this.simAlpha,e.vz+=(n.z-e.z)*t*this.simAlpha}}applyCollide(){let t=this.nodes,e=.9;for(let n=0;n<t.length;n++){let s=t[n];if(!s)continue;let r=s.radius+5,a=r*r,o=s.x+s.vx,c=s.y+s.vy,l=s.z+s.vz;for(let u=n+1;u<t.length;u++){let d=t[u];if(!d)continue;let h=d.radius+5,p=r+h,g=o-(d.x+d.vx),y=c-(d.y+d.vy),m=l-(d.z+d.vz),f=g*g+y*y+m*m;if(f>=p*p)continue;g===0&&(g=this.rng.jiggle(),f+=g*g),y===0&&(y=this.rng.jiggle(),f+=y*y),m===0&&(m=this.rng.jiggle(),f+=m*m),f=Math.sqrt(f);let E=(p-f)/f*e,C=g*E,M=y*E,T=m*E,b=h*h,A=b/(a+b),_=1-A;s.vx+=C*A,s.vy+=M*A,s.vz+=T*A,d.vx-=C*_,d.vy-=M*_,d.vz-=T*_}}}};var li="#FAF9F6",Ls="#C28E0E",Xi=new Map([["parties",{colour:"#9AA0A8",ink:"#5A616B"}],["unions",{colour:"#E15759",ink:"#A93843"}],["finance",{colour:"#4E79A7",ink:"#365F86"}],["individuals",{colour:"#79706E",ink:"#57504E"}],["property",{colour:"#F28E2B",ink:"#A85A0F"}],["mining & energy",{colour:"#9C755F",ink:"#6E4F3D"}],["hospitality",{colour:"#EDC948",ink:"#7A6414"}],["media & tech",{colour:"#76B7B2",ink:"#3E7A75"}],["health & pharma",{colour:"#59A14F",ink:"#3B7134"}],["gambling",{colour:"#B07AA1",ink:"#7D5273"}],["legal & lobbying",{colour:"#6A51A3",ink:"#4A3775"}],["defence & security",{colour:"#37474F",ink:"#263238"}],["agriculture",{colour:"#6B8E23",ink:"#4A6318"}],["retail",{colour:"#FF9DA7",ink:"#B04A56"}],["tobacco & alcohol",{colour:"#A65628",ink:"#7A3C1B"}],["other",{colour:"#999966",ink:"#6B6B3D"}]]),lg={colour:"#999966",ink:"#6B6B3D"};function Ds(i){return Xi.get(i)??lg}var Ns=40,cg=.22,hg=3.2,sh=380,ug=520,dg=230,fg=560,pg=.05,rh=.35,ah=Math.PI-.55;function mg(i){return Math.max(.6,Math.min(5,.55+1.2*Math.log10(1+Math.max(0,i))))}function gg(i){let t=new Map;i.forEach((n,s)=>{let r=n.source<n.target?`${n.source} ${n.target}`:`${n.target} ${n.source}`,a=t.get(r);a?a.push(s):t.set(r,[s])});let e=new Array(i.length).fill(0);for(let n of t.values())n.length!==1&&n.forEach((s,r)=>{e[s]=-1+2*r/(n.length-1)});return e}function oh(){try{let i=document.createElement("canvas");return!!(i.getContext("webgl2")??i.getContext("webgl"))}catch{return!1}}function xg(){let i=[],t=[];for(let e of Xi.values())i.push(new Pt(e.colour)),t.push(e.ink);return{cats:i,inks:t,surface:new Pt(li),accent:new Pt(Ls)}}var La=class{canvas;labelLayer;onSelect;renderer;scene=new ss;camera;nodeGroup=new tn;edgeGroup=new tn;territoryGroup=new tn;hemi;key;fill;fog;sphereGeo=new ii(1,40,24);shellGeo=new ii(1,32,18);tubeGeo=new Ni(1,1,1,7,1,!0);coneGeo=new hs(1,1,10);ringGeo=new ds(1.18,1.32,48);territoryGeo=new ii(1,28,18);selectionRing;selectionRingMaterial;traceRing;traceRingMaterial;palette;data=null;sim=null;centres=new Map;nodeVisuals=new Map;edgeVisuals=[];territories=[];paintRank=[];worldCentre=new D;worldRadius=320;emphasis={selectedId:null,pathEdges:null,pathFrom:null};hoveredId=null;neighbourIds=null;pathNodeIds=null;pathEdgeKeys=null;insets={left:0,right:0,bottom:0};view;distGoal;tween=null;idleSpin;reduced;reducedQuery=null;onContextLost=null;onReducedChange=t=>{this.reduced=t.matches,t.matches&&(this.idleSpin=!1)};viewOwnedFlag=!1;focusOwnedFlag=!1;fitDist=420;pointers=new Map;orbit=null;pinch=null;drag=null;gestured=!1;hoverPos=null;hoverDirty=!1;raycaster=new _s;frameHandle=null;lastFrame=performance.now();frameCount=0;renderDirty=!0;resizeObserver;disposed=!1;width=1;height=1;constructor(t,e,n,s){this.canvas=t,this.labelLayer=e,this.onSelect=n,s&&(this.onContextLost=r=>{r.preventDefault(),s()},t.addEventListener("webglcontextlost",this.onContextLost)),this.reducedQuery=typeof globalThis.matchMedia=="function"?globalThis.matchMedia("(prefers-reduced-motion: reduce)"):null,this.reduced=this.reducedQuery?.matches??!1,this.idleSpin=!this.reduced,this.reducedQuery?.addEventListener("change",this.onReducedChange),this.renderer=new Ca({canvas:t,antialias:!0,alpha:!1}),this.renderer.setPixelRatio(Math.min(globalThis.devicePixelRatio||1,2)),this.palette=xg(),this.camera=new Ce(Ns,1.5,2,9e3),this.fog=new is(this.palette.surface.clone(),600,2400),this.scene.fog=this.fog,this.scene.add(this.territoryGroup),this.scene.add(this.edgeGroup),this.scene.add(this.nodeGroup),this.hemi=new gs(16777215,8947848,.95),this.key=new Fi(16777215,1.15),this.key.position.set(.55,1,.4),this.fill=new Fi(16777215,.3),this.fill.position.set(-.6,-.35,-.7),this.scene.add(this.hemi,this.key,this.fill),this.selectionRingMaterial=new en({transparent:!0,opacity:0,depthWrite:!1,side:Ze}),this.selectionRing=new me(this.ringGeo,this.selectionRingMaterial),this.selectionRing.visible=!1,this.scene.add(this.selectionRing),this.traceRingMaterial=this.selectionRingMaterial.clone(),this.traceRing=new me(this.ringGeo,this.traceRingMaterial),this.traceRing.visible=!1,this.scene.add(this.traceRing),this.applyPaletteToScene(),this.view={target:new D,theta:-.5,phi:.95,dist:640},this.distGoal=this.view.dist,this.resizeObserver=new ResizeObserver(()=>this.handleResize()),this.resizeObserver.observe(t.parentElement??t),this.handleResize(),this.bindPointerHandlers(),this.frameHandle=requestAnimationFrame(this.frame)}applyPaletteToScene(){let t=this.palette.surface;this.renderer.setClearColor(t,1),this.fog.color.copy(t),this.hemi.color.copy(t.clone().lerp(new Pt(16777215),.72)),this.hemi.groundColor.copy(t.clone().multiplyScalar(.55)),this.selectionRingMaterial.color.copy(this.palette.accent),this.traceRingMaterial.color.copy(this.palette.accent)}catColour(t){return this.palette.cats[t]??this.palette.accent}applyNodeColour(t){let e=t.colour;t.hollow?(t.material.color.copy(this.palette.surface),t.material.emissive.set(0),t.shellMaterial.color.copy(e)):(t.material.color.copy(e),t.material.emissive.copy(e).multiplyScalar(.16),t.shellMaterial.color.copy(e))}applyEdgeColour(t){let e=this.pathEdgeKeys?.has(t.key)??!1,n=this.emphasis.selectedId??this.hoveredId,s=n!==null&&(t.edge.source===n||t.edge.target===n);if(e){t.material.color.copy(this.palette.accent),t.coneMaterial.color.copy(this.palette.accent);return}if(s){let a=n?this.nodeVisuals.get(n):void 0,o=a?a.colour:this.palette.accent;t.material.color.copy(o),t.coneMaterial.color.copy(o);return}let r=t.from.colour;t.material.color.copy(r),t.coneMaterial.color.copy(r)}setData(t){this.data=t;let e=new Map;for(let[l,u]of this.nodeVisuals)e.set(l,{x:u.sim.x,y:u.sim.y,z:u.sim.z});let n=this.nodeVisuals.size===0,s=new Map;for(let l of t.nodes)s.set(l.group,(s.get(l.group)??0)+1);let r=new Map([...s.entries()].sort((l,u)=>u[1]-l[1]||l[0].localeCompare(u[0]))),a=ll(r,t.aspect,t.centralGroup);this.centres=a,!this.viewOwnedFlag&&a.size>2&&(this.view.theta=this.bestTheta(a));let o=l=>Fa(t.measure,t.measure==="links"?t.degrees.get(l.id)??0:l.weight);this.sim=new Ps({nodes:t.nodes.map(l=>{let u=e.get(l.id);return{id:l.id,group:l.group,radius:o(l),...u?{x:u.x,y:u.y,z:u.z}:{}}}),links:t.edges.map(l=>({source:l.source,target:l.target})),layout:t.layout,centres:a}),this.sim.tick(300),this.clearScene(),t.nodes.forEach((l,u)=>{let d=this.sim?.byId(l.id);if(!d)return;let h=t.groupStyles.get(l.group),p=h?.slot??0,g=h?.hollow??!1,y=t.degrees.get(l.id)??0,m=t.measure==="links"&&y===0,f=o(l),E=new fs({roughness:.42,metalness:.04,transparent:!0,opacity:1}),C=new me(this.sphereGeo,E);C.userData.nodeId=l.id;let M=new en({transparent:!0,opacity:g?.95:0,side:Ee,depthWrite:!1}),T=new me(this.shellGeo,M);T.raycast=()=>{},C.add(T),T.scale.setScalar(g?1.22:1.14),this.nodeGroup.add(C);let b=document.createElement("div");b.className="rp-map3d-label",b.textContent=Ua(l.label),b.style.display="none",this.labelLayer.appendChild(b);let A={node:l,sim:d,r:m?Math.max(3.5,f-1.5):f,slot:p,colour:l.colour?new Pt(l.colour):this.catColour(p).clone(),hollow:g,unlinked:m,mesh:C,material:E,shell:T,shellMaterial:M,opacity:{current:1,target:1},shellOpacity:{current:g?.95:0,target:g?.95:0},scale:{current:n&&!this.reduced?.001:1,target:1},bornAt:n&&!this.reduced?performance.now()+Math.min(u*9,900):0,label:b};this.applyNodeColour(A),this.nodeVisuals.set(l.id,A)});let c=gg(t.edges);if(this.edgeVisuals=[],t.edges.forEach((l,u)=>{let d=this.nodeVisuals.get(l.source),h=this.nodeVisuals.get(l.target);if(!d||!h)return;let p=new en({transparent:!0,depthWrite:!1}),g=new me(this.tubeGeo,p);g.raycast=()=>{};let y=new en({transparent:!0,depthWrite:!1}),m=new me(this.coneGeo,y);m.raycast=()=>{},m.visible=!1,this.edgeGroup.add(g,m);let f=d.node.group!==h.node.group,E={edge:l,key:`${l.source}|${l.label}|${l.target}`,from:d,to:h,mesh:g,material:p,cone:m,coneMaterial:y,width:mg(l.weight),crossing:f,lateral:c[u]??0,opacity:{current:0,target:f?.16:.4},emphasised:!1,label:null};this.applyEdgeColour(E),this.edgeVisuals.push(E)}),this.territories=[],t.layout==="grouped"&&r.size>1)for(let[l]of r){let u=t.groupStyles.get(l);if(!u)continue;let d=new en({transparent:!0,opacity:.055,depthWrite:!1}),h=this.palette.cats[u.slot];h&&d.color.copy(h);let p=new me(this.territoryGeo,d);p.raycast=()=>{},p.renderOrder=-2,this.territoryGroup.add(p);let g=document.createElement("div");g.className="rp-map3d-territory",g.style.color=this.palette.inks[u.slot]??"#5A616B",g.textContent=`${l.toUpperCase()} \xB7 ${s.get(l)??0}`,g.style.display="none",this.labelLayer.appendChild(g),this.territories.push({group:l,style:u,mesh:p,material:d,caption:g,centre:new D,r:0})}this.paintRank=[...this.nodeVisuals.values()].sort((l,u)=>u.r-l.r),this.updateWorldBounds(),this.updateTerritories(),this.updateEmphasisSets(),this.renderDirty=!0}clearScene(){for(let t of this.nodeVisuals.values())t.material.dispose(),t.shellMaterial.dispose(),t.label.remove();for(let t of this.edgeVisuals)t.material.dispose(),t.coneMaterial.dispose(),t.label?.remove();for(let t of this.territories)t.material.dispose(),t.caption.remove();this.nodeGroup.clear(),this.edgeGroup.clear(),this.territoryGroup.clear(),this.nodeVisuals.clear(),this.edgeVisuals=[],this.territories=[]}updateWorldBounds(){let t=new D,e=0;for(let s of this.nodeVisuals.values())t.x+=s.sim.x,t.y+=s.sim.y,t.z+=s.sim.z,e+=1;if(e===0)return;t.multiplyScalar(1/e);let n=120;for(let s of this.nodeVisuals.values()){let r=Math.hypot(s.sim.x-t.x,s.sim.y-t.y,s.sim.z-t.z)+s.r;r>n&&(n=r)}this.worldCentre.copy(t),this.worldRadius=n}setEmphasis(t){this.emphasis=t,this.updateEmphasisSets()}setHovered(t){this.hoveredId!==t&&(this.hoveredId=t,this.canvas.style.cursor=t?"pointer":"grab",this.updateEmphasisSets())}updateEmphasisSets(){let{selectedId:t,pathEdges:e,pathFrom:n}=this.emphasis,s=t??this.hoveredId;if(s){let r=new Set([s]);for(let a of this.edgeVisuals)a.edge.source===s&&r.add(a.edge.target),a.edge.target===s&&r.add(a.edge.source);this.neighbourIds=r}else this.neighbourIds=null;if(e){let r=new Set;for(let a of e)r.add(a.source),r.add(a.target);this.pathNodeIds=r,this.pathEdgeKeys=new Set(e.map(a=>`${a.source}|${a.label}|${a.target}`))}else this.pathNodeIds=null,this.pathEdgeKeys=null;for(let r of this.nodeVisuals.values()){let a=r.node.id,o=a===t,c=a===this.hoveredId,l=a===n,u=this.neighbourIds?.has(a)??!0,d=this.pathNodeIds?.has(a)??!1,h=this.pathNodeIds&&!d||!this.pathNodeIds&&!u,p=o||c||l||d;r.opacity.target=h?.12:r.unlinked&&!p?.55:1,r.shellOpacity.target=r.hollow?h?.14:.95:c&&!o?.4:0,r.scale.target=p?1.08:1}for(let r of this.edgeVisuals){let a=this.pathEdgeKeys?.has(r.key)??!1,o=s!==null&&(r.edge.source===s||r.edge.target===s),c=this.pathEdgeKeys&&!a||s!==null&&!o&&!this.pathEdgeKeys,l=a||o;r.emphasised=l,r.opacity.target=c?.04:l?.92:r.crossing?.16:.4,this.applyEdgeColour(r)}this.renderDirty=!0}setInsets(t){this.insets=t}get viewOwned(){return this.viewOwnedFlag}get focusOwned(){return this.focusOwnedFlag}claimView(){this.tween=null,this.viewOwnedFlag=!0,this.focusOwnedFlag=!1,this.idleSpin=!1}freeBox(){let t=Math.max(1,this.width-this.insets.left-this.insets.right),e=Math.max(1,this.height-this.insets.bottom);return{w:t,h:e,cx:this.insets.left+t/2,cy:e/2}}frameFor(t){let e=this.freeBox(),n=ki.degToRad(Ns/2),s=Math.max(.2,e.h/this.height),r=Math.max(.2,e.w/this.width),a=Math.atan(Math.tan(n)*s*.9),o=Math.atan(Math.tan(n)*this.camera.aspect*r*.9),c=t/Math.tan(Math.min(a,o));return{box:e,dist:c}}worldPerPixel(t){return 2*t*Math.tan(ki.degToRad(Ns/2))/this.height}offsetTarget(t,e){let n=this.freeBox(),s=this.worldPerPixel(e),r=n.cx-this.width/2,a=n.cy-this.height/2,o=new D,c=new D,l=new D;return this.camera.matrixWorld.extractBasis(o,c,l),t.clone().addScaledVector(o,-r*s).addScaledVector(c,a*s)}fit(t=!0){if(this.tween=null,this.viewOwnedFlag=!1,this.focusOwnedFlag=!1,this.nodeVisuals.size===0)return;this.updateWorldBounds(),this.updateCamera();let e=this.fitDistance();this.fitDist=e;let s={target:this.offsetTarget(this.worldCentre,e),theta:this.view.theta,phi:this.view.phi,dist:e};this.moveView(s,t?ug:0)}bestTheta(t){let e=this.view.phi,n=[...t.values()],s=this.view.theta,r=-1/0;for(let a=0;a<36;a++){let o=a/36*Math.PI*2,c=Math.cos(o),l=-Math.sin(o),u=Math.cos(e),d=1/0;for(let h=0;h<n.length;h++)for(let p=h+1;p<n.length;p++){let g=n[h],y=n[p];if(!g||!y)continue;let m=(g.x-y.x)*c+(g.z-y.z)*l,f=(g.y-y.y)*Math.sin(e)-((g.x-y.x)*-l+(g.z-y.z)*c)*u,E=Math.hypot(m,f)/(g.r+y.r);E<d&&(d=E)}d>r&&(r=d,s=o)}return s}fitDistance(){let{theta:t,phi:e}=this.view,n=new D(Math.sin(e)*Math.sin(t),Math.cos(e),Math.sin(e)*Math.cos(t)),s=new D().crossVectors(new D(0,1,0),n);s.lengthSq()<.001&&s.set(1,0,0),s.normalize();let r=new D().crossVectors(n,s),a=this.freeBox(),o=ki.degToRad(Ns/2),c=Math.atan(Math.tan(o)*this.camera.aspect*Math.max(.2,a.w/this.width)*.92),l=Math.atan(Math.tan(o)*Math.max(.2,a.h/this.height)*.92),u=new D,d=240;for(let h of this.nodeVisuals.values()){u.set(h.sim.x,h.sim.y,h.sim.z).sub(this.worldCentre);let p=u.dot(n),g=Math.abs(u.dot(s))+h.r,y=Math.abs(u.dot(r))+h.r+26;d=Math.max(d,g/Math.tan(c)+p,y/Math.tan(l)+p)}return d}focusOn(t,e){let n=this.nodeVisuals.get(t);if(!n)return null;this.updateCamera();let s=new D(n.sim.x,n.sim.y,n.sim.z),r=this.freeBox(),a=s.clone().project(this.camera),o=(a.x*.5+.5)*this.width,c=(-a.y*.5+.5)*this.height,l=Math.min(90,r.w*.18),u=Math.min(90,r.h*.18);if(a.z<1&&o>this.insets.left+l&&o<this.insets.left+r.w-l&&c>u&&c<r.h-u&&this.insets.bottom<=0)return null;let h=e;if(h===null){let g=n.r+30;for(let m of this.edgeVisuals){let f=m.edge.source===t?m.edge.target:m.edge.target===t?m.edge.source:null;if(f===null)continue;let E=this.nodeVisuals.get(f);if(!E)continue;let C=Math.hypot(E.sim.x-n.sim.x,E.sim.y-n.sim.y,E.sim.z-n.sim.z)+E.r;C>g&&(g=C)}let{dist:y}=this.frameFor(g*1.12);h=Math.min(this.view.dist,Math.max(dg,Math.min(fg,y)))}h=Math.max(this.minDist(),Math.min(this.maxDist(),h));let p=this.offsetTarget(s,h);return this.moveView({target:p,theta:this.view.theta,phi:this.view.phi,dist:h},sh),this.viewOwnedFlag=!0,this.focusOwnedFlag=!0,this.idleSpin=!1,h}nudgeForInsets(t,e){if(t===0&&e===0)return;let n=this.worldPerPixel(this.view.dist),s=new D,r=new D,a=new D;this.camera.matrixWorld.extractBasis(s,r,a);let o=this.view.target.clone().addScaledVector(s,-t*n).addScaledVector(r,e*n);this.moveView({...this.view,target:o},sh)}zoomBy(t){this.claimView(),this.distGoal=Math.max(this.minDist(),Math.min(this.maxDist(),this.distGoal/t))}minDist(){return Math.max(60,this.fitDist*cg)}maxDist(){return this.fitDist*hg}moveView(t,e){if(this.reduced||e<=0){this.view={...t,target:t.target.clone()},this.distGoal=t.dist,this.tween=null,this.renderDirty=!0;return}this.tween={from:{...this.view,target:this.view.target.clone()},to:{...t,target:t.target.clone()},started:performance.now(),duration:e},this.distGoal=t.dist}bindPointerHandlers(){let t=this.canvas;t.addEventListener("pointerdown",this.onPointerDown),t.addEventListener("pointermove",this.onPointerMove),t.addEventListener("pointerup",this.onPointerUp),t.addEventListener("pointercancel",this.onPointerUp),t.addEventListener("pointerleave",this.onPointerLeave),t.addEventListener("wheel",this.onWheel,{passive:!1}),t.addEventListener("contextmenu",this.onContextMenu),t.addEventListener("keydown",this.onKeyDown)}unbindPointerHandlers(){let t=this.canvas;t.removeEventListener("pointerdown",this.onPointerDown),t.removeEventListener("pointermove",this.onPointerMove),t.removeEventListener("pointerup",this.onPointerUp),t.removeEventListener("pointercancel",this.onPointerUp),t.removeEventListener("pointerleave",this.onPointerLeave),t.removeEventListener("wheel",this.onWheel),t.removeEventListener("contextmenu",this.onContextMenu),t.removeEventListener("keydown",this.onKeyDown)}localPoint(t){let e=this.canvas.getBoundingClientRect();return{x:t.clientX-e.left,y:t.clientY-e.top}}capturePointer(t){try{this.canvas.setPointerCapture?.(t)}catch{}}releasePointer(t){try{this.canvas.releasePointerCapture?.(t)}catch{}}raycastVec=new D;raycastNode(t,e){this.updateCamera(),this.raycaster.setFromCamera(new Ut(t/this.width*2-1,-(e/this.height)*2+1),this.camera);let n=this.raycaster.ray.origin,s=this.raycaster.ray.direction,r=this.raycastVec,a=null,o=1/0;for(let c of this.nodeVisuals.values()){r.set(c.sim.x-n.x,c.sim.y-n.y,c.sim.z-n.z);let l=r.dot(s);if(l<0)continue;let u=c.r,d=r.lengthSq()-l*l;if(d>u*u)continue;let h=l-Math.sqrt(u*u-d);h<this.camera.near||h>=o||(a=c,o=h)}return a}onPointerDown=t=>{let e=this.localPoint(t);if(this.pointers.set(t.pointerId,e),this.capturePointer(t.pointerId),this.pointers.size===2){this.orbit=null,this.releaseDrag();let[s,r]=[...this.pointers.entries()];s&&r&&(this.claimView(),this.pinch={a:s[0],b:r[0],gap:Math.hypot(s[1].x-r[1].x,s[1].y-r[1].y),dist:this.view.dist,midX:(s[1].x+r[1].x)/2,midY:(s[1].y+r[1].y)/2});return}if(this.pointers.size>2||this.pinch)return;let n=t.button===0?this.raycastNode(e.x,e.y):null;if(n&&this.sim){let s=new D;this.camera.getWorldDirection(s);let r=new D(n.sim.x,n.sim.y,n.sim.z),a=new qe().setFromNormalAndCoplanarPoint(s,r);this.drag={id:n.node.id,plane:a,moved:!1,lastX:e.x,lastY:e.y,travel:0},this.idleSpin=!1,this.sim.reheat();return}this.orbit={mode:t.button===2||t.button===1||t.shiftKey?"pan":"orbit",lastX:e.x,lastY:e.y,moved:0},this.canvas.style.cursor="grabbing"};onPointerMove=t=>{let e=this.localPoint(t);this.pointers.has(t.pointerId)&&this.pointers.set(t.pointerId,e);let n=this.pinch;if(n){let a=this.pointers.get(n.a),o=this.pointers.get(n.b);if(!a||!o)return;let c=Math.hypot(a.x-o.x,a.y-o.y);if(c>0&&n.gap>0){let d=Math.max(this.minDist(),Math.min(this.maxDist(),n.dist*(n.gap/c)));this.view.dist=d,this.distGoal=d}let l=(a.x+o.x)/2,u=(a.y+o.y)/2;this.panBy(l-n.midX,u-n.midY),n.midX=l,n.midY=u,this.renderDirty=!0;return}let s=this.drag;if(s&&this.sim){if(s.travel+=Math.abs(e.x-s.lastX)+Math.abs(e.y-s.lastY),s.lastX=e.x,s.lastY=e.y,s.travel<=3)return;s.moved=!0,this.raycaster.setFromCamera(new Ut(e.x/this.width*2-1,-(e.y/this.height)*2+1),this.camera);let a=new D;this.raycaster.ray.intersectPlane(s.plane,a)&&this.sim.pin(s.id,a.x,a.y,a.z);return}let r=this.orbit;if(r){let a=e.x-r.lastX,o=e.y-r.lastY;r.moved+=Math.abs(a)+Math.abs(o),r.lastX=e.x,r.lastY=e.y,r.moved>3&&this.claimView(),r.mode==="pan"?this.panBy(a,o):(this.view.theta-=a*.005,this.view.phi=Math.max(rh,Math.min(ah,this.view.phi-o*.005))),this.renderDirty=!0;return}this.hoverPos=e,this.hoverDirty=!0};panBy(t,e){let n=this.worldPerPixel(this.view.dist),s=new D,r=new D,a=new D;this.camera.matrixWorld.extractBasis(s,r,a),this.view.target.addScaledVector(s,-t*n).addScaledVector(r,e*n)}releaseDrag(){let t=this.drag;t&&(this.sim?.unpin(t.id),this.sim?.cool(),this.drag=null)}onPointerUp=t=>{let e=this.localPoint(t);if(this.pointers.delete(t.pointerId),this.releasePointer(t.pointerId),this.pinch){this.pointers.size<2&&(this.pinch=null,this.gestured=!0);return}let n=this.drag;if(n){let r=n.moved;this.releaseDrag(),r||this.onSelect(n.id);return}let s=this.orbit;if(this.orbit=null,this.canvas.style.cursor="grab",s&&s.moved<=3){if(this.gestured){this.gestured=!1;return}let r=this.raycastNode(e.x,e.y);this.onSelect(r?r.node.id:null)}this.gestured=!1};onPointerLeave=()=>{this.hoverPos=null,this.setHovered(null)};onWheel=t=>{t.preventDefault(),this.claimView();let e=t.deltaY<0?1.12:1/1.12;this.distGoal=Math.max(this.minDist(),Math.min(this.maxDist(),this.distGoal/e))};onContextMenu=t=>{t.preventDefault()};centremostNodeId(){let t=this.freeBox(),e=null,n=1/0,s=this.labelVec;for(let r of this.nodeVisuals.values()){if(s.set(r.sim.x,r.sim.y,r.sim.z).project(this.camera),s.z>1||s.z<-1)continue;let a=(s.x*.5+.5)*this.width,o=(-s.y*.5+.5)*this.height;if(a<0||a>this.width||o<0||o>this.height)continue;let c=Math.hypot(a-t.cx,o-t.cy);c<n&&(n=c,e=r.node.id)}return e}onKeyDown=t=>{switch(t.key){case"Enter":case" ":{let n=this.centremostNodeId();n&&this.onSelect(n);break}case"ArrowLeft":this.claimView(),this.view.theta+=.15;break;case"ArrowRight":this.claimView(),this.view.theta-=.15;break;case"ArrowUp":this.claimView(),this.view.phi=Math.max(rh,this.view.phi-.15);break;case"ArrowDown":this.claimView(),this.view.phi=Math.min(ah,this.view.phi+.15);break;case"+":case"=":this.zoomBy(1.3);break;case"-":this.zoomBy(1/1.3);break;default:return}t.preventDefault(),this.renderDirty=!0};handleResize(){let t=this.canvas.parentElement;if(!t)return;let e=t.getBoundingClientRect();e.width<1||e.height<1||(this.width=e.width,this.height=e.height,this.renderer.setSize(e.width,e.height,!1),this.camera.aspect=e.width/e.height,this.camera.updateProjectionMatrix(),!this.viewOwnedFlag&&this.nodeVisuals.size>0&&this.fit(!1),this.renderDirty=!0)}stepFades(t){let e=this.reduced?1:1-Math.exp(-t/110),n=!1,s=a=>{let o=a.target-a.current;return Math.abs(o)<.004?(a.current=a.target,a.current):(n=!0,a.current+=o*e,a.current)},r=performance.now();for(let a of this.nodeVisuals.values())a.bornAt>0&&r<a.bornAt?n=!0:(a.bornAt=0,s(a.scale)),s(a.opacity),s(a.shellOpacity);for(let a of this.edgeVisuals)s(a.opacity);return n}frame=t=>{if(this.disposed)return;this.frameHandle=requestAnimationFrame(this.frame);let e=Math.min(64,t-this.lastFrame);this.lastFrame=t,this.frameCount+=1;let n=this.sim!==null&&(this.sim.alpha()>.02||this.drag!==null);n&&(this.sim?.tick(1),this.renderDirty=!0);let s=this.tween;if(s){let r=Math.min(1,(t-s.started)/s.duration),a=1-Math.pow(1-r,3);this.view.target.lerpVectors(s.from.target,s.to.target,a),this.view.theta=s.from.theta+(s.to.theta-s.from.theta)*a,this.view.phi=s.from.phi+(s.to.phi-s.from.phi)*a,this.view.dist=s.from.dist*Math.pow(s.to.dist/s.from.dist,a),r>=1&&(this.tween=null),this.renderDirty=!0}else{let r=this.distGoal-this.view.dist;Math.abs(r)>.5&&(this.view.dist+=r*(this.reduced?1:Math.min(1,e/90)),this.renderDirty=!0),this.idleSpin&&this.nodeVisuals.size>0&&(this.view.theta+=pg*e/1e3,this.renderDirty=!0)}if(this.stepFades(e)&&(this.renderDirty=!0),this.hoverDirty&&!this.drag&&!this.orbit&&!this.pinch&&(this.hoverDirty=!1,this.hoverPos)){let r=this.raycastNode(this.hoverPos.x,this.hoverPos.y);this.setHovered(r?r.node.id:null)}this.renderDirty&&(this.renderDirty=!1,this.updateCamera(),this.updateNodeMeshes(),this.updateEdgeMeshes(),n&&this.updateTerritories(),this.updateRings(),this.renderer.render(this.scene,this.camera),this.projectLabels(),(n||this.tween)&&(this.renderDirty=!0))};updateCamera(){let{target:t,theta:e,phi:n,dist:s}=this.view,r=Math.sin(n);this.camera.position.set(t.x+s*r*Math.sin(e),t.y+s*Math.cos(n),t.z+s*r*Math.cos(e)),this.camera.lookAt(t),this.camera.updateMatrixWorld(),this.fog.near=s+this.worldRadius*.1,this.fog.far=s+this.worldRadius*2.1}updateNodeMeshes(){for(let t of this.nodeVisuals.values()){let e=Math.max(.001,t.r*t.scale.current);t.mesh.position.set(t.sim.x,t.sim.y,t.sim.z),t.mesh.scale.setScalar(e),t.material.opacity=t.opacity.current,t.material.depthWrite=t.opacity.current>.5,t.shellMaterial.opacity=t.shellOpacity.current,t.shell.visible=t.shellOpacity.current>.01}}edgeUp=new D(0,1,0);edgeTmpDir=new D;edgeTmpSide=new D;edgeTmpMid=new D;edgeTmpQuat=new Ye;updateEdgeMeshes(){let t=this.edgeTmpDir,e=this.edgeTmpSide,n=this.edgeTmpMid;for(let s of this.edgeVisuals){let{from:r,to:a}=s;t.set(a.sim.x-r.sim.x,a.sim.y-r.sim.y,a.sim.z-r.sim.z);let o=t.length();if(o<1){s.mesh.visible=!1,s.cone.visible=!1;continue}t.multiplyScalar(1/o);let c=r.r*r.scale.current,l=a.r*a.scale.current,u=s.emphasised?Math.max(4.5,s.width*3.2):0,d=c+1,h=l+u+1,p=Math.max(1,o-d-h);e.set(t.z,0,-t.x),e.lengthSq()<.01&&e.set(1,0,0),e.normalize();let g=s.lateral*Math.min(12,o*.1),y=d+p/2;n.set(r.sim.x+t.x*y+e.x*g,r.sim.y+t.y*y+e.y*g,r.sim.z+t.z*y+e.z*g);let m=s.emphasised?Math.max(s.width,1.5):s.width;if(s.mesh.visible=s.opacity.current>.01,s.mesh.position.copy(n),s.mesh.quaternion.copy(this.edgeTmpQuat.setFromUnitVectors(this.edgeUp,t)),s.mesh.scale.set(m,p,m),s.material.opacity=s.opacity.current,s.emphasised){s.cone.visible=!0,s.cone.position.set(a.sim.x-t.x*(l+u/2+1),a.sim.y-t.y*(l+u/2+1),a.sim.z-t.z*(l+u/2+1)),s.cone.quaternion.copy(this.edgeTmpQuat);let f=Math.max(2.2,m*2.1);s.cone.scale.set(f,u,f),s.coneMaterial.opacity=Math.min(1,s.opacity.current+.05)}else s.cone.visible=!1}}updateTerritories(){for(let t of this.territories){let e=0,n=0,s=0,r=0;for(let o of this.nodeVisuals.values())o.node.group===t.group&&(e+=o.sim.x,n+=o.sim.y,s+=o.sim.z,r+=1);if(r===0){t.mesh.visible=!1,t.caption.style.display="none";continue}e/=r,n/=r,s/=r;let a=0;for(let o of this.nodeVisuals.values()){if(o.node.group!==t.group)continue;let c=Math.hypot(o.sim.x-e,o.sim.y-n,o.sim.z-s)+o.r;c>a&&(a=c)}t.centre.set(e,n,s),t.r=a+22,t.mesh.visible=!0,t.mesh.position.set(e,n,s),t.mesh.scale.setScalar(t.r)}}updateRings(){let t=(e,n,s)=>{let r=s?this.nodeVisuals.get(s):void 0;if(!r){e.visible=!1;return}e.visible=!0,e.position.set(r.sim.x,r.sim.y,r.sim.z),e.scale.setScalar(r.r*r.scale.current),e.quaternion.copy(this.camera.quaternion),n.opacity=.85};t(this.selectionRing,this.selectionRingMaterial,this.emphasis.selectedId),t(this.traceRing,this.traceRingMaterial,this.emphasis.pathFrom!==this.emphasis.selectedId?this.emphasis.pathFrom:null)}labelVec=new D;projectLabels(){let t=this.camera,e=Math.tan(ki.degToRad(Ns/2)),n=this.emphasis.selectedId??this.hoveredId,s=[],r=Math.max(10,Math.min(48,Math.round(24*(this.fitDist/Math.max(1,this.view.dist))))),a=0,o=this.paintRank.map(c=>{this.labelVec.set(c.sim.x,c.sim.y,c.sim.z).project(t);let l=this.labelVec.z<=1&&this.labelVec.z>=-1,u=(this.labelVec.x*.5+.5)*this.width,d=(-this.labelVec.y*.5+.5)*this.height,h=Math.hypot(c.sim.x-t.position.x,c.sim.y-t.position.y,c.sim.z-t.position.z),p=c.r*c.scale.current*(this.height/2)/(h*e);return{ok:l,sx:u,sy:d,camDist:h,screenR:p,opacity:c.opacity.current}});for(let c=0;c<this.paintRank.length;c++){let l=this.paintRank[c],u=o[c];if(!l||!u)continue;let d=l.label,h=l.node.id===n||l.node.id===this.emphasis.pathFrom||(this.pathNodeIds?.has(l.node.id)??!1),p=this.neighbourIds?.has(l.node.id)??!1;if(!(h||p||a<r)||l.opacity.current<.2||!u.ok){d.style.display="none";continue}let{sx:y,sy:m,camDist:f,screenR:E}=u;if(y<-40||y>this.width+40||m<-20||m>this.height+20){d.style.display="none";continue}let M=(d.textContent??"").length*6.2*.5,T={x1:y-M,x2:y+M,y1:m-E-22,y2:m-E-4};if(!h&&!p){let A=y,_=m-E-13;if(o.some((I,F)=>F!==c&&I.ok&&I.opacity>.2&&I.screenR>13&&I.camDist<f-1&&Math.hypot(A-I.sx,_-I.sy)<I.screenR*.92)){d.style.display="none";continue}if(s.some(I=>T.x1<I.x2&&T.x2>I.x1&&T.y1<I.y2&&T.y2>I.y1)){d.style.display="none";continue}a+=1}s.push(T);let b=Math.max(0,Math.min(1,(f-this.fog.near)/Math.max(1,this.fog.far-this.fog.near)));d.style.display="block",d.style.transform=`translate(-50%, -100%) translate(${y.toFixed(1)}px, ${(m-E-4).toFixed(1)}px)`,d.style.opacity=String(Math.max(.06,(1-b*.92)*Math.min(1,l.opacity.current+.1))),h?d.setAttribute("data-emphasised",""):d.removeAttribute("data-emphasised")}for(let c of this.territories){if(!c.mesh.visible)continue;if(this.labelVec.copy(c.centre),this.labelVec.y+=c.r,this.labelVec.project(t),!(this.labelVec.z<1&&this.labelVec.z>-1)){c.caption.style.display="none";continue}let u=(this.labelVec.x*.5+.5)*this.width,d=(-this.labelVec.y*.5+.5)*this.height;c.caption.style.display="block",c.caption.style.transform=`translate(-50%, -100%) translate(${u.toFixed(1)}px, ${(d-6).toFixed(1)}px)`,c.caption.style.opacity=n?"0.3":"0.9"}this.projectEdgeLabels()}projectEdgeLabels(){for(let t of this.edgeVisuals){if(!(t.emphasised&&!!t.edge.label&&this.view.dist<this.fitDist*1.15)){t.label&&(t.label.style.display="none");continue}if(!t.label){let r=document.createElement("div");r.className="rp-map3d-edge-label",r.textContent=t.edge.label,this.labelLayer.appendChild(r),t.label=r}if(this.labelVec.set((t.from.sim.x+t.to.sim.x)/2,(t.from.sim.y+t.to.sim.y)/2,(t.from.sim.z+t.to.sim.z)/2).project(this.camera),this.labelVec.z>1||this.labelVec.z<-1){t.label.style.display="none";continue}let n=(this.labelVec.x*.5+.5)*this.width,s=(-this.labelVec.y*.5+.5)*this.height;t.label.style.display="block",t.label.style.transform=`translate(-50%, -140%) translate(${n.toFixed(1)}px, ${s.toFixed(1)}px)`}}dispose(){this.disposed=!0,this.frameHandle!==null&&cancelAnimationFrame(this.frameHandle),this.unbindPointerHandlers(),this.onContextLost&&this.canvas.removeEventListener("webglcontextlost",this.onContextLost),this.reducedQuery?.removeEventListener("change",this.onReducedChange),this.resizeObserver.disconnect(),this.clearScene(),this.sphereGeo.dispose(),this.shellGeo.dispose(),this.tubeGeo.dispose(),this.coneGeo.dispose(),this.ringGeo.dispose(),this.territoryGeo.dispose(),this.selectionRingMaterial.dispose(),this.traceRingMaterial.dispose(),this.renderer.dispose()}};var lh=1e4;function hl(i){let t=Math.abs(i);return t>=1e9?`$${(i/1e9).toFixed(1)}b`:t>=1e6?`$${(i/1e6).toFixed(1)}m`:t>=1e3?`$${Math.round(i/1e3)}k`:`$${Math.round(i)}`}function cl(i,t){return i?i===t?`${i}`:`${i}\u2013${t}`:""}function _g(i){let t=new Map,e=0;for(let o of Xi.keys())t.set(o,e++);let n=new Map;for(let o of i.nodes)n.set(o.group,(n.get(o.group)??0)+1);let s=new Map;for(let[o,c]of n){let l=Ds(o);s.set(o,{slot:t.get(o)??t.get("other")??0,colour:l.colour,ink:l.ink,hollow:!1,count:c})}let r=i.nodes.map(o=>({id:o.id,label:o.label,group:o.group,weight:o.total/lh,kind:o.kind,industry:o.industry,total:o.total,count:o.count,firstYear:o.firstYear,lastYear:o.lastYear,...o.colour?{colour:o.colour}:{}})),a=i.edges.map(o=>({source:o.source,target:o.target,label:hl(o.total),weight:o.total/lh,total:o.total,count:o.count,firstYear:o.firstYear,lastYear:o.lastYear}));return{nodes:r,edges:a,groupStyles:s,degrees:Oa(a)}}var ch="money-map-styles",vg=`
.mm-root { position: relative; overflow: hidden; background: ${li};
...
.mm-canvas:focus-visible { outline: 2px solid ${Ls}; }
...
.rp-map3d-label { position: absolute; top: 0; left: 0; white-space: nowrap;
  ...
  text-shadow: 0 0 4px ${li}, 0 0 8px ${li}; }
...
.rp-map3d-territory { position: absolute; top: 0; left: 0; white-space: nowrap;
  ...
  text-shadow: 0 0 4px ${li}; transition: opacity 160ms; }
...
.mm-card:focus-visible { outline: 2px solid ${Ls}; }
