...
**Models (updated 2026-09-12 — Ask on DeepSeek V4 Pro, side pipelines on platform flash-lite):**
...
`JOURNEY_STORY_MODEL`, `FOLLOWUPS_MODEL`): Ask = `openai-compatible` (the Pro slot); the rest =
`gemini-2.5-flash-lite`, their pre-BYOK pin, generated platform-side. `ASK_MODEL` is folded into
