    ...
    function generateTemplatePrompt(templateId) {
      switch (templateId) {
        case 'free-prompt':
          ...
          prompt = `Summarize the following content in a ${tone} tone: "${content}". Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Use <p> elements for paragraphs. Here is the prompt: ${content}}`;
          return prompt;
        break;
        case 'content-summarizer':
          // get the fields for content summarizer
          var content = encodeURIComponent(dialog.content.querySelector("[data-template-field='content-summarizer-content']").value);
          var tone = encodeURIComponent(dialog.content.querySelector("[data-template-field='content-summarizer-tone']").value);
          prompt = `Summarize the following content in a ${tone} tone: "${content}". Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Use <p> elements for paragraphs.`;
          return prompt;
        break;
        case 'aida-framework':
          ...
          prompt = `Never mention the AIDA framework. Write content using the AIDA framework, without mentioning that you are using the AIDA framework - don't mention anything about attenion, etc. with the following properties: Company Name: ${companyName}, Product: ${product}, Tone: ${tone}.  Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Use <p> elements for paragraphs.`;
          return prompt;
        break;
        case 'bab-framework':
          ...
          prompt = `Write content using the BAB (Before-After-Bridge) framework with the following properties: Company Name: ${companyName}, Product: ${product}, Tone: ${tone}. Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Use <p> elements for paragraphs.`;
          return prompt;
        break;
        case 'blog-post-conclusion-paragraph':
          ...
          prompt = `Write a conclusion paragraph for the following blog post using this post outline: ${outline}. Include a call to action: ${cta}. Use this tone of voice: ${tone}. Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Always use <p> elements for paragraphs.`;
          return prompt;
        break;
        case 'blog-post-intro-paragraph':
          ...
          prompt = `Write an introduction paragraph for the following blog post title: ${title}. The audience is ${audience}. Use this tone of voice: ${tone}. Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Always use <p> elements for paragraphs.`;
          return prompt;
        break;
        case 'blog-post-outline':
          ...
          prompt = `Write an outline for the following blog post title: ${title}. Use this tone of voice: ${tone}. Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Always use <p> elements for paragraphs.`;
          return prompt;
        break;
        case 'company-bio':
          ...
          prompt = `Write a company bio for the following company name: ${name}. Company info: ${info}. Use this tone of voice: ${tone}. Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Always use <p> elements for paragraphs.`;
          return prompt;
        break;
        case 'content-improver':
          ...
          prompt = `Improve the following content: ${content}. Use this tone of voice: ${tone}. Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Always use <p> elements for paragraphs.`;
          return prompt;
        break;
        case 'simplify':
          ...
          prompt = `Explain the following content to a child at grade level ${gradeLevel}: ${content}. Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Always use <p> elements for paragraphs.`;
          return prompt;
          break;
        case 'faq-generator':
          ...
          prompt = `Write ${numQuestions} FAQs for the following topic: ${topic}. Use this tone of voice: ${tone}. Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Always use <p> elements for paragraphs.`;
        return prompt;
          break;
        case 'feature-to-benefit':
          ...
          prompt = `Write the benefits of the features of this product description: ${description}. Use this tone of voice: ${tone}. Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Always use <p> elements for paragraphs.`;
          return prompt;
        break;
        case 'listicle':
          ...
          prompt = `Write a listicle for the following topic: ${topic}. The list should have ${listCount} items. Use this tone of voice: ${tone}. Respond in semantic HTML format without divs and use h2 instead of h1 elements. Never use h1 elements. Use h2, h3, h4 as appropriate for headings. Always use <p> elements for paragraphs and li for lists.`;
          return prompt;
        break;
        case 'one-shot-blog-post':
          ...
          prompt = `Write a one-shot blog post for the following topic: ${topic}. Use this tone of voice: ${tone}. Respond in semantic HTML format without divs and never use h2 instead of h1 elements. Never use h1 elements. Use h2, h3, h4 as appropriate for headings.  Always use <p> elements for paragraphs.`;
          return prompt;
        break;
        case 'perfect-headline':
          ...
          prompt = `Write a perfect headline for the following product description: ${productDescription}. The company product name is ${companyProductName}. The customer avatar is ${customerAvatar}. The customer problem is ${customerProblem}. Use this tone of voice: ${tone}. Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Always use <p> elements for paragraphs.`;
          return prompt;
        break;
        case 'persuasive-bullet-points':
          ...
          prompt = `Write persuasive bullet points for the following content: Company/Product Name: ${companyProductName}, Product Description: ${productDescription}, Tone: ${tone}.  Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Use <ul> and <li> for the list items.`;
          return prompt;
        break;
        case 'press-release':
          ...
          prompt = `Write a press release for the following topic: ${topic}. The press release should have ${points} points.  Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Always use <p> elements for paragraphs.`;
          return prompt;
        break;
        case 'sentence-expander':
          ...
          prompt = `Expand the following sentence: ${sentence}. Use this tone of voice: ${tone}. Respond in semantic HTML format without divs and h2 instead of h1 elements.  Use h2, h3, h4 as appropriate for headings. Always use <p> elements for paragraphs.`;
          return prompt;
        break;
      }
    }
