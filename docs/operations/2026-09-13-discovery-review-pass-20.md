...
The independent challenge found a second form: asking why she supported it before widening the dates left 2025 in the retrieval text even after clearing the structured date filters. A date placed before the topic had the same problem. Source replay then exposed another direct consequence: the initial dated question rejected a relevant point and exact quote because neither repeated 2025. The numeric support guard passed; topic matching caused the rejection.
